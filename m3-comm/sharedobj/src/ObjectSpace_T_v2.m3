MODULE ObjectSpace_T_v2 EXPORTS ObjectSpace, ObjectSpace_T_v2;
...
TYPE
  ...
  PROCEDURE Surrogate_printState(self: ObjectSpace.T) RAISES {Thread.Alerted,
      NetObj.Error} =
