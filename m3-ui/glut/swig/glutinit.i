...
//pargc is value param dont need to return it
//%typemap(m3wrapoutconv) int *pargc %{$1%}
...
//Do not need to define an unused to get the IMPORT Ctypes AS C 
//void Unused(const char* title);
