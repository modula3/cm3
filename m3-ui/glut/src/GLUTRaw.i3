...
<* EXTERNAL glutFullScreenToggle *>
PROCEDURE FullScreenToggle ();

<* EXTERNAL glutLeaveFullScreen *>
...
<* EXTERNAL glutGetModeValues *>
PROCEDURE GetModeValues (mode: C.unsigned_int;
VAR size: C.int;
): REF C.int;
...
<* EXTERNAL glutMultiEntryFunc *>
PROCEDURE MultiEntryFunc ( callback: CallBack2T;
);

<* EXTERNAL glutMultiButtonFunc *>
PROCEDURE MultiButtonFunc ( callback: CallBack5T;
);

<* EXTERNAL glutMultiMotionFunc *>
PROCEDURE MultiMotionFunc ( callback: CallBack3T;
);

<* EXTERNAL glutMultiPassiveFunc *>
PROCEDURE MultiPassiveFunc ( callback: CallBack3T;
);

<* EXTERNAL glutInitContextVersion *>
PROCEDURE InitContextVersion (majorVersion, minorVersion: C.int;
);

<* EXTERNAL glutInitContextFlags *>
PROCEDURE InitContextFlags (flags: C.int;
);

<* EXTERNAL glutInitContextProfile *>
PROCEDURE InitContextProfile (profile: C.int;
);
