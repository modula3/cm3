...
<* EXTERNAL glutInit *>
PROCEDURE Init
  (VAR pargc: C.int; READONLY argv: (*ARRAY OF*) C.char_star; );
...
<* EXTERNAL glutGet *>
PROCEDURE Get (query: GL.GLenum; ): C.int;

<* EXTERNAL glutDeviceGet *>
PROCEDURE DeviceGet (query: GL.GLenum; ): C.int;

<* EXTERNAL glutGetModifiers *>
PROCEDURE GetModifiers (): C.int;

<* EXTERNAL glutLayerGet *>
PROCEDURE LayerGet (query: GL.GLenum; ): C.int;

<* EXTERNAL glutBitmapCharacter *>
PROCEDURE BitmapCharacter (font: REF INTEGER; character: C.int; );

<* EXTERNAL glutBitmapWidth *>
PROCEDURE BitmapWidth (font: REF INTEGER; character: C.int; ): C.int;

<* EXTERNAL glutStrokeCharacter *>
PROCEDURE StrokeCharacter (font: REF INTEGER; character: C.int; );

<* EXTERNAL glutStrokeWidth *>
PROCEDURE StrokeWidth (font: REF INTEGER; character: C.int; ): C.int;

<* EXTERNAL glutBitmapLength *>
PROCEDURE BitmapLength (font: REF INTEGER; READONLY string: C.char_star; ):
  C.int;

<* EXTERNAL glutStrokeLength *>
PROCEDURE StrokeLength (font: REF INTEGER; READONLY string: C.char_star; ):
  C.int;

<* EXTERNAL glutWireCube *>
PROCEDURE WireCube (size: GL.GLdouble; );

<* EXTERNAL glutSolidCube *>
PROCEDURE SolidCube (size: GL.GLdouble; );

<* EXTERNAL glutWireSphere *>
PROCEDURE WireSphere (radius: GL.GLdouble; slices, stacks: INTEGER; );

<* EXTERNAL glutSolidSphere *>
PROCEDURE SolidSphere (radius: GL.GLdouble; slices, stacks: INTEGER; );

<* EXTERNAL glutWireCone *>
PROCEDURE WireCone (base, height: GL.GLdouble; slices, stacks: INTEGER; );

<* EXTERNAL glutSolidCone *>
PROCEDURE SolidCone (base, height: GL.GLdouble; slices, stacks: INTEGER; );

<* EXTERNAL glutWireTorus *>
PROCEDURE WireTorus
  (innerRadius, outerRadius: GL.GLdouble; sides, rings: INTEGER; );
...
PROCEDURE WireTeapot (size: GL.GLdouble; );

<* EXTERNAL glutSolidTeapot *>
PROCEDURE SolidTeapot (size: GL.GLdouble; );
...
PROCEDURE GameModeGet (query: GL.GLenum; ): C.int;

<* EXTERNAL glutVideoResizeGet *>
PROCEDURE VideoResizeGet (query: GL.GLenum; ): C.int;
...
PROCEDURE SetColor (color: C.int; red, green, blue: GL.GLfloat; );

<* EXTERNAL glutGetColor *>
PROCEDURE glutGetColor (color, component: C.int; ): GL.GLfloat;
...
PROCEDURE SetOption (option_flag: GL.GLenum; value: C.int; );
...
PROCEDURE BitmapHeight (font: REFANY; ): C.int;

<* EXTERNAL glutStrokeHeight *>
PROCEDURE StrokeHeight (font: REFANY; ): GL.GLfloat;

<* EXTERNAL glutBitmapString *>
PROCEDURE BitmapString (font: REFANY; READONLY string: C.char_star; );

<* EXTERNAL glutStrokeString *>
PROCEDURE StrokeString (font: REFANY; READONLY string: C.char_star; );
...
PROCEDURE WireCylinder
  (radius, height: GL.GLdouble; slices, stacks: INTEGER; );
