...
(* This interface reveals those aspects of the BooleanProp module that are 
...
FROM BooleanProp IMPORT 
  Name, Val, ConstBeh, SyncBeh, AsyncBeh, DepBeh, Request;

(* Proxy Maker (PM) procedures for the various proxied object 
