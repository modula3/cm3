...
(* All rights reserved.                                                      *)
(*                                                                           *)
(* Last modified on Tue Jan 31 00:06:38 PST 1995 by najork                   *)
(*       Created on Sun May 22 11:34:32 PDT 1994 by najork                   *)


MODULE LineTypeProp EXPORTS LineTypeProp, 
                            LineTypePropPrivate, 
                            LineTypePropProxy;
...
PROCEDURE ComputeAsyncBeh (self : AsyncBeh; time : LONGREAL) : Kind 
  ...
  BEGIN
    ...
    ELSE
      RAISE Prop.BadMethod("LineTypeProp.AsyncBeh.compute method is undefined");
    END;
  END ComputeAsyncBeh;
...
PROCEDURE ValueDepBeh (self : DepBeh; time : LONGREAL) : Kind 
  ...
  BEGIN
    ...
    IF self.hot THEN
      RAISE Prop.BadMethod("LineTypeProp.DepBeh occurs in a dependency cycle");
    END;
...
PROCEDURE ComputeDepBeh (self : DepBeh; time : LONGREAL) : Kind 
  ...
  BEGIN
    ...
    ELSE
      RAISE Prop.BadMethod("LineTypeProp.DepBeh.compute method is undefined");
    END;
  END ComputeDepBeh;
...
PROCEDURE ValueRequest (self     : Request; 
  ...
  BEGIN
    ...
    ELSE
      RAISE Prop.BadMethod("LineTypeProp.Request.value method is undefined");
    END;
  END ValueRequest;
...
(*****************************************************************************)
(* Animation queue for synchronous line type property value behavior         *)
(*****************************************************************************)
