...
PROCEDURE PrintMessageType (message: WinDef.UINT) =
  BEGIN
    ...
    | WinUser.WM_NEXTMENU => IO.Put("WM_NEXTMENU");
    | WinUser.WM_SIZING => IO.Put("WM_SIZING");
    | WinUser.WM_CAPTURECHANGED => IO.Put("WM_CAPTURECHANGED");
    | WinUser.WM_MOVING => IO.Put("WM_MOVING");
    | WinUser.WM_POWERBROADCAST => IO.Put("WM_POWERBROADCAST");
    | WinUser.WM_DEVICECHANGE => IO.Put("WM_DEVICECHANGE");
    ...
    | WinUser.WM_ENTERSIZEMOVE => IO.Put("WM_ENTERSIZEMOVE");
    | WinUser.WM_EXITSIZEMOVE => IO.Put("WM_EXITSIZEMOVE");
