...
(* All rights reserved.                                                      *)
(*                                                                           *)
(* Last modified on Tue Jan 31 00:05:29 PST 1995 by najork                   *)
(*       Created on Sun May 22 10:47:40 PDT 1994 by najork                   *)
...
PROCEDURE GetVal (self : Val) : Base
...
PROCEDURE ComputeDepBeh (self : DepBeh; time : LONGREAL) : Base
  ...
  BEGIN
    ...
    ELSE
      RAISE Prop.BadMethod("ColorProp.DepBeh.compute method is undefined");
    END;
  END ComputeDepBeh;
...
PROCEDURE ValueRequest (self     : Request;
  ...
  BEGIN
    ...
    ELSE
      RAISE Prop.BadMethod("ColorProp.Request.value method is undefined");
    END;
  END ValueRequest;
...
PROCEDURE RgbLinChangeToValue (self       : RgbLinChangeToReq;
  ...
  BEGIN
    ...
    ELSE
      fraction := 1.0;
    END;
    RETURN Base {startcolor.r + (self.p.r -  startcolor.r) * fraction,
                 startcolor.g + (self.p.g -  startcolor.g) * fraction,
                 startcolor.b + (self.p.b -  startcolor.b) * fraction};
  END RgbLinChangeToValue;


(*****************************************************************************)
(* Animation queue for synchronous color property value behavior             *)
(*****************************************************************************)
