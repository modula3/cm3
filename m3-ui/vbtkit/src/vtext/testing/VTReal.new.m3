...
(* *)
(* Last modified on Fri Nov 20 22:29:38 PST 1992 by meehan *)
...
(* This module maintains the "real" screen structures.  The following
   ...
   line^[0] through line^[lines - 1] are defined.  when dirty is false, then
   if lines < nLines, then the remaining lines are zero-size.  (The
   allWhiteBelow, turned and width fields are defined through nLines - 1.) *)
  ...
  BEGIN
    WITH z_43 = view^ DO
      IF (z_43.real.lines > 0)
           AND (z_43.real.line [0].realLine.from # z_43.virtual.start.at) THEN
        Dirtied (view, 0, 0);
      END;
              ...
              VBT.PaintTint (
                ...
                Rect.Meet (
                  Rect.FromEdges (
                    ...
                    z_43.rect.text.north + z_43.real.lines * z_43.lineSpacing,
                    z_43.rect.text.north
  ...
  BEGIN
    WITH z_52 = view^ DO
      ...
      LOOP
        ...
        WHILE (o < z_52.real.lines) AND NOT z_52.real.line [o].realLine.valid DO
          o := o + 1;
        END;
      ...
      WITH z_70 = z_69.real.line [i] DO
        ...
        WITH z_71 = z_69.vScreenFont^ DO
          ...
          IF NOT z_71.vScreenFont.paintOpaque THEN
            ...
            WHILE at < to DO
              ...
              PaintBackgroundTransparent (
                ...
                z_70.realLine.allWhiteBelow, oldWidth, z_70.realLine.width);
              at := until;
            END;
            h := z_69.rect.text.west;
          ...
          IF h < z_69.rect.text.west + oldWidth THEN
            VBT.PaintTint (
              z_69.vbt,
              Rect.Meet (Rect.FromEdges (h, z_69.rect.text.west + oldWidth, v,
                                         v + z_69.lineSpacing),
                         z_69.rect.textClip), z_69.vOptions.whiteBlack.bg);
          END;
          rdIndex := to;
            ...
            WITH z_72 = marker^ DO
              ...
              | WhichEnd.Left =>
                  VBT.PaintTint (
                    z_69.vbt,
                    Rect.Meet (
                      Rect.FromEdges (leftSide.h, leftSide.h + 1, v,
              ...
              | WhichEnd.Right =>
                  VBT.PaintTint (
                    z_69.vbt,
                    Rect.Meet (
                      Rect.FromEdges (rightSide.h - 1, rightSide.h, v,
                                      v + (z_71.vScreenFont.box.south
                                             - z_71.vScreenFont.box.north)),
                      z_69.rect.textClip), stroke);
              END;
              IF z_72.options.top THEN
                VBT.PaintTint (
                  z_69.vbt, Rect.Meet (Rect.FromEdges (
                                         leftSide.h, rightSide.h, v, v + 1),
                                       z_69.rect.textClip), stroke);
              END;
              IF z_72.options.bottom THEN
                VBT.PaintTint (
                  z_69.vbt,
                  Rect.Meet (
                    Rect.FromEdges (leftSide.h, rightSide.h,
                                    v + (z_71.vScreenFont.box.south
              ...
              IF (z_72.options.whichEnd = WhichEnd.Left)
                   AND NOT z_72.options.top AND NOT z_72.options.bottom THEN
                z_70.realLine.width :=
                  MAX (
                    z_70.realLine.width, leftSide.h + 1 - z_69.rect.text.west);
              ELSE
                z_70.realLine.width :=
                  MAX (z_70.realLine.width, rightSide.h - z_69.rect.text.west);
              END;
...
PROCEDURE PaintSegmentOpaque (                view  : View;
                              ...
                              atStyleStart, atStyleStop0: BOOLEAN) RAISES {} =
  VAR
    charht     : Coord;
    h0         : INTEGER (* Coord *);
          ...
          WITH z_75 = z_74.vScreenFont.vFont^ DO
            IF (h0 < z_73.rect.textClip.east)
                    ...
                    IF NOT (oldAllWhiteBelow
                      ...
                      VBT.PaintTint (
                        ...
                        Rect.Meet (
                          ...
                          z_73.rect.textClip), intervalOptions.leading);
                    END;
                    allWhiteBelow := FALSE;
                  ELSE
                    clip :=
              ...
              | IntervalStyle.SlugStyle =>
                  VBT.PaintTint (z_73.vbt, Rect.Meet (Rect.FromEdges (
                                                        h0, h, v, v + charht),
                                                      z_73.rect.textClip),
                                 intervalOptions.whiteStroke.fg);
                  FillLeading (intervalOptions.leading);
  ...
  PROCEDURE PaintWhite () RAISES {} =
    ...
    BEGIN
      WITH z_76 = view^ DO
        IF (h0 < z_76.rect.textClip.east) AND (h > z_76.rect.textClip.west) THEN
          to := Rect.FromEdges (h0, h, v, v + charht + z_76.vOptions.leading);
          IF intervalOptions.style = IntervalStyle.NoStyle THEN
          ...
          ELSE
            ...
            | IntervalStyle.HighlightStyle =>
                VBT.PaintTint (
                  z_76.vbt, Rect.Meet (Rect.MoveEdge (to, Rect.Edge.S,
                                                      -z_76.vOptions.leading),
                                       z_76.rect.textClip),
            ...
            | IntervalStyle.UnderlineStyle =>
                ...
                ELSE
                  ...
                  FillLeading (intervalOptions.leading);
                  VBT.PaintTint (
                    z_76.vbt, Rect.Meet (Rect.FromEdges (
            ...
            | IntervalStyle.ThinUnderlineStyle =>
                VBT.PaintTint (
                  ...
                  Rect.Meet (Rect.MoveEdge (
                               to, Rect.Edge.S, -(z_76.vOptions.leading + 1)),
                             z_76.rect.textClip),
                  intervalOptions.whiteBlack.bg);
                FillLeading (intervalOptions.leading);
                VBT.PaintTint (
            ...
            | IntervalStyle.SlugStyle =>
                VBT.PaintTint (
                  z_76.vbt, Rect.Meet (Rect.FromEdges (h0, h, v, v + charht),
                                       z_76.rect.textClip),
                  intervalOptions.whiteStroke.fg);
                FillLeading (intervalOptions.leading);
            | IntervalStyle.OverlapStyle =>
                VBT.PaintTexture (
                  ...
                  Rect.Meet (Rect.FromEdges (
                             ...
                             z_76.rect.textClip),
                  z_76.vOptions.whiteBlack.bgFg, VTTexture.lightGray,
                  Point.FromCoords (z_76.rect.text.west, v));
                allWhiteBelow := FALSE;
            ELSE                 <* ASSERT(FALSE) *>
            END;
    ...
    WITH z_78 = view^ DO
      WITH z_79 = z_78.vScreenFont^ DO
        WITH z_80 = z_79.vScreenFont.vFont^ DO
          charht := z_79.vScreenFont.box.south - z_79.vScreenFont.box.north;
          h0 := h;
          ci0 := 0;
          ci := 0;
          atStyleStop := FALSE;
                  ...
                  VBT.PaintTint (
                    ...
                    Rect.Meet (
                      Rect.FromEdges (
                        ...
                        v - z_79.vScreenFont.box.north - 1), charClip), black);
                  VBT.PaintTint (
                    z_78.vbt,
                    Rect.Meet (
                      Rect.FromEdges (
...
PROCEDURE PaintBackgroundTransparent (                view  : View;
  ...
  VAR
    ...
    h0     : INTEGER (* Coord *);
    ci, ci0: INTEGER (* CARDINAL *);
  (* PROCEDURE PaintSub( VAR IN chars: ARRAY OF CHAR; start, length: CARDINAL)
     RAISES {}; VAR refpt: Point.T; clip: Rect.T; BEGIN WITH view^ DO WITH
     vScreenFont^ DO WITH vScreenFont.vFont^ DO IF (h0 < rect.textClip.east)
     AND (h > rect.textClip.west) THEN refpt := Point.FromCoords(h0, v -
     vScreenFont.box.north); CASE intervalOptions.style OF | NoStyle:
     VBT.PaintSub(vbt, rect.textClip, refpt, vFont.font, chars, start, length,
     vOptions.whiteBlack^.bgFg); | HighlightStyle: VBT.PaintSub(vbt,
     rect.textClip, refpt, vFont.font, chars, start, length,
     intervalOptions.whiteBlack^.bgFg); | InverseStyle: VBT.PaintSub(vbt,
     rect.textClip, refpt, vFont.font, chars, start, length,
     intervalOptions.whiteBlack^.fgbg); | GrayStyle: VBT.PaintSub(vbt,
     rect.textClip, refpt, vFont.font, chars, start, length,
     intervalOptions.whiteBlack^.bgFg); | UnderlineStyle: IF vOptions.leading
     > 0 THEN clip := Rect.Meet( Rect.FromEdges(h0, h, v, v + charht - 1),
     rect.textClip); ELSE clip := Rect.Meet( Rect.FromEdges(h0, h, v, v +
     charht - 2), rect.textClip); END; VBT.PaintSub(vbt, clip, refpt,
     vFont.font, chars, start, length, intervalOptions.whiteBlack^.bgFg); |
     ThinUnderlineStyle, GrayUnderlineStyle: clip :=
     Rect.Meet(Rect.FromEdges(h0, h, v, v + charht - 1), rect.textClip);
     VBT.PaintSub(vbt, clip, refpt, vFont.font, chars, start, length,
     intervalOptions.whiteBlack^.bgFg); | BoxStyle: clip := Rect.FromEdges(h0,
     h, v + 1, v + charht - 1); clip := Rect.Meet(clip, rect.textClip);
     VBT.PaintSub(vbt, clip, refpt, vFont.font, chars, start, length,
     intervalOptions.whiteBlack^.bgFg); | SlugStyle: | OverlapStyle:
     VBT.PaintTexture(vbt, Rect.Meet( Rect.FromEdges(h0, h, v, v + charht +
     vOptions.leading), rect.textClip), vOptions.whiteBlack^.bgFg,
     VTTexture.lightGray, Point.FromCoords(rect.text.west, v));
     VBT.PaintSub(vbt, rect.textClip, refpt, vFont.font, chars, start, length,
     vOptions.whiteBlack^.transparentFg); allWhiteBelow := FALSE; END; ELSE IF
     intervalOptions.style # NoStyle THEN allWhiteBelow := FALSE; END; END;
     newWidth := h - rect.text.west; END; END; END; END PaintSub; *)
  PROCEDURE PaintWhite () RAISES {} =
    VAR to: Rect.T;
    BEGIN
      WITH z_81 = view^ DO
        IF (h0 < z_81.rect.textClip.east) AND (h > z_81.rect.textClip.west) THEN
          to := Rect.FromEdges (h0, h, v, v + charht + z_81.vOptions.leading);
          IF intervalOptions.style = IntervalStyle.NoStyle THEN
          ...
          ELSE
            ...
            | IntervalStyle.HighlightStyle =>
                VBT.PaintTint (
                  z_81.vbt, Rect.Meet (Rect.MoveEdge (to, Rect.Edge.S,
                                                      -z_81.vOptions.leading),
                                       z_81.rect.textClip),
                  intervalOptions.whiteBlack.bg);
            | IntervalStyle.InverseStyle =>
                VBT.PaintTint (
            ...
            | IntervalStyle.GrayUnderlineStyle,
                ...
                VBT.PaintTint (
                  z_81.vbt,
                  Rect.Meet (Rect.MoveEdge (
                               to, Rect.Edge.S, -(z_81.vOptions.leading + 1)),
                             z_81.rect.textClip),
                  intervalOptions.whiteBlack.bg);
            | IntervalStyle.BoxStyle =>
                to := Rect.FromEdges (h0, h, v + 1, v + charht - 1);
            ...
            | IntervalStyle.OverlapStyle =>
                VBT.PaintTexture (
                  ...
                  Rect.Meet (Rect.FromEdges (
                             ...
                             z_81.rect.textClip),
                  z_81.vOptions.whiteBlack.bgFg, VTTexture.lightGray,
        ...
        WITH z_86 = z_85.vScreenFont^ DO
          WITH z_87 = z_86.vScreenFont.vFont^ DO
            IF (h0 < z_85.rect.textClip.east)
              ...
              refpt := Point.FromCoords (h0, v - z_86.vScreenFont.box.north);
              CASE intervalOptions.style OF
              | IntervalStyle.NoStyle =>
                  VBT.PaintSub (
    ...
    WITH z_88 = view^ DO
      WITH z_89 = z_88.vScreenFont^ DO
        WITH z_90 = z_89.vScreenFont.vFont^ DO
          charht := z_89.vScreenFont.box.south - z_89.vScreenFont.box.north;
          h0 := h;
          ci0 := 0;
          ci := 0;
          WHILE (ci < length) DO
                  ...
                  VBT.PaintTint (
                    ...
                    Rect.Meet (
                      Rect.FromEdges (
                        ...
                        v - z_89.vScreenFont.box.north - 1), charClip), black);
                  VBT.PaintTint (
                    z_88.vbt,
                    Rect.Meet (
                      Rect.FromEdges (
      ...
      WITH z_97 = z_96.vScreenFont^ DO
        WITH z_98 = z_97.vScreenFont.vFont^ DO
          ...
          WHILE (ci < length) DO
            c := Rd.GetChar (rd);
            IF c = '\n' THEN
              h := z_96.rect.text.east;
            ELSIF (c = '\t') AND ('\t' IN z_98.vFont.printable) THEN
              xx := h - z_96.rect.text.west;
              xx := xx + z_97.vScreenFont.width [' ']
                      + z_97.vScreenFont.width ['\t'] - 1;
              xx := xx - xx MOD z_97.vScreenFont.width ['\t'];
              h := xx + z_96.rect.text.west;
            ELSE
              h := h + z_97.vScreenFont.width [c];
            END;
            ci := ci + 1;
          END;
