...
ZEUSLIB = -lm3zeus -lm3mg -lm3codeview $(FORMSVBTLIB)
...
all:: RTTest
clean:: ; rm -f RTTest RTTest.ov RTTest.b RTTest.bx RTTest.by
RTTest: FRC ; $(DO_M3) -o RTTest $(PGM_SOURCES) $(IMPORT_LIBS)


FROM_M3SU = ../src/RTTest.m3
include $(M3SU)
