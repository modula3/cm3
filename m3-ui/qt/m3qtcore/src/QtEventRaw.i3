...
PROCEDURE New_QEvent0 (type: C.int;
): QEvent;
...
PROCEDURE RegisterEventType (hint: C.int;
): C.int;
...
PROCEDURE New_QTimerEvent0 (timerId: C.int;
): QTimerEvent;
...
PROCEDURE New_QChildEvent0 (type: C.int;
 child: ADDRESS;
): QChildEvent;
...
TYPE
QDynamicPropertyChangeEvent = ADDRESS;
