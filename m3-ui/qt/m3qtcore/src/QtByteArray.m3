...
PROCEDURE New_QByteArray1 (self: QByteArray; arg1: TEXT; ): QByteArray =
  VAR
    result : ADDRESS;
    arg1tmp: C.char_star;
  BEGIN
...
PROCEDURE New_QByteArray2 (self: QByteArray; arg1: TEXT; size: INTEGER; ):
  QByteArray =
  VAR
    result : ADDRESS;
    arg1tmp: C.char_star;
...
PROCEDURE New_QByteArray3 (self: QByteArray; size: INTEGER; c: CHAR; ):
  QByteArray =
  VAR result: ADDRESS;
  BEGIN
...
PROCEDURE New_QByteArray4
  (self: QByteArray; size: INTEGER; arg2: Initialization; ): QByteArray =
  VAR result: ADDRESS;
  BEGIN
...
PROCEDURE QByteArray_size (self: QByteArray; ): INTEGER =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_resize (self: QByteArray; size: INTEGER; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtByteArrayRaw.QByteArray_resize(selfAdr, size);
  END QByteArray_resize;

PROCEDURE QByteArray_fill (self: QByteArray; c: CHAR; size: INTEGER; ):
  QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
...
PROCEDURE QByteArray_fill1 (self: QByteArray; c: CHAR; ): QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QByteArray_capacity (self: QByteArray; ): INTEGER =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtByteArrayRaw.QByteArray_capacity(selfAdr);
  END QByteArray_capacity;

PROCEDURE QByteArray_reserve (self: QByteArray; size: INTEGER; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_data (self: QByteArray; ): TEXT =
  VAR
    result : C.char_star;
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_data1 (self: QByteArray; ): TEXT =
  VAR
    result : C.char_star;
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_constData (self: QByteArray; ): TEXT =
  VAR
    result : C.char_star;
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_isSharedWith (self, other: QByteArray; ): BOOLEAN =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(other.cxxObj, ADDRESS);
  BEGIN
    RETURN QtByteArrayRaw.QByteArray_isSharedWith(selfAdr, arg2tmp);
  END QByteArray_isSharedWith;
...
PROCEDURE QByteArray_count (self: QByteArray; c: CHAR; ): INTEGER =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtByteArrayRaw.QByteArray_count(selfAdr, ORD(c));
  END QByteArray_count;

PROCEDURE QByteArray_count1 (self: QByteArray; a: TEXT; ): INTEGER =
  VAR
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp: C.char_star;
    result : INTEGER;
...
PROCEDURE QByteArray_count2 (self, a: QByteArray; ): INTEGER =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QByteArray_left (self: QByteArray; len: INTEGER; ): QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QByteArray_right (self: QByteArray; len: INTEGER; ): QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QByteArray_mid (self: QByteArray; index, len: INTEGER; ):
  QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
...
PROCEDURE QByteArray_mid1 (self: QByteArray; index: INTEGER; ):
  QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
...
PROCEDURE QByteArray_startsWith (self, a: QByteArray; ): BOOLEAN =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(a.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_startsWith1 (self: QByteArray; c: CHAR; ): BOOLEAN =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtByteArrayRaw.QByteArray_startsWith1(selfAdr, ORD(c));
  END QByteArray_startsWith1;

PROCEDURE QByteArray_startsWith2 (self: QByteArray; c: TEXT; ): BOOLEAN =
  VAR
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp: C.char_star;
    result : BOOLEAN;
...
PROCEDURE QByteArray_endsWith (self, a: QByteArray; ): BOOLEAN =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(a.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_endsWith1 (self: QByteArray; c: CHAR; ): BOOLEAN =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtByteArrayRaw.QByteArray_endsWith1(selfAdr, ORD(c));
  END QByteArray_endsWith1;

PROCEDURE QByteArray_endsWith2 (self: QByteArray; c: TEXT; ): BOOLEAN =
  VAR
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp: C.char_star;
    result : BOOLEAN;
...
PROCEDURE QByteArray_truncate (self: QByteArray; pos: INTEGER; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtByteArrayRaw.QByteArray_truncate(selfAdr, pos);
  END QByteArray_truncate;

PROCEDURE QByteArray_chop (self: QByteArray; n: INTEGER; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtByteArrayRaw.QByteArray_chop(selfAdr, n);
  END QByteArray_chop;

PROCEDURE QByteArray_toLower (self: QByteArray; ): QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QByteArray_toUpper (self: QByteArray; ): QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QByteArray_trimmed (self: QByteArray; ): QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QByteArray_simplified (self: QByteArray; ): QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QByteArray_prepend (self: QByteArray; c: CHAR; ): QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QByteArray_prepend1 (self: QByteArray; s: TEXT; ): QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QByteArray_prepend2 (self: QByteArray; s: TEXT; len: INTEGER; ):
  QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
...
PROCEDURE QByteArray_prepend3 (self, a: QByteArray; ): QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QByteArray_remove (self: QByteArray; index, len: INTEGER; ):
  QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
...
PROCEDURE QByteArray_repeated (self: QByteArray; times: INTEGER; ):
  QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
...
PROCEDURE QByteArray_toShort
  (self: QByteArray; VAR ok: BOOLEAN; base: INTEGER; ): INTEGER =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_toShort2 (self: QByteArray; ): INTEGER =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_toUShort
  (self: QByteArray; VAR ok: BOOLEAN; base: INTEGER; ): CARDINAL =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_toUShort2 (self: QByteArray; ): CARDINAL =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_toInt1 (self: QByteArray; VAR ok: BOOLEAN; ):
  INTEGER =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_toInt2 (self: QByteArray; ): INTEGER =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_toUInt2 (self: QByteArray; ): CARDINAL =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_toLong1 (self: QByteArray; VAR ok: BOOLEAN; ):
  INTEGER =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_toLong2 (self: QByteArray; ): INTEGER =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_toULong2 (self: QByteArray; ): CARDINAL =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtByteArrayRaw.QByteArray_toULong2(selfAdr);
  END QByteArray_toULong2;

PROCEDURE QByteArray_toFloat (self: QByteArray; VAR ok: BOOLEAN; ): REAL =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtByteArrayRaw.QByteArray_toFloat(selfAdr, ok);
  END QByteArray_toFloat;

PROCEDURE QByteArray_toFloat1 (self: QByteArray; ): REAL =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QByteArray_toDouble1 (self: QByteArray; ): LONGREAL =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtByteArrayRaw.QByteArray_toDouble1(selfAdr);
  END QByteArray_toDouble1;

PROCEDURE QByteArray_toBase64 (self: QByteArray; ): QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QByteArray_toHex (self: QByteArray; ): QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QByteArray_toPercentEncoding
  (self, exclude, include: QByteArray; percent: CHAR; ): QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
  ...
  BEGIN
    ret := QtByteArrayRaw.QByteArray_toPercentEncoding(
             selfAdr, arg2tmp, arg3tmp, ORD(percent));
...
PROCEDURE QByteArray_toPercentEncoding1
  (self, exclude, include: QByteArray; ): QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
    ...
    arg3tmp             := LOOPHOLE(include.cxxObj, ADDRESS);
  BEGIN
    ret := QtByteArrayRaw.QByteArray_toPercentEncoding1(
...
PROCEDURE QByteArray_toPercentEncoding3 (self: QByteArray; ): QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QByteArray_setRawData (self: QByteArray; a: TEXT; n: CARDINAL; ):
  QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
  ...
  BEGIN
    arg2tmp := M3toC.CopyTtoS(a);
    ret := QtByteArrayRaw.QByteArray_setRawData(selfAdr, arg2tmp, n);
...
PROCEDURE FromRawData (arg1: TEXT; size: INTEGER; ): QByteArray =
  ...
  BEGIN
    ...
    (*IF ISTYPE(result,QByteArray) AND ret = selfAdr THEN result :=
       LOOPHOLE(self,QByteArray); ELSE*)
    result := NEW(QByteArray);
    result.cxxObj := ret;
    result.destroyCxx();
    (*END;*)
...
PROCEDURE QByteArray_push_back (self: QByteArray; c: CHAR; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtByteArrayRaw.QByteArray_push_back(selfAdr, ORD(c));
  END QByteArray_push_back;

PROCEDURE QByteArray_push_back1 (self: QByteArray; c: TEXT; ) =
  VAR
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp: C.char_star;
  BEGIN
...
PROCEDURE QByteArray_push_front (self: QByteArray; c: CHAR; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtByteArrayRaw.QByteArray_push_front(selfAdr, ORD(c));
  END QByteArray_push_front;

PROCEDURE QByteArray_push_front1 (self: QByteArray; c: TEXT; ) =
  VAR
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp: C.char_star;
  BEGIN
...
PROCEDURE QByteArray_count3 (self: QByteArray; ): INTEGER =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtByteArrayRaw.QByteArray_count3(selfAdr);
  END QByteArray_count3;

PROCEDURE QByteArray_length (self: QByteArray; ): INTEGER =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
REVEAL
  QByteArray = QByteArrayPublic BRANDED OBJECT
               OVERRIDES
                 ...
                 isSharedWith       := QByteArray_isSharedWith;
                 ...
                 setRawData         := QByteArray_setRawData;
