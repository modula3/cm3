...
PROCEDURE New_QStringList1 (self:QStringList; i: TEXT;
): QStringList =
VAR
result : ADDRESS;
...
BEGIN
ret := QtStringListRaw.QStringList_replaceInStrings(selfAdr, arg2tmp, arg3tmp, ORD(cs));
...
arg3tmp :=  LOOPHOLE(arg3qtmp.cxxObj,ADDRESS);
BEGIN
ret := QtStringListRaw.QStringList_replaceInStrings1(selfAdr, arg2tmp, arg3tmp);
...
PROCEDURE Cleanup_QStringList(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
QStringList =
QStringListPublic BRANDED OBJECT
OVERRIDES
