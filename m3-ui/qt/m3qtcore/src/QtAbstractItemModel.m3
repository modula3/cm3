...
PROCEDURE QModelIndex_row (self: QModelIndex; ): INTEGER =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QModelIndex_row(selfAdr);
  END QModelIndex_row;

PROCEDURE QModelIndex_column (self: QModelIndex; ): INTEGER =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QModelIndex_column(selfAdr);
  END QModelIndex_column;

PROCEDURE QModelIndex_internalId (self: QModelIndex; ): CARDINAL =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QModelIndex_internalId(selfAdr);
  END QModelIndex_internalId;

PROCEDURE QModelIndex_parent (self: QModelIndex; ): QModelIndex =
  VAR
    ret    : ADDRESS;
    result : QModelIndex;
...
PROCEDURE QModelIndex_sibling (self: QModelIndex; row, column: INTEGER; ):
  QModelIndex =
  VAR
    ret    : ADDRESS;
    result : QModelIndex;
  ...
  BEGIN
    ret :=
      QtAbstractItemModelRaw.QModelIndex_sibling(selfAdr, row, column);
...
PROCEDURE QModelIndex_child (self: QModelIndex; row, column: INTEGER; ):
  QModelIndex =
  VAR
    ret    : ADDRESS;
    result : QModelIndex;
...
PROCEDURE QModelIndex_flags (self: QModelIndex; ): ItemFlags =
  VAR
    ret    : INTEGER;
    result : ItemFlags;
    selfAdr: ADDRESS   := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QModelIndex_model (self: QModelIndex; ): QAbstractItemModel =
  VAR
    ret    : ADDRESS;
...
REVEAL
  QModelIndex = QModelIndexPublic BRANDED OBJECT
                OVERRIDES
...
PROCEDURE New_QPersistentModelIndex0 (self: QPersistentModelIndex; ):
...
PROCEDURE New_QPersistentModelIndex1
  (self: QPersistentModelIndex; index: QModelIndex; ):
  QPersistentModelIndex =
  VAR
    result : ADDRESS;
...
PROCEDURE New_QPersistentModelIndex2
  (self: QPersistentModelIndex; other: QPersistentModelIndex; ):
  QPersistentModelIndex =
  VAR
    result : ADDRESS;
    arg1tmp          := LOOPHOLE(other.cxxObj, ADDRESS);
...
PROCEDURE QPersistentModelIndex_internalId (self: QPersistentModelIndex; ):
  ...
  BEGIN
    RETURN
      QtAbstractItemModelRaw.QPersistentModelIndex_internalId(selfAdr);
...
PROCEDURE QPersistentModelIndex_sibling
  (self: QPersistentModelIndex; row, column: INTEGER; ): QModelIndex =
  VAR
    ret    : ADDRESS;
    result : QModelIndex;
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    ret := QtAbstractItemModelRaw.QPersistentModelIndex_sibling(
             selfAdr, row, column);
...
PROCEDURE QPersistentModelIndex_child
  ...
  VAR
    ...
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    ret := QtAbstractItemModelRaw.QPersistentModelIndex_child(
             selfAdr, row, column);
...
PROCEDURE Cleanup_QPersistentModelIndex
  (<* UNUSED *> READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
  QPersistentModelIndex = QPersistentModelIndexPublic BRANDED OBJECT
                          OVERRIDES
...
PROCEDURE QAbstractItemModel_hasIndex
  (self: QAbstractItemModel; row, column: INTEGER; parent: QModelIndex; ):
  BOOLEAN =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg4tmp          := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_hasIndex(
             selfAdr, row, column, arg4tmp);
  END QAbstractItemModel_hasIndex;

PROCEDURE QAbstractItemModel_hasIndex1
  (self: QAbstractItemModel; row, column: INTEGER; ): BOOLEAN =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_hasIndex1(
             selfAdr, row, column);
  END QAbstractItemModel_hasIndex1;

PROCEDURE QAbstractItemModel_sibling
  (self: QAbstractItemModel; row, column: INTEGER; idx: QModelIndex; ):
  QModelIndex =
  VAR
    ret    : ADDRESS;
    result : QModelIndex;
  ...
  BEGIN
    ret := QtAbstractItemModelRaw.QAbstractItemModel_sibling(
             selfAdr, row, column, arg4tmp);
...
PROCEDURE QAbstractItemModel_hasChildren
  (self: QAbstractItemModel; parent: QModelIndex; ): BOOLEAN =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_hasChildren(
             selfAdr, arg2tmp);
...
PROCEDURE QAbstractItemModel_setData (self : QAbstractItemModel;
  ...
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_setData(
             selfAdr, arg2tmp, arg3tmp, role);
  END QAbstractItemModel_setData;

PROCEDURE QAbstractItemModel_setData1
  (self: QAbstractItemModel; index: QModelIndex; value: QVariant; ):
  BOOLEAN =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(index.cxxObj, ADDRESS);
    arg3tmp          := LOOPHOLE(value.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_setData1(
...
PROCEDURE QAbstractItemModel_setHeaderData (self   : QAbstractItemModel;
  ...
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_setHeaderData(
             selfAdr, section, ORD(orientation), arg4tmp, role);
...
PROCEDURE QAbstractItemModel_setHeaderData1 (self   : QAbstractItemModel;
  ...
  VAR
    ...
    arg4tmp          := LOOPHOLE(value.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_setHeaderData1(
             selfAdr, section, ORD(orientation), arg4tmp);
...
PROCEDURE QAbstractItemModel_mimeData
  (self: QAbstractItemModel; indexes: QModelIndexList; ): QMimeData =
  VAR
    ret    : ADDRESS;
    result : QMimeData;
    selfAdr: ADDRESS   := LOOPHOLE(self.cxxObj, ADDRESS);
  ...
  BEGIN
    ret :=
      QtAbstractItemModelRaw.QAbstractItemModel_mimeData(selfAdr, arg2tmp);
...
PROCEDURE QAbstractItemModel_dropMimeData (self  : QAbstractItemModel;
  ...
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_dropMimeData(
             selfAdr, arg2tmp, ORD(action), row, column, arg6tmp);
  END QAbstractItemModel_dropMimeData;

PROCEDURE QAbstractItemModel_supportedDropActions
  (self: QAbstractItemModel; ): DropActions =
  VAR
    ret    : INTEGER;
    result : DropActions;
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    ret := QtAbstractItemModelRaw.QAbstractItemModel_supportedDropActions(
             selfAdr);
...
PROCEDURE QAbstractItemModel_supportedDragActions
  ...
  VAR
    ...
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    ret := QtAbstractItemModelRaw.QAbstractItemModel_supportedDragActions(
             selfAdr);
    result := VAL(ret, DropActions);
    RETURN result;
...
PROCEDURE QAbstractItemModel_setSupportedDragActions
  (self: QAbstractItemModel; arg2: DropActions; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtAbstractItemModelRaw.QAbstractItemModel_setSupportedDragActions(
      selfAdr, ORD(arg2));
  END QAbstractItemModel_setSupportedDragActions;

PROCEDURE QAbstractItemModel_insertRows
  (self: QAbstractItemModel; row, count: INTEGER; parent: QModelIndex; ):
  BOOLEAN =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg4tmp          := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_insertRows(
             selfAdr, row, count, arg4tmp);
  END QAbstractItemModel_insertRows;

PROCEDURE QAbstractItemModel_insertRows1
  (self: QAbstractItemModel; row, count: INTEGER; ): BOOLEAN =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_insertRows1(
             selfAdr, row, count);
...
PROCEDURE QAbstractItemModel_insertColumns (self: QAbstractItemModel;
  ...
  VAR
    ...
    arg4tmp          := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_insertColumns(
             selfAdr, column, count, arg4tmp);
  END QAbstractItemModel_insertColumns;

PROCEDURE QAbstractItemModel_insertColumns1
  (self: QAbstractItemModel; column, count: INTEGER; ): BOOLEAN =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_insertColumns1(
             selfAdr, column, count);
...
PROCEDURE QAbstractItemModel_removeRows
  ...
  VAR
    ...
    arg4tmp          := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_removeRows(
             selfAdr, row, count, arg4tmp);
...
PROCEDURE QAbstractItemModel_removeRows1
  ...
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_removeRows1(
             selfAdr, row, count);
...
PROCEDURE QAbstractItemModel_removeColumns (self: QAbstractItemModel;
  ...
  VAR
    ...
    arg4tmp          := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_removeColumns(
             selfAdr, column, count, arg4tmp);
...
PROCEDURE QAbstractItemModel_removeColumns1
  ...
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_removeColumns1(
             selfAdr, column, count);
  END QAbstractItemModel_removeColumns1;

PROCEDURE QAbstractItemModel_insertRow
  (self: QAbstractItemModel; row: INTEGER; parent: QModelIndex; ):
  BOOLEAN =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg3tmp          := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_insertRow(
             selfAdr, row, arg3tmp);
  END QAbstractItemModel_insertRow;

PROCEDURE QAbstractItemModel_insertRow1
  (self: QAbstractItemModel; row: INTEGER; ): BOOLEAN =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN
      QtAbstractItemModelRaw.QAbstractItemModel_insertRow1(selfAdr, row);
  END QAbstractItemModel_insertRow1;

PROCEDURE QAbstractItemModel_insertColumn
  (self: QAbstractItemModel; column: INTEGER; parent: QModelIndex; ):
  BOOLEAN =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg3tmp          := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_insertColumn(
             selfAdr, column, arg3tmp);
  END QAbstractItemModel_insertColumn;

PROCEDURE QAbstractItemModel_insertColumn1
  (self: QAbstractItemModel; column: INTEGER; ): BOOLEAN =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_insertColumn1(
             selfAdr, column);
...
PROCEDURE QAbstractItemModel_removeRow
  ...
  VAR
    ...
    arg3tmp          := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_removeRow(
             selfAdr, row, arg3tmp);
...
PROCEDURE QAbstractItemModel_removeRow1
  ...
  BEGIN
    RETURN
      QtAbstractItemModelRaw.QAbstractItemModel_removeRow1(selfAdr, row);
...
PROCEDURE QAbstractItemModel_removeColumn
  ...
  VAR
    ...
    arg3tmp          := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_removeColumn(
             selfAdr, column, arg3tmp);
...
PROCEDURE QAbstractItemModel_removeColumn1
  ...
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_removeColumn1(
             selfAdr, column);
  END QAbstractItemModel_removeColumn1;

PROCEDURE QAbstractItemModel_fetchMore
  (self: QAbstractItemModel; parent: QModelIndex; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QAbstractItemModel_canFetchMore
  ...
  VAR
    ...
    arg2tmp          := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractItemModel_canFetchMore(
             selfAdr, arg2tmp);
  END QAbstractItemModel_canFetchMore;

PROCEDURE QAbstractItemModel_flags
  (self: QAbstractItemModel; index: QModelIndex; ): ItemFlags =
  VAR
    ret    : INTEGER;
    result : ItemFlags;
    selfAdr: ADDRESS   := LOOPHOLE(self.cxxObj, ADDRESS);
  ...
  BEGIN
    ret :=
      QtAbstractItemModelRaw.QAbstractItemModel_flags(selfAdr, arg2tmp);
    result := VAL(ret, ItemFlags);
    RETURN result;
  END QAbstractItemModel_flags;

PROCEDURE QAbstractItemModel_sort
  (self: QAbstractItemModel; column: INTEGER; order: SortOrder; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtAbstractItemModelRaw.QAbstractItemModel_sort(
      selfAdr, column, ORD(order));
  END QAbstractItemModel_sort;

PROCEDURE QAbstractItemModel_sort1
  (self: QAbstractItemModel; column: INTEGER; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QAbstractItemModel_buddy
  (self: QAbstractItemModel; index: QModelIndex; ): QModelIndex =
  VAR
    ret    : ADDRESS;
    result : QModelIndex;
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
  ...
  BEGIN
    ret :=
      QtAbstractItemModelRaw.QAbstractItemModel_buddy(selfAdr, arg2tmp);
...
PROCEDURE QAbstractItemModel_match (self : QAbstractItemModel;
  ...
  VAR
    ...
    arg4tmp                  := LOOPHOLE(value.cxxObj, ADDRESS);
  BEGIN
    ret := QtAbstractItemModelRaw.QAbstractItemModel_match(
             selfAdr, arg2tmp, role, arg4tmp, hits, ORD(flags));
...
PROCEDURE QAbstractItemModel_match1 (self : QAbstractItemModel;
  ...
  VAR
    ...
    arg4tmp                  := LOOPHOLE(value.cxxObj, ADDRESS);
  BEGIN
    ret := QtAbstractItemModelRaw.QAbstractItemModel_match1(
             selfAdr, arg2tmp, role, arg4tmp, hits);
...
PROCEDURE QAbstractItemModel_match2 (self : QAbstractItemModel;
  ...
  VAR
    ...
    arg4tmp                  := LOOPHOLE(value.cxxObj, ADDRESS);
  BEGIN
    ret := QtAbstractItemModelRaw.QAbstractItemModel_match2(
             selfAdr, arg2tmp, role, arg4tmp);
...
PROCEDURE QAbstractItemModel_span
  (self: QAbstractItemModel; index: QModelIndex; ): QSize =
  VAR
    ret    : ADDRESS;
    result : QSize;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  ...
  BEGIN
    ret :=
      QtAbstractItemModelRaw.QAbstractItemModel_span(selfAdr, arg2tmp);
...
PROCEDURE Cleanup_QAbstractItemModel
  (<* UNUSED *> READONLY self: WeakRef.T; ref: REFANY) =
...
PROCEDURE QAbstractTableModel_index
  (self: QAbstractTableModel; row, column: INTEGER; parent: QModelIndex; ):
  QModelIndex =
  VAR
    ret    : ADDRESS;
    result : QModelIndex;
    ...
    arg4tmp              := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    ret := QtAbstractItemModelRaw.QAbstractTableModel_index(
             selfAdr, row, column, arg4tmp);
...
PROCEDURE QAbstractTableModel_index1
  (self: QAbstractTableModel; row, column: INTEGER; ): QModelIndex =
  VAR
    ret    : ADDRESS;
    result : QModelIndex;
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    ret := QtAbstractItemModelRaw.QAbstractTableModel_index1(
             selfAdr, row, column);
...
PROCEDURE QAbstractTableModel_dropMimeData (self  : QAbstractTableModel;
  ...
  VAR
    ...
    arg6tmp          := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractTableModel_dropMimeData(
             selfAdr, arg2tmp, ORD(action), row, column, arg6tmp);
  END QAbstractTableModel_dropMimeData;

PROCEDURE Cleanup_QAbstractTableModel
  (<* UNUSED *> READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
  QAbstractTableModel = QAbstractTableModelPublic BRANDED OBJECT
                        OVERRIDES
...
PROCEDURE QAbstractListModel_index
  (self: QAbstractListModel; row, column: INTEGER; parent: QModelIndex; ):
  QModelIndex =
  VAR
    ret    : ADDRESS;
    result : QModelIndex;
    ...
    arg4tmp              := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    ret := QtAbstractItemModelRaw.QAbstractListModel_index(
             selfAdr, row, column, arg4tmp);
...
PROCEDURE QAbstractListModel_index1
  (self: QAbstractListModel; row, column: INTEGER; ): QModelIndex =
  VAR
    ret    : ADDRESS;
    result : QModelIndex;
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    ret := QtAbstractItemModelRaw.QAbstractListModel_index1(
             selfAdr, row, column);
...
PROCEDURE QAbstractListModel_index2
  (self: QAbstractListModel; row: INTEGER; ): QModelIndex =
  VAR
    ret    : ADDRESS;
    result : QModelIndex;
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QAbstractListModel_dropMimeData (self  : QAbstractListModel;
  ...
  VAR
    ...
    arg6tmp          := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    RETURN QtAbstractItemModelRaw.QAbstractListModel_dropMimeData(
             selfAdr, arg2tmp, ORD(action), row, column, arg6tmp);
  END QAbstractListModel_dropMimeData;

PROCEDURE Cleanup_QAbstractListModel
  (<* UNUSED *> READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
  QAbstractListModel = QAbstractListModelPublic BRANDED OBJECT
                       OVERRIDES
