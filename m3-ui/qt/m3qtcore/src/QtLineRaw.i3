...
<* EXTERNAL New_QLine1 *>
PROCEDURE New_QLine1 ( pt1, pt2: ADDRESS;
): QLine;

<* EXTERNAL New_QLine2 *>
PROCEDURE New_QLine2 (x1, y1, x2, y2: C.int;
): QLine;
...
PROCEDURE QLine_EqualEqual ( self: QLine;
 d: ADDRESS;
): BOOLEAN;

<* EXTERNAL QLine_NotEqual *>
PROCEDURE QLine_NotEqual ( self: QLine;
 d: ADDRESS;
): BOOLEAN;
...
PROCEDURE New_QLineF1 ( pt1, pt2: ADDRESS;
): QLineF;

<* EXTERNAL New_QLineF2 *>
PROCEDURE New_QLineF2 (x1, y1, x2, y2: C.double;
): QLineF;

<* EXTERNAL New_QLineF3 *>
PROCEDURE New_QLineF3 ( line: ADDRESS;
): QLineF;

<* EXTERNAL FromPolar *>
PROCEDURE FromPolar (length, angle: C.double;
): ADDRESS;
...
PROCEDURE QLineF_angleTo ( self: QLineF;
 l: ADDRESS;
): C.double;
...
PROCEDURE QLineF_intersect ( self: QLineF;
 l, intersectionPoint: ADDRESS;
): C.int;

<* EXTERNAL QLineF_angle1 *>
PROCEDURE QLineF_angle1 ( self: QLineF;
 l: ADDRESS;
): C.double;
...
PROCEDURE QLineF_EqualEqual ( self: QLineF;
 d: ADDRESS;
): BOOLEAN;

<* EXTERNAL QLineF_NotEqual *>
PROCEDURE QLineF_NotEqual ( self: QLineF;
 d: ADDRESS;
): BOOLEAN;
