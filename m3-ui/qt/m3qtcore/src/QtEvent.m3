...
PROCEDURE New_QEvent0 (self:QEvent;type: Type;
): QEvent =
VAR
result : ADDRESS;
BEGIN
...
PROCEDURE QEvent_type ( self: QEvent;
): Type =
VAR
...
PROCEDURE QEvent_spontaneous ( self: QEvent;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QEvent_setAccepted ( self: QEvent;
accepted: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QEvent_isAccepted ( self: QEvent;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE RegisterEventType (hint: INTEGER;
): INTEGER =
BEGIN
RETURN QtEventRaw.RegisterEventType(hint);
END RegisterEventType;

PROCEDURE Cleanup_QEvent(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QEvent := ref;
BEGIN
  Delete_QEvent(obj);
 END Cleanup_QEvent;
...
PROCEDURE QTimerEvent_timerId ( self: QTimerEvent;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE Cleanup_QTimerEvent(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
QTimerEvent =
QTimerEventPublic BRANDED OBJECT
OVERRIDES
...
PROCEDURE New_QChildEvent0 (self:QChildEvent;type: Type;
 child: QObject;
): QChildEvent =
VAR
result : ADDRESS;
...
PROCEDURE QChildEvent_child ( self: QChildEvent;
): QObject =
VAR
...
PROCEDURE QChildEvent_added ( self: QChildEvent;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QChildEvent_polished ( self: QChildEvent;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QChildEvent_removed ( self: QChildEvent;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE Cleanup_QChildEvent(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
QChildEvent =
QChildEventPublic BRANDED OBJECT
OVERRIDES
...
PROCEDURE New_QDynamicPropertyChangeEvent0 (self:QDynamicPropertyChangeEvent;READONLY name: QByteArray;
...
PROCEDURE Delete_QDynamicPropertyChangeEvent ( self: QDynamicPropertyChangeEvent;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QDynamicPropertyChangeEvent_propertyName ( self: QDynamicPropertyChangeEvent;
): QByteArray =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE Cleanup_QDynamicPropertyChangeEvent(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QDynamicPropertyChangeEvent := ref;
BEGIN
  Delete_QDynamicPropertyChangeEvent(obj);
 END Cleanup_QDynamicPropertyChangeEvent;

PROCEDURE Destroy_QDynamicPropertyChangeEvent(self : QDynamicPropertyChangeEvent) =
BEGIN
  EVAL WeakRef.FromRef(self,Cleanup_QDynamicPropertyChangeEvent);
