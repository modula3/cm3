...
PROCEDURE New_QSize1 (self:QSize;w, h: INTEGER;
): QSize =
VAR
result : ADDRESS;
BEGIN
...
PROCEDURE QSize_isNull ( self: QSize;
): BOOLEAN =
VAR
...
PROCEDURE QSize_isEmpty ( self: QSize;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QSize_isValid ( self: QSize;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QSize_width ( self: QSize;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QSize_height ( self: QSize;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QSize_setWidth ( self: QSize;
w: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QSize_setHeight ( self: QSize;
h: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QSize_scale ( self: QSize;
w, h: INTEGER;
...
PROCEDURE QSize_scale1 ( self, s: QSize;
mode: AspectRatioMode;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QSize_expandedTo ( self, arg2: QSize;
): QSize =
VAR
...
PROCEDURE QSize_boundedTo ( self, arg2: QSize;
): QSize =
VAR
ret:ADDRESS; result : QSize;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QSize_rwidth ( self: QSize;
...
PROCEDURE QSize_rheight ( self: QSize;
): UNTRACED REF INTEGER =
VAR
ret : UNTRACED REF C.int;
result := NEW(UNTRACED REF INTEGER);
...
PROCEDURE QSize_PlusEqual ( self, arg2: QSize;
): QSize =
VAR
ret:ADDRESS; result : QSize;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QSize_MinusEqual ( self, arg2: QSize;
): QSize =
VAR
ret:ADDRESS; result : QSize;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QSize_MultiplyEqual ( self: QSize;
c: LONGREAL;
): QSize =
VAR
ret:ADDRESS; result : QSize;
...
PROCEDURE QSize_DivideEqual ( self: QSize;
c: LONGREAL;
): QSize =
VAR
ret:ADDRESS; result : QSize;
...
PROCEDURE Cleanup_QSize(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QSize := ref;
BEGIN
  Delete_QSize(obj);
 END Cleanup_QSize;
...
PROCEDURE New_QSizeF1 (self:QSizeF; sz: QSize;
): QSizeF =
VAR
result : ADDRESS;
...
PROCEDURE New_QSizeF2 (self:QSizeF;w, h: LONGREAL;
): QSizeF =
VAR
result : ADDRESS;
BEGIN
...
PROCEDURE QSizeF_isNull ( self: QSizeF;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QSizeF_isEmpty ( self: QSizeF;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QSizeF_isValid ( self: QSizeF;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QSizeF_width ( self: QSizeF;
): LONGREAL =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QSizeF_height ( self: QSizeF;
): LONGREAL =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QSizeF_setWidth ( self: QSizeF;
w: LONGREAL;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QSizeF_setHeight ( self: QSizeF;
h: LONGREAL;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QSizeF_scale ( self: QSizeF;
w, h: LONGREAL;
mode: AspectRatioMode;
) =
VAR
...
PROCEDURE QSizeF_scale1 ( self, s: QSizeF;
mode: AspectRatioMode;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QSizeF_expandedTo ( self, arg2: QSizeF;
): QSizeF =
VAR
...
PROCEDURE QSizeF_boundedTo ( self, arg2: QSizeF;
): QSizeF =
VAR
ret:ADDRESS; result : QSizeF;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QSizeF_rwidth ( self: QSizeF;
...
PROCEDURE QSizeF_rheight ( self: QSizeF;
): UNTRACED REF LONGREAL =
VAR
ret : UNTRACED REF C.double;
result := NEW(UNTRACED REF LONGREAL);
...
PROCEDURE QSizeF_PlusEqual ( self, arg2: QSizeF;
): QSizeF =
VAR
ret:ADDRESS; result : QSizeF;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QSizeF_MinusEqual ( self, arg2: QSizeF;
): QSizeF =
VAR
ret:ADDRESS; result : QSizeF;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QSizeF_MultiplyEqual ( self: QSizeF;
c: LONGREAL;
): QSizeF =
VAR
ret:ADDRESS; result : QSizeF;
...
PROCEDURE QSizeF_DivideEqual ( self: QSizeF;
c: LONGREAL;
): QSizeF =
VAR
ret:ADDRESS; result : QSizeF;
...
PROCEDURE QSizeF_toSize ( self: QSizeF;
): QSize =
VAR
ret:ADDRESS; result : QSize;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE Cleanup_QSizeF(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QSizeF := ref;
BEGIN
  Delete_QSizeF(obj);
 END Cleanup_QSizeF;
