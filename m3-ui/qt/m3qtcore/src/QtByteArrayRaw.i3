...
PROCEDURE New_QByteArray1 ( arg1: C.char_star;
): QByteArray;

<* EXTERNAL New_QByteArray2 *>
PROCEDURE New_QByteArray2 ( arg1: C.char_star;
size: C.int;
): QByteArray;

<* EXTERNAL New_QByteArray3 *>
PROCEDURE New_QByteArray3 (size: C.int;
c: C.char;
): QByteArray;

<* EXTERNAL New_QByteArray4 *>
PROCEDURE New_QByteArray4 (size, arg2: C.int;
): QByteArray;

<* EXTERNAL New_QByteArray5 *>
PROCEDURE New_QByteArray5 ( arg1: ADDRESS;
): QByteArray;
...
PROCEDURE QByteArray_count2 ( self: QByteArray;
 a: ADDRESS;
): C.int;
...
PROCEDURE QByteArray_startsWith ( self: QByteArray;
 a: ADDRESS;
): BOOLEAN;
...
PROCEDURE QByteArray_endsWith ( self: QByteArray;
 a: ADDRESS;
): BOOLEAN;
...
PROCEDURE QByteArray_prepend3 ( self: QByteArray;
 a: ADDRESS;
): ADDRESS;
...
PROCEDURE QByteArray_toPercentEncoding ( self: QByteArray;
 exclude, include: ADDRESS;
percent: C.char;
): ADDRESS;

<* EXTERNAL QByteArray_toPercentEncoding1 *>
PROCEDURE QByteArray_toPercentEncoding1 ( self: QByteArray;
 exclude, include: ADDRESS;
): ADDRESS;

<* EXTERNAL QByteArray_toPercentEncoding2 *>
PROCEDURE QByteArray_toPercentEncoding2 ( self: QByteArray;
 exclude: ADDRESS;
): ADDRESS;
...
PROCEDURE FromRawData ( arg1: C.char_star;
size: C.int;
): ADDRESS;

<* EXTERNAL FromBase64 *>
PROCEDURE FromBase64 ( base64: ADDRESS;
): ADDRESS;

<* EXTERNAL FromHex *>
PROCEDURE FromHex ( hexEncoded: ADDRESS;
): ADDRESS;

<* EXTERNAL FromPercentEncoding *>
PROCEDURE FromPercentEncoding ( pctEncoded: ADDRESS;
percent: C.char;
): ADDRESS;

<* EXTERNAL FromPercentEncoding1 *>
PROCEDURE FromPercentEncoding1 ( pctEncoded: ADDRESS;
): ADDRESS;
...
PROCEDURE QByteArray_push_back2 ( self: QByteArray;
 a: ADDRESS;
);
...
PROCEDURE QByteArray_push_front2 ( self: QByteArray;
 a: ADDRESS;
);
