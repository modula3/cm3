...
PROCEDURE New_QObject0 (self: QObject; parent: QObject; ): QObject =
  VAR
    result : ADDRESS;
...
PROCEDURE QObject_event (self: QObject; arg2: REFANY (*QEvent*); ):
  BOOLEAN =
  VAR
...
PROCEDURE QObject_eventFilter
  (self, arg2: QObject; arg3: REFANY (*QEvent*); ): BOOLEAN =
  VAR
    arg1tmp := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QObject_setObjectName (self: QObject; name: TEXT; ) =
  VAR
    arg1tmp   := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QObject_isWidgetType (self: QObject; ): BOOLEAN =
  VAR arg1tmp := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtObjectRaw.QObject_isWidgetType(arg1tmp);
  END QObject_isWidgetType;

PROCEDURE QObject_signalsBlocked (self: QObject; ): BOOLEAN =
  VAR arg1tmp := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtObjectRaw.QObject_signalsBlocked(arg1tmp);
  END QObject_signalsBlocked;

PROCEDURE QObject_blockSignals (self: QObject; b: BOOLEAN; ): BOOLEAN =
  VAR arg1tmp := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtObjectRaw.QObject_blockSignals(arg1tmp, b);
  END QObject_blockSignals;

PROCEDURE QObject_startTimer (self: QObject; interval: INTEGER; ):
  INTEGER =
  VAR arg1tmp := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QObject_killTimer (self: QObject; id: INTEGER; ) =
  VAR arg1tmp := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QObject_parent (self: QObject; ): QObject =
  VAR
    ret    : ADDRESS;
    result : QObject;
    arg1tmp          := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QObject_inherits (self: QObject; classname: TEXT; ): BOOLEAN =
  VAR
    arg1tmp              := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp: C.char_star;
    result : BOOLEAN;
...
REVEAL
  QObject = QObjectPublic BRANDED OBJECT
            OVERRIDES
              init_0             := New_QObject0;
              init_1             := New_QObject1;
              event              := QObject_event;
