...
PROCEDURE New_QDate1 (self:QDate;y, m, d: INTEGER;
): QDate =
VAR
result : ADDRESS;
BEGIN
...
PROCEDURE ShortMonthName (month: INTEGER;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE ShortMonthName1 (month: INTEGER;
type: MonthNameType;
): TEXT =
VAR
ret : ADDRESS;
...
PROCEDURE ShortDayName (weekday: INTEGER;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE ShortDayName1 (weekday: INTEGER;
type: MonthNameType;
): TEXT =
VAR
ret : ADDRESS;
...
PROCEDURE LongMonthName (month: INTEGER;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE LongMonthName1 (month: INTEGER;
type: MonthNameType;
): TEXT =
VAR
ret : ADDRESS;
...
PROCEDURE LongDayName (weekday: INTEGER;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE LongDayName1 (weekday: INTEGER;
type: MonthNameType;
): TEXT =
VAR
ret : ADDRESS;
...
PROCEDURE QDate_daysTo ( self, arg2: QDate;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDate_Equals ( self, other: QDate;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDate_NotEquals ( self, other: QDate;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE QDate_LessThan ( self, other: QDate;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE QDate_LessThanEquals ( self, other: QDate;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE QDate_GreaterThan ( self, other: QDate;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE QDate_GreaterThanEquals ( self, other: QDate;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE QDate_FromString ( s: TEXT;
f: DateFormat;
): QDate =
VAR
ret:ADDRESS; result : QDate;
...
PROCEDURE QDate_FromString1 ( s: TEXT;
): QDate =
VAR
ret:ADDRESS; result : QDate;
qstr_s := NEW(QString).initQString(s);
...
PROCEDURE QDate_FromString2 ( s, format: TEXT;
): QDate =
VAR
ret:ADDRESS; result : QDate;
qstr_s := NEW(QString).initQString(s);
...
PROCEDURE QDate_IsValid1 (y, m, d: INTEGER;
): BOOLEAN =
BEGIN
...
PROCEDURE FromJulianDay (jd: INTEGER;
): QDate =
VAR
ret:ADDRESS; result : QDate;
BEGIN
...
PROCEDURE Cleanup_QDate(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QDate := ref;
BEGIN
  Delete_QDate(obj);
 END Cleanup_QDate;
...
PROCEDURE New_QTime1 (self:QTime;h, m, s, ms: INTEGER;
): QTime =
VAR
result : ADDRESS;
BEGIN
...
PROCEDURE New_QTime2 (self:QTime;h, m, s: INTEGER;
): QTime =
VAR
result : ADDRESS;
BEGIN
...
PROCEDURE New_QTime3 (self:QTime;h, m: INTEGER;
): QTime =
VAR
result : ADDRESS;
BEGIN
...
PROCEDURE QTime_secsTo ( self, arg2: QTime;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(arg2.cxxObj,ADDRESS);
...
PROCEDURE QTime_msecsTo ( self, arg2: QTime;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(arg2.cxxObj,ADDRESS);
...
PROCEDURE QTime_Equals ( self, other: QTime;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE QTime_NotEquals ( self, other: QTime;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE QTime_LessThan ( self, other: QTime;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE QTime_LessThanEquals ( self, other: QTime;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE QTime_GreaterThan ( self, other: QTime;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE QTime_GreaterThanEquals ( self, other: QTime;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE QTime_FromString ( s: TEXT;
f: DateFormat;
): QTime =
VAR
ret:ADDRESS; result : QTime;
...
PROCEDURE QTime_FromString1 ( s: TEXT;
): QTime =
VAR
ret:ADDRESS; result : QTime;
qstr_s := NEW(QString).initQString(s);
...
PROCEDURE QTime_FromString2 ( s, format: TEXT;
): QTime =
VAR
ret:ADDRESS; result : QTime;
qstr_s := NEW(QString).initQString(s);
...
PROCEDURE IsValid1 (h, m, s, ms: INTEGER;
): BOOLEAN =
BEGIN
RETURN QtDateTimeRaw.IsValid1(h, m, s, ms);
END IsValid1;

PROCEDURE IsValid2 (h, m, s: INTEGER;
): BOOLEAN =
BEGIN
...
PROCEDURE Cleanup_QTime(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QTime := ref;
BEGIN
  Delete_QTime(obj);
 END Cleanup_QTime;
...
PROCEDURE New_QDateTime1 (self:QDateTime; arg1: QDate;
): QDateTime =
VAR
result : ADDRESS;
...
PROCEDURE New_QDateTime2 (self:QDateTime; arg1: QDate;
 arg2: QTime;
spec: TimeSpec;
): QDateTime =
VAR
...
PROCEDURE New_QDateTime3 (self:QDateTime; arg1: QDate;
 arg2: QTime;
): QDateTime =
VAR
result : ADDRESS;
...
PROCEDURE New_QDateTime4 (self:QDateTime; other: QDateTime;
): QDateTime =
VAR
result : ADDRESS;
...
PROCEDURE QDateTime_Assign ( self, other: QDateTime;
): QDateTime =
VAR
ret:ADDRESS; result : QDateTime;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QDateTime_daysTo ( self, arg2: QDateTime;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(arg2.cxxObj,ADDRESS);
...
PROCEDURE QDateTime_secsTo ( self, arg2: QDateTime;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(arg2.cxxObj,ADDRESS);
...
PROCEDURE QDateTime_Equals ( self, other: QDateTime;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE QDateTime_NotEquals ( self, other: QDateTime;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE QDateTime_LessThan ( self, other: QDateTime;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE QDateTime_LessThanEquals ( self, other: QDateTime;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE QDateTime_GreaterThan ( self, other: QDateTime;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE QDateTime_GreaterThanEquals ( self, other: QDateTime;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
PROCEDURE FromString2 ( s, format: TEXT;
): QDateTime =
VAR
ret:ADDRESS; result : QDateTime;
qstr_s := NEW(QString).initQString(s);
...
PROCEDURE FromTime_t (secsSince1Jan1970UTC: CARDINAL;
): QDateTime =
VAR
ret:ADDRESS; result : QDateTime;
BEGIN
...
PROCEDURE Cleanup_QDateTime(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
QDateTime =
QDateTimePublic BRANDED OBJECT
OVERRIDES
