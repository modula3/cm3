...
TYPE
  ...
  QRectPublic = BRANDED OBJECT
                ...
                METHODS
                  init_0     (): QRect;
                  init_1     (topleft, bottomright: QPoint; ): QRect;
                  init_2     (topleft: QPoint; size: QSize; ): QRect;
                  init       (left, top, width, height: INTEGER; ): QRect;
                  isNull     (): BOOLEAN;
                  isEmpty    (): BOOLEAN;
                  isValid    (): BOOLEAN;
                  left       (): INTEGER;
                  ...
                  translate1      (p: QPoint; );
                  translated      (dx, dy: INTEGER; ): QRect;
                  translated1     (p: QPoint; ): QRect;
                  moveTo          (x, t: INTEGER; );
                  moveTo1         (p: QPoint; );
                  ...
                  adjusted        (x1, y1, x2, y2: INTEGER; ): QRect;
                  size            (): QSize;
                  width           (): INTEGER;
                  height          (): INTEGER;
                  setWidth        (w: INTEGER; );
                  setHeight       (h: INTEGER; );
                  setSize         (s: QSize; );
                  PlusEqual       (r: QRect; ): QRect;
                  MinusEqual      (r: QRect; ): QRect;
                  MultiplyEqual   (r: QRect; ): QRect;
                  DivideEqual     (r: QRect; ): QRect;
                  contains        (p: QPoint; proper: BOOLEAN; ): BOOLEAN;
                  contains1       (p: QPoint; ): BOOLEAN;
                  contains2       (x, y: INTEGER; ): BOOLEAN;
                  contains3   (x, y: INTEGER; proper: BOOLEAN; ): BOOLEAN;
                  contains4   (r: QRect; proper: BOOLEAN; ): BOOLEAN;
                  contains5   (r: QRect; ): BOOLEAN;
                  unite       (r: QRect; ): QRect;
                  united      (other: QRect; ): QRect;
                  intersect   (r: QRect; ): QRect;
                  intersected (other: QRect; ): QRect;
                  intersects  (r: QRect; ): BOOLEAN;
                  destroyCxx  ();
                END;
  ...
  QRectFPublic = BRANDED OBJECT
                 ...
                 METHODS
                   init_0  (): QRectF;
                   init_1  (topleft: QPointF; size: QSizeF; ): QRectF;
                   init_2  (topleft, bottomRight: QPointF; ): QRectF;
                   init_3  (left, top, width, height: LONGREAL; ): QRectF;
                   init_4  (rect: QRect; ): QRectF;
                   isNull  (): BOOLEAN;
                   isEmpty (): BOOLEAN;
                   isValid (): BOOLEAN;
                   normalized      (): QRectF;
                   ...
                   translated      (dx, dy: LONGREAL; ): QRectF;
                   translated1     (p: QPointF; ): QRectF;
                   moveTo          (x, t: LONGREAL; );
                   moveTo1         (p: QPointF; );
                   ...
                   adjusted        (x1, y1, x2, y2: LONGREAL; ): QRectF;
                   size            (): QSizeF;
                   width           (): LONGREAL;
                   height          (): LONGREAL;
                   setWidth        (w: LONGREAL; );
                   ...
                   setSize         (s: QSizeF; );
                   PlusEqual       (r: QRectF; ): QRectF;
                   MinusEqual      (r: QRectF; ): QRectF;
                   MultiplyEqual   (r: QRectF; ): QRectF;
                   DivideEqual     (r: QRectF; ): QRectF;
                   contains        (p: QPointF; ): BOOLEAN;
                   contains1       (x, y: LONGREAL; ): BOOLEAN;
                   contains2       (r: QRectF; ): BOOLEAN;
                   unite           (r: QRectF; ): QRectF;
                   united          (other: QRectF; ): QRectF;
                   intersect       (r: QRectF; ): QRectF;
                   intersected     (other: QRectF; ): QRectF;
                   intersects      (r: QRectF; ): BOOLEAN;
                   toRect          (): QRect;
                   toAlignedRect   (): QRect;
                   destroyCxx      ();
                 END;
