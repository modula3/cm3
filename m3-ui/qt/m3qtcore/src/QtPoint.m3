...
PROCEDURE New_QPoint1 (self:QPoint;xpos, ypos: INTEGER;
): QPoint =
VAR
result : ADDRESS;
BEGIN
...
PROCEDURE QPoint_isNull ( self: QPoint;
): BOOLEAN =
VAR
...
PROCEDURE QPoint_x ( self: QPoint;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QPoint_y ( self: QPoint;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QPoint_setX ( self: QPoint;
x: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QPoint_setY ( self: QPoint;
y: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QPoint_manhattanLength ( self: QPoint;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QPoint_rx ( self: QPoint;
...
PROCEDURE QPoint_ry ( self: QPoint;
): UNTRACED REF INTEGER =
VAR
ret : UNTRACED REF C.int;
result := NEW(UNTRACED REF INTEGER);
...
PROCEDURE QPoint_PlusEqual ( self, p: QPoint;
): QPoint =
VAR
...
PROCEDURE QPoint_MinusEqual ( self, p: QPoint;
): QPoint =
VAR
ret:ADDRESS; result : QPoint;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QPoint_MultiplyEqual ( self: QPoint;
c: LONGREAL;
): QPoint =
VAR
ret:ADDRESS; result : QPoint;
...
PROCEDURE QPoint_DivideEqual ( self: QPoint;
c: LONGREAL;
): QPoint =
VAR
ret:ADDRESS; result : QPoint;
...
PROCEDURE Cleanup_QPoint(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QPoint := ref;
BEGIN
  Delete_QPoint(obj);
 END Cleanup_QPoint;
...
PROCEDURE New_QPointF1 (self:QPointF; p: QPoint;
): QPointF =
VAR
result : ADDRESS;
...
PROCEDURE New_QPointF2 (self:QPointF;xpos, ypos: LONGREAL;
): QPointF =
VAR
result : ADDRESS;
BEGIN
...
PROCEDURE QPointF_manhattanLength ( self: QPointF;
): LONGREAL =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QPointF_isNull ( self: QPointF;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QPointF_x ( self: QPointF;
): LONGREAL =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QPointF_y ( self: QPointF;
): LONGREAL =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QPointF_setX ( self: QPointF;
x: LONGREAL;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QPointF_setY ( self: QPointF;
y: LONGREAL;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QPointF_rx ( self: QPointF;
...
PROCEDURE QPointF_ry ( self: QPointF;
): UNTRACED REF LONGREAL =
VAR
ret : UNTRACED REF C.double;
result := NEW(UNTRACED REF LONGREAL);
...
PROCEDURE QPointF_PlusEqual ( self, p: QPointF;
): QPointF =
VAR
...
PROCEDURE QPointF_MinusEqual ( self, p: QPointF;
): QPointF =
VAR
ret:ADDRESS; result : QPointF;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QPointF_MultiplyEqual ( self: QPointF;
c: LONGREAL;
): QPointF =
VAR
ret:ADDRESS; result : QPointF;
...
PROCEDURE QPointF_DivideEqual ( self: QPointF;
c: LONGREAL;
): QPointF =
VAR
ret:ADDRESS; result : QPointF;
...
PROCEDURE QPointF_toPoint ( self: QPointF;
): QPoint =
VAR
ret:ADDRESS; result : QPoint;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE Cleanup_QPointF(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QPointF := ref;
BEGIN
  Delete_QPointF(obj);
 END Cleanup_QPointF;
