...
PROCEDURE QRect_Or (self, r: QRect; ): QRect =
  VAR
    ret    : ADDRESS;
    result : QRect;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  ...
  BEGIN
    ret := QtRectRaw.QRect_Or(selfAdr, arg2tmp);
...
PROCEDURE QRect_And (self, r: QRect; ): QRect =
  VAR
    ret    : ADDRESS;
    result : QRect;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(r.cxxObj, ADDRESS);
  BEGIN
    ret := QtRectRaw.QRect_And(selfAdr, arg2tmp);
...
PROCEDURE QRect_OrEqual (self, r: QRect; ): QRect =
  VAR
    ret    : ADDRESS;
    result : QRect;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(r.cxxObj, ADDRESS);
  BEGIN
    ret := QtRectRaw.QRect_OrEqual(selfAdr, arg2tmp);
...
PROCEDURE QRect_AndEqual (self, r: QRect; ): QRect =
  VAR
    ret    : ADDRESS;
    result : QRect;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(r.cxxObj, ADDRESS);
  BEGIN
    ret := QtRectRaw.QRect_AndEqual(selfAdr, arg2tmp);
...
REVEAL
  QRect = QRectPublic BRANDED OBJECT
          OVERRIDES
            ...
            Or              := QRect_Or;
            And             := QRect_And;
            OrEqual         := QRect_OrEqual;
            AndEqual        := QRect_AndEqual;
...
PROCEDURE QRectF_Or (self, r: QRectF; ): QRectF =
  VAR
    ret    : ADDRESS;
    result : QRectF;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(r.cxxObj, ADDRESS);
  BEGIN
    ret := QtRectRaw.QRectF_Or(selfAdr, arg2tmp);
...
PROCEDURE QRectF_And (self, r: QRectF; ): QRectF =
  VAR
    ret    : ADDRESS;
    result : QRectF;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(r.cxxObj, ADDRESS);
  BEGIN
    ret := QtRectRaw.QRectF_And(selfAdr, arg2tmp);
...
PROCEDURE QRectF_OrEqual (self, r: QRectF; ): QRectF =
  VAR
    ret    : ADDRESS;
    result : QRectF;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(r.cxxObj, ADDRESS);
  BEGIN
    ret := QtRectRaw.QRectF_OrEqual(selfAdr, arg2tmp);
...
PROCEDURE QRectF_AndEqual (self, r: QRectF; ): QRectF =
  VAR
    ret    : ADDRESS;
    result : QRectF;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(r.cxxObj, ADDRESS);
  BEGIN
    ret := QtRectRaw.QRectF_AndEqual(selfAdr, arg2tmp);
...
REVEAL
  QRectF = QRectFPublic BRANDED OBJECT
           OVERRIDES
             ...
             Or              := QRectF_Or;
             And             := QRectF_And;
             OrEqual         := QRectF_OrEqual;
             AndEqual        := QRectF_AndEqual;
