...
<* EXTERNAL QRect_Or *>
PROCEDURE QRect_Or (self: QRect; r: ADDRESS; ): ADDRESS;

<* EXTERNAL QRect_And *>
PROCEDURE QRect_And (self: QRect; r: ADDRESS; ): ADDRESS;

<* EXTERNAL QRect_OrEqual *>
PROCEDURE QRect_OrEqual (self: QRect; r: ADDRESS; ): ADDRESS;

<* EXTERNAL QRect_AndEqual *>
PROCEDURE QRect_AndEqual (self: QRect; r: ADDRESS; ): ADDRESS;
...
<* EXTERNAL QRectF_Or *>
PROCEDURE QRectF_Or (self: QRectF; r: ADDRESS; ): ADDRESS;

<* EXTERNAL QRectF_And *>
PROCEDURE QRectF_And (self: QRectF; r: ADDRESS; ): ADDRESS;

<* EXTERNAL QRectF_OrEqual *>
PROCEDURE QRectF_OrEqual (self: QRectF; r: ADDRESS; ): ADDRESS;

<* EXTERNAL QRectF_AndEqual *>
PROCEDURE QRectF_AndEqual (self: QRectF; r: ADDRESS; ): ADDRESS;
