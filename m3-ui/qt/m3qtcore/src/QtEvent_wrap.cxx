...
SWIGEXPORT long Modula3_QTimerEventToQEvent(long objectRef) {
    long baseptr = 0;
    *(QEvent **)&baseptr = *(QTimerEvent **)&objectRef;
    return baseptr;
}

SWIGEXPORT long Modula3_QChildEventToQEvent(long objectRef) {
    long baseptr = 0;
    *(QEvent **)&baseptr = *(QChildEvent **)&objectRef;
    return baseptr;
}

SWIGEXPORT long Modula3_QDynamicPropertyChangeEventToQEvent(long objectRef) {
    long baseptr = 0;
    *(QEvent **)&baseptr = *(QDynamicPropertyChangeEvent **)&objectRef;
    return baseptr;
}
