...
SWIGEXPORT void ProcessEvents(QEventLoop::ProcessEventsFlags flags) {
...
SWIGEXPORT void ProcessEvents2(QEventLoop::ProcessEventsFlags flags, int maxtime) {
  QEventLoop::ProcessEventsFlags arg1 ;
  int arg2 ;
...
SWIGEXPORT long Modula3_QCoreApplicationToQObject(long objectRef) {
    long baseptr = 0;
    *(QObject **)&baseptr = *(QCoreApplication **)&objectRef;
    return baseptr;
}
