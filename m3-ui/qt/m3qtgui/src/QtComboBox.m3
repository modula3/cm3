...
PROCEDURE New_QComboBox0 (self:QComboBox; parent: QWidget;
): QComboBox =
VAR
result : ADDRESS;
...
PROCEDURE QComboBox_maxVisibleItems ( self: QComboBox;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QComboBox_setMaxVisibleItems ( self: QComboBox;
maxItems: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_count ( self: QComboBox;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QComboBox_setMaxCount ( self: QComboBox;
max: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_maxCount ( self: QComboBox;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QComboBox_autoCompletion ( self: QComboBox;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QComboBox_setAutoCompletion ( self: QComboBox;
enable: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
VAR
ret:INTEGER; result : CaseSensitivity;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QComboBox_setAutoCompletionCaseSensitivity ( self: QComboBox;
sensitivity: CaseSensitivity;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtComboBoxRaw.QComboBox_setAutoCompletionCaseSensitivity(selfAdr, ORD(sensitivity));
END QComboBox_setAutoCompletionCaseSensitivity;

PROCEDURE QComboBox_duplicatesEnabled ( self: QComboBox;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QComboBox_setDuplicatesEnabled ( self: QComboBox;
enable: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_setFrame ( self: QComboBox;
arg2: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_hasFrame ( self: QComboBox;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QComboBox_findText ( self: QComboBox;
 text: TEXT;
flags: MatchFlags;
): INTEGER =
VAR
...
PROCEDURE QComboBox_findText1 ( self: QComboBox;
 text: TEXT;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_findData ( self: QComboBox;
 data: QVariant;
role: INTEGER;
flags: MatchFlags;
): INTEGER =
...
BEGIN
RETURN QtComboBoxRaw.QComboBox_findData(selfAdr, arg2tmp, role, ORD(flags));
END QComboBox_findData;

PROCEDURE QComboBox_findData1 ( self: QComboBox;
 data: QVariant;
role: INTEGER;
): INTEGER =
VAR
...
PROCEDURE QComboBox_findData2 ( self: QComboBox;
 data: QVariant;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_insertPolicy ( self: QComboBox;
): InsertPolicy =
VAR
ret:INTEGER; result : InsertPolicy;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QComboBox_setInsertPolicy ( self: QComboBox;
policy: InsertPolicy;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
VAR
ret:INTEGER; result : SizeAdjustPolicy;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QComboBox_setSizeAdjustPolicy ( self: QComboBox;
...
PROCEDURE QComboBox_minimumContentsLength ( self: QComboBox;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QComboBox_setMinimumContentsLength ( self: QComboBox;
characters: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_iconSize ( self: QComboBox;
): QSize =
VAR
...
PROCEDURE QComboBox_setIconSize ( self: QComboBox;
 size: QSize;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_isEditable ( self: QComboBox;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QComboBox_setEditable ( self: QComboBox;
editable: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_setLineEdit ( self: QComboBox;
 edit: QLineEdit;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_lineEdit ( self: QComboBox;
): QLineEdit =
VAR
ret:ADDRESS; result : QLineEdit;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QComboBox_setValidator ( self: QComboBox;
 v: QValidator;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_validator ( self: QComboBox;
): QValidator =
VAR
...
PROCEDURE QComboBox_setCompleter ( self: QComboBox;
 c: QCompleter;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_completer ( self: QComboBox;
): QCompleter =
VAR
...
PROCEDURE QComboBox_setItemDelegate ( self: QComboBox;
...
PROCEDURE QComboBox_model ( self: QComboBox;
): QAbstractItemModel =
VAR
...
PROCEDURE QComboBox_setModel ( self: QComboBox;
...
PROCEDURE QComboBox_rootModelIndex ( self: QComboBox;
): QModelIndex =
VAR
...
PROCEDURE QComboBox_setRootModelIndex ( self: QComboBox;
 index: QModelIndex;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_modelColumn ( self: QComboBox;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QComboBox_setModelColumn ( self: QComboBox;
visibleColumn: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QComboBox_currentIndex ( self: QComboBox;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QComboBox_currentText ( self: QComboBox;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE QComboBox_itemText ( self: QComboBox;
index: INTEGER;
): TEXT =
VAR
ret : ADDRESS;
...
PROCEDURE QComboBox_itemIcon ( self: QComboBox;
index: INTEGER;
): QIcon =
VAR
...
PROCEDURE QComboBox_itemData ( self: QComboBox;
index, role: INTEGER;
): QVariant =
VAR
...
PROCEDURE QComboBox_itemData1 ( self: QComboBox;
index: INTEGER;
): QVariant =
VAR
ret:ADDRESS; result : QVariant;
...
PROCEDURE QComboBox_addItem ( self: QComboBox;
 text: TEXT;
 userData: QVariant;
) =
VAR
...
PROCEDURE QComboBox_addItem1 ( self: QComboBox;
 text: TEXT;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_addItem2 ( self: QComboBox;
 icon: QIcon;
 text: TEXT;
 userData: QVariant;
) =
...
PROCEDURE QComboBox_addItem3 ( self: QComboBox;
 icon: QIcon;
 text: TEXT;
) =
VAR
...
PROCEDURE QComboBox_addItems ( self: QComboBox;
 texts: QStringList;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_insertItem ( self: QComboBox;
index: INTEGER;
 text: TEXT;
 userData: QVariant;
) =
...
PROCEDURE QComboBox_insertItem1 ( self: QComboBox;
index: INTEGER;
 text: TEXT;
) =
VAR
...
BEGIN
QtComboBoxRaw.QComboBox_insertItem2(selfAdr, index, arg3tmp, arg4tmp, arg5tmp);
END QComboBox_insertItem2;

PROCEDURE QComboBox_insertItem3 ( self: QComboBox;
index: INTEGER;
 icon: QIcon;
 text: TEXT;
) =
...
PROCEDURE QComboBox_insertItems ( self: QComboBox;
index: INTEGER;
 texts: QStringList;
) =
VAR
...
PROCEDURE QComboBox_insertSeparator ( self: QComboBox;
index: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_removeItem ( self: QComboBox;
index: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_setItemText ( self: QComboBox;
index: INTEGER;
 text: TEXT;
) =
VAR
...
PROCEDURE QComboBox_setItemIcon ( self: QComboBox;
index: INTEGER;
 icon: QIcon;
) =
VAR
...
PROCEDURE QComboBox_setItemData ( self: QComboBox;
index: INTEGER;
 value: QVariant;
role: INTEGER;
) =
...
PROCEDURE QComboBox_setItemData1 ( self: QComboBox;
index: INTEGER;
 value: QVariant;
) =
VAR
...
PROCEDURE QComboBox_view ( self: QComboBox;
): QAbstractItemView =
VAR
ret:ADDRESS; result : QAbstractItemView;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QComboBox_setView ( self: QComboBox;
...
PROCEDURE QComboBox_sizeHint ( self: QComboBox;
): QSize =
VAR
ret:ADDRESS; result : QSize;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_minimumSizeHint ( self: QComboBox;
): QSize =
VAR
ret:ADDRESS; result : QSize;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_setEditText ( self: QComboBox;
 text: TEXT;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QComboBox_setCurrentIndex ( self: QComboBox;
index: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE Cleanup_QComboBox(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
