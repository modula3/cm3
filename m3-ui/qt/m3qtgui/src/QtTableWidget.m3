...
PROCEDURE New_QTableWidgetSelectionRange0 (self:QTableWidgetSelectionRange;): QTableWidgetSelectionRange =
VAR
result : ADDRESS;
BEGIN
...
PROCEDURE New_QTableWidgetSelectionRange1 (self:QTableWidgetSelectionRange;top, left, bottom, right: INTEGER;
): QTableWidgetSelectionRange =
VAR
result : ADDRESS;
BEGIN
result := QtTableWidgetRaw.New_QTableWidgetSelectionRange1(top, left, bottom, right);
...
PROCEDURE New_QTableWidgetSelectionRange2 (self:QTableWidgetSelectionRange; other: QTableWidgetSelectionRange;
): QTableWidgetSelectionRange =
VAR
result : ADDRESS;
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
RETURN QtTableWidgetRaw.QTableWidgetSelectionRange_rightColumn(selfAdr);
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
RETURN QtTableWidgetRaw.QTableWidgetSelectionRange_columnCount(selfAdr);
END QTableWidgetSelectionRange_columnCount;

PROCEDURE Cleanup_QTableWidgetSelectionRange(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QTableWidgetSelectionRange := ref;
BEGIN
  Delete_QTableWidgetSelectionRange(obj);
 END Cleanup_QTableWidgetSelectionRange;

PROCEDURE Destroy_QTableWidgetSelectionRange(self : QTableWidgetSelectionRange) =
BEGIN
  EVAL WeakRef.FromRef(self,Cleanup_QTableWidgetSelectionRange);
...
PROCEDURE New_QTableWidgetItem1 (self:QTableWidgetItem;): QTableWidgetItem =
VAR
result : ADDRESS;
BEGIN
...
PROCEDURE New_QTableWidgetItem2 (self:QTableWidgetItem; text: TEXT;
type: INTEGER;
): QTableWidgetItem =
VAR
result : ADDRESS;
...
PROCEDURE New_QTableWidgetItem4 (self:QTableWidgetItem; icon: QIcon;
 text: TEXT;
type: INTEGER;
): QTableWidgetItem =
VAR
...
BEGIN
result := QtTableWidgetRaw.New_QTableWidgetItem4(arg1tmp, arg2tmp, type);
...
PROCEDURE New_QTableWidgetItem5 (self:QTableWidgetItem; icon: QIcon;
 text: TEXT;
): QTableWidgetItem =
VAR
result : ADDRESS;
...
PROCEDURE New_QTableWidgetItem6 (self:QTableWidgetItem; other: QTableWidgetItem;
): QTableWidgetItem =
VAR
result : ADDRESS;
arg1tmp :=  LOOPHOLE(other.cxxObj,ADDRESS);
...
VAR
ret:ADDRESS; result : QTableWidget;
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTableWidgetItem_row ( self: QTableWidgetItem;
): INTEGER =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTableWidgetItem_column ( self: QTableWidgetItem;
): INTEGER =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTableWidgetItem_setSelected ( self: QTableWidgetItem;
select: BOOLEAN;
) =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_isSelected ( self: QTableWidgetItem;
): BOOLEAN =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTableWidgetItem_flags ( self: QTableWidgetItem;
): ItemFlags =
VAR
...
PROCEDURE QTableWidgetItem_setFlags ( self: QTableWidgetItem;
flags: ItemFlags;
) =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_text ( self: QTableWidgetItem;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE QTableWidgetItem_setText ( self: QTableWidgetItem;
 text: TEXT;
) =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_icon ( self: QTableWidgetItem;
): QIcon =
VAR
...
PROCEDURE QTableWidgetItem_setIcon ( self: QTableWidgetItem;
 icon: QIcon;
) =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_statusTip ( self: QTableWidgetItem;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE QTableWidgetItem_setStatusTip ( self: QTableWidgetItem;
 statusTip: TEXT;
) =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_toolTip ( self: QTableWidgetItem;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE QTableWidgetItem_setToolTip ( self: QTableWidgetItem;
 toolTip: TEXT;
) =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_whatsThis ( self: QTableWidgetItem;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE QTableWidgetItem_setWhatsThis ( self: QTableWidgetItem;
 whatsThis: TEXT;
) =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_font ( self: QTableWidgetItem;
): QFont =
VAR
...
PROCEDURE QTableWidgetItem_setFont ( self: QTableWidgetItem;
 font: QFont;
) =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_setTextAlignment ( self: QTableWidgetItem;
alignment: INTEGER;
) =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_setBackgroundColor ( self: QTableWidgetItem;
 color: QColor;
) =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_background ( self: QTableWidgetItem;
): QBrush =
VAR
...
PROCEDURE QTableWidgetItem_setBackground ( self: QTableWidgetItem;
 brush: QBrush;
) =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_textColor ( self: QTableWidgetItem;
): QColor =
VAR
ret:ADDRESS; result : QColor;
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_setTextColor ( self: QTableWidgetItem;
 color: QColor;
) =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_foreground ( self: QTableWidgetItem;
): QBrush =
VAR
ret:ADDRESS; result : QBrush;
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_setForeground ( self: QTableWidgetItem;
 brush: QBrush;
) =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_setCheckState ( self: QTableWidgetItem;
state: CheckState;
) =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_sizeHint ( self: QTableWidgetItem;
): QSize =
VAR
...
PROCEDURE QTableWidgetItem_setSizeHint ( self: QTableWidgetItem;
 size: QSize;
) =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableWidgetItem_type ( self: QTableWidgetItem;
): INTEGER =
VAR
arg1tmp :=  LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE Cleanup_QTableWidgetItem(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
PROCEDURE New_QTableWidget2 (self:QTableWidget;rows, columns: INTEGER;
 parent: QWidget;
): QTableWidget =
VAR
result : ADDRESS;
...
VAR
ret:ADDRESS; result : QTableWidgetItem;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
BEGIN
QtTableWidgetRaw.QTableWidget_setVerticalHeaderItem(selfAdr, row, arg3tmp);
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtTableWidgetRaw.QTableWidget_takeVerticalHeaderItem(selfAdr, row);
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtTableWidgetRaw.QTableWidget_horizontalHeaderItem(selfAdr, column);
...
arg3tmp :=  LOOPHOLE(item.cxxObj,ADDRESS);
BEGIN
QtTableWidgetRaw.QTableWidget_setHorizontalHeaderItem(selfAdr, column, arg3tmp);
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtTableWidgetRaw.QTableWidget_takeHorizontalHeaderItem(selfAdr, column);
...
arg2tmp :=  LOOPHOLE(labels.cxxObj,ADDRESS);
BEGIN
QtTableWidgetRaw.QTableWidget_setHorizontalHeaderLabels(selfAdr, arg2tmp);
...
arg2tmp :=  LOOPHOLE(item.cxxObj,ADDRESS);
BEGIN
QtTableWidgetRaw.QTableWidget_setCurrentItem1(selfAdr, arg2tmp, ORD(command));
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtTableWidgetRaw.QTableWidget_setCurrentCell1(selfAdr, row, column, ORD(command));
...
BEGIN
QtTableWidgetRaw.QTableWidget_setCellWidget(selfAdr, row, column, arg4tmp);
...
BEGIN
QtTableWidgetRaw.QTableWidget_setRangeSelected(selfAdr, arg2tmp, select);
...
logicalColumn: INTEGER;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
RETURN QtTableWidgetRaw.QTableWidget_visualColumn(selfAdr, logicalColumn);
...
PROCEDURE Cleanup_QTableWidget(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
