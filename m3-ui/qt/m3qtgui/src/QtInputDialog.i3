...
FROM QtNamespace IMPORT WindowTypes, InputMethodHints;
...
PROCEDURE GetText5 (    parent          : QWidget;
                        title, label    : TEXT;
                        echo            : EchoMode;
                        text            : TEXT;
                    VAR ok              : BOOLEAN;
                        flags           : WindowTypes;
                        inputMethodHints: InputMethodHints; ): TEXT;

PROCEDURE GetItem5 (    parent          : QWidget;
                        title, label    : TEXT;
                        items           : QStringList;
                        current         : INTEGER;
                        editable        : BOOLEAN;
