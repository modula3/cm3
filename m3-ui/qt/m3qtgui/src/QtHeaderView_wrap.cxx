...
SWIGEXPORT int QHeaderView_defaultAlignment(QHeaderView const * self) {
  QHeaderView *arg1 = (QHeaderView *) 0 ;
  Qt::Alignment result;
  int cresult ;
  
  arg1 = *(QHeaderView **)&self; 
  result = ((QHeaderView const *)arg1)->defaultAlignment();
  cresult = (int)result;
  return cresult;
}


SWIGEXPORT void QHeaderView_setDefaultAlignment(QHeaderView * self, int alignment) {
  QHeaderView *arg1 = (QHeaderView *) 0 ;
  Qt::Alignment arg2 ;
