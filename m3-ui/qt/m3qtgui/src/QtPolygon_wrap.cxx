...
SWIGEXPORT void QPolygon_swap(QPolygon * self, QPolygon & other) {
  ...
  /*
  if(!arg2) {
      //SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "QPolygon & reference is null");
      //RETURN ;
      return ;
    }
  */
...
SWIGEXPORT void QPolygonF_swap(QPolygonF * self, QPolygonF & other) {
  ...
  /*
  if(!arg2) {
      //SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "QPolygonF & reference is null");
      //RETURN ;
      return ;
    }
  */
