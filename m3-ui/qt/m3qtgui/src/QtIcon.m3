...
PROCEDURE New_QIcon1 (self:QIcon; pixmap: QPixmap;
): QIcon =
VAR
result : ADDRESS;
...
PROCEDURE New_QIcon2 (self:QIcon; other: QIcon;
): QIcon =
VAR
result : ADDRESS;
...
PROCEDURE New_QIcon3 (self:QIcon; fileName: TEXT;
): QIcon =
VAR
result : ADDRESS;
...
PROCEDURE New_QIcon4 (self:QIcon; engine: QIconEngine;
): QIcon =
VAR
result : ADDRESS;
...
PROCEDURE New_QIcon5 (self:QIcon; engine: QIconEngineV2;
): QIcon =
VAR
result : ADDRESS;
arg1tmp :=  LOOPHOLE(engine.cxxObj,ADDRESS);
...
PROCEDURE QIcon_pixmap ( self: QIcon;
 size: QSize;
mode: Mode;
state: State;
): QPixmap =
...
PROCEDURE QIcon_pixmap1 ( self: QIcon;
 size: QSize;
mode: Mode;
): QPixmap =
VAR
...
PROCEDURE QIcon_pixmap2 ( self: QIcon;
 size: QSize;
): QPixmap =
VAR
ret:ADDRESS; result : QPixmap;
...
PROCEDURE QIcon_pixmap3 ( self: QIcon;
w, h: INTEGER;
mode: Mode;
state: State;
): QPixmap =
...
PROCEDURE QIcon_pixmap4 ( self: QIcon;
w, h: INTEGER;
mode: Mode;
): QPixmap =
VAR
...
PROCEDURE QIcon_pixmap5 ( self: QIcon;
w, h: INTEGER;
): QPixmap =
VAR
ret:ADDRESS; result : QPixmap;
...
PROCEDURE QIcon_pixmap6 ( self: QIcon;
extent: INTEGER;
mode: Mode;
state: State;
): QPixmap =
...
PROCEDURE QIcon_pixmap7 ( self: QIcon;
extent: INTEGER;
mode: Mode;
): QPixmap =
VAR
...
PROCEDURE QIcon_pixmap8 ( self: QIcon;
extent: INTEGER;
): QPixmap =
VAR
ret:ADDRESS; result : QPixmap;
...
PROCEDURE QIcon_actualSize ( self: QIcon;
 size: QSize;
mode: Mode;
state: State;
): QSize =
...
arg2tmp :=  LOOPHOLE(size.cxxObj,ADDRESS);
BEGIN
ret := QtIconRaw.QIcon_actualSize(selfAdr, arg2tmp, ORD(mode), ORD(state));
...
PROCEDURE QIcon_actualSize1 ( self: QIcon;
 size: QSize;
mode: Mode;
): QSize =
VAR
...
PROCEDURE QIcon_actualSize2 ( self: QIcon;
 size: QSize;
): QSize =
VAR
ret:ADDRESS; result : QSize;
...
BEGIN
QtIconRaw.QIcon_paint(selfAdr, arg2tmp, arg3tmp, ORD(alignment), ORD(mode), ORD(state));
END QIcon_paint;
...
arg3tmp :=  LOOPHOLE(rect.cxxObj,ADDRESS);
BEGIN
QtIconRaw.QIcon_paint1(selfAdr, arg2tmp, arg3tmp, ORD(alignment), ORD(mode));
END QIcon_paint1;
...
PROCEDURE QIcon_paint3 ( self: QIcon;
 painter: QPainter;
 rect: QRect;
) =
VAR
...
arg2tmp :=  LOOPHOLE(painter.cxxObj,ADDRESS);
BEGIN
QtIconRaw.QIcon_paint4(selfAdr, arg2tmp, x, y, w, h, ORD(alignment), ORD(mode), ORD(state));
END QIcon_paint4;
...
arg2tmp :=  LOOPHOLE(painter.cxxObj,ADDRESS);
BEGIN
QtIconRaw.QIcon_paint5(selfAdr, arg2tmp, x, y, w, h, ORD(alignment), ORD(mode));
END QIcon_paint5;
...
PROCEDURE QIcon_paint7 ( self: QIcon;
 painter: QPainter;
x, y, w, h: INTEGER;
) =
VAR
...
PROCEDURE QIcon_isNull ( self: QIcon;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QIcon_isDetached ( self: QIcon;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QIcon_serialNumber ( self: QIcon;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QIcon_cacheKey ( self: QIcon;
): CARDINAL =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QIcon_addPixmap ( self: QIcon;
 pixmap: QPixmap;
mode: Mode;
state: State;
) =
...
PROCEDURE QIcon_addPixmap1 ( self: QIcon;
 pixmap: QPixmap;
mode: Mode;
) =
VAR
...
PROCEDURE QIcon_addPixmap2 ( self: QIcon;
 pixmap: QPixmap;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QIcon_addFile ( self: QIcon;
 fileName: TEXT;
 size: QSize;
mode: Mode;
state: State;
...
BEGIN
QtIconRaw.QIcon_addFile(selfAdr, arg2tmp, arg3tmp, ORD(mode), ORD(state));
END QIcon_addFile;

PROCEDURE QIcon_addFile1 ( self: QIcon;
 fileName: TEXT;
 size: QSize;
mode: Mode;
) =
...
PROCEDURE QIcon_addFile2 ( self: QIcon;
 fileName: TEXT;
 size: QSize;
) =
VAR
...
PROCEDURE QIcon_addFile3 ( self: QIcon;
 fileName: TEXT;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
VAR
arg1tmp :=  LOOPHOLE(searchpath.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE Cleanup_QIcon(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QIcon := ref;
BEGIN
  Delete_QIcon(obj);
 END Cleanup_QIcon;
