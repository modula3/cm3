...
sectionSizeHint(logicalIndex: INTEGER;
): INTEGER;
visualIndexAt(position: INTEGER;
): INTEGER;
logicalIndexAt(position: INTEGER;
): INTEGER;
logicalIndexAt1(x, y: INTEGER;
): INTEGER;
logicalIndexAt2( pos: QPoint;
): INTEGER;
sectionSize(logicalIndex: INTEGER;
): INTEGER;
sectionPosition(logicalIndex: INTEGER;
): INTEGER;
sectionViewportPosition(logicalIndex: INTEGER;
): INTEGER;
...
isSectionHidden(logicalIndex: INTEGER;
): BOOLEAN;
setSectionHidden(logicalIndex: INTEGER;
hide: BOOLEAN;
);
...
count(): INTEGER;
visualIndex(logicalIndex: INTEGER;
): INTEGER;
logicalIndex(visualIndex: INTEGER;
): INTEGER;
...
setResizeMode1(logicalIndex: INTEGER;
mode: ResizeMode;
);
resizeMode(logicalIndex: INTEGER;
): ResizeMode;
stretchSectionCount(): INTEGER;
setSortIndicatorShown(show: BOOLEAN;
);
isSortIndicatorShown(): BOOLEAN;
setSortIndicator(logicalIndex: INTEGER;
order: SortOrder;
);
