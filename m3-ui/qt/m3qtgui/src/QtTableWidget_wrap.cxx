...
SWIGEXPORT int QTableWidgetItem_flags(QTableWidgetItem const * self) {
  QTableWidgetItem *arg1 = (QTableWidgetItem *) 0 ;
  Qt::ItemFlags result;
  int cresult ;
  
  arg1 = *(QTableWidgetItem **)&self; 
  result = ((QTableWidgetItem const *)arg1)->flags();
  cresult = (int)result;
  return cresult;
}


SWIGEXPORT void QTableWidgetItem_setFlags(QTableWidgetItem * self, int flags) {
  QTableWidgetItem *arg1 = (QTableWidgetItem *) 0 ;
  Qt::ItemFlags arg2 ;
