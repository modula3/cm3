...
SWIGEXPORT int QTreeWidgetItem_flags(QTreeWidgetItem const * self) {
  QTreeWidgetItem *arg1 = (QTreeWidgetItem *) 0 ;
  Qt::ItemFlags result;
  int cresult ;
  
  arg1 = *(QTreeWidgetItem **)&self; 
  result = ((QTreeWidgetItem const *)arg1)->flags();
  cresult = (int)result;
  return cresult;
}


SWIGEXPORT void QTreeWidgetItem_setFlags(QTreeWidgetItem * self, int flags) {
  QTreeWidgetItem *arg1 = (QTreeWidgetItem *) 0 ;
  Qt::ItemFlags arg2 ;
