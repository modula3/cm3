...
PROCEDURE New_QPolygon5 (nPoints: C.int; points: ADDRESS; ): QPolygon;

<* EXTERNAL QPolygon_swap *>
PROCEDURE QPolygon_swap (self: QPolygon; other: ADDRESS; );
...
<* EXTERNAL QPolygon_setPoints *>
PROCEDURE QPolygon_setPoints
  (self: QPolygon; nPoints: C.int; points: ADDRESS; );

<* EXTERNAL QPolygon_putPoints *>
PROCEDURE QPolygon_putPoints
  (self: QPolygon; index, nPoints: C.int; points: ADDRESS; );

<* EXTERNAL QPolygon_putPoints1 *>
PROCEDURE QPolygon_putPoints1 (self          : QPolygon;
                               index, nPoints: C.int;
                               from          : ADDRESS;
                               fromIndex     : C.int;    );

<* EXTERNAL QPolygon_putPoints2 *>
PROCEDURE QPolygon_putPoints2
  (self: QPolygon; index, nPoints: C.int; from: ADDRESS; );
...
<* EXTERNAL QPolygonF_swap *>
PROCEDURE QPolygonF_swap (self: QPolygonF; other: ADDRESS; );
