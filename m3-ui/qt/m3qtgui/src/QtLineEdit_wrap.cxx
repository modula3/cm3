...
SWIGEXPORT void QLineEdit_setAlignment(QLineEdit * self, int flag) {
  QLineEdit *arg1 = (QLineEdit *) 0 ;
  Qt::Alignment arg2 ;
...
SWIGEXPORT int QLineEdit_alignment(QLineEdit const * self) {
  QLineEdit *arg1 = (QLineEdit *) 0 ;
  Qt::Alignment result;
  int cresult ;
  
  arg1 = *(QLineEdit **)&self; 
  result = ((QLineEdit const *)arg1)->alignment();
  cresult = (int)result;
  return cresult;
}
