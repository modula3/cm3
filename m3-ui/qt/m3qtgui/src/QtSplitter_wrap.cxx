...
SWIGEXPORT long Modula3_QSplitterToQFrame(long objectRef) {
    long baseptr = 0;
    *(QFrame **)&baseptr = *(QSplitter **)&objectRef;
    return baseptr;
}

SWIGEXPORT long Modula3_QSplitterHandleToQWidget(long objectRef) {
    long baseptr = 0;
    *(QWidget **)&baseptr = *(QSplitterHandle **)&objectRef;
    return baseptr;
}
