...
PROCEDURE New_QPalette1 (self: QPalette; button: QColor; ): QPalette =
  VAR
    result : ADDRESS;
...
PROCEDURE New_QPalette2 (self: QPalette; button: GlobalColor; ): QPalette =
  VAR result: ADDRESS;
  BEGIN
...
PROCEDURE New_QPalette4 (self: QPalette;
                         windowText, button, light, dark, mid, text,
                           bright_text, base, window: QBrush; ): QPalette =
  VAR
    result : ADDRESS;
  ...
  BEGIN
    result := QtPaletteRaw.New_QPalette4(
                arg1tmp, arg2tmp, arg3tmp, arg4tmp, arg5tmp, arg6tmp,
                arg7tmp, arg8tmp, arg9tmp);
...
PROCEDURE New_QPalette5
  (self                                            : QPalette;
   windowText, window, light, dark, mid, text, base: QColor;   ):
  QPalette =
  VAR
    result : ADDRESS;
    arg1tmp          := LOOPHOLE(windowText.cxxObj, ADDRESS);
  ...
  BEGIN
    result :=
      QtPaletteRaw.New_QPalette5(
        arg1tmp, arg2tmp, arg3tmp, arg4tmp, arg5tmp, arg6tmp, arg7tmp);
...
PROCEDURE New_QPalette6 (self: QPalette; palette: QPalette; ): QPalette =
  VAR
    result : ADDRESS;
...
PROCEDURE QPalette_Op_Brush_Assign (self, palette: QPalette; ): QPalette =
  VAR
    ret    : ADDRESS;
    result : QPalette;
...
PROCEDURE QPalette_currentColorGroup (self: QPalette; ): ColorGroup =
  VAR
    ret    : INTEGER;
    result : ColorGroup;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_setCurrentColorGroup
  (self: QPalette; cg: ColorGroup; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtPaletteRaw.QPalette_setCurrentColorGroup(selfAdr, ORD(cg));
  END QPalette_setCurrentColorGroup;

PROCEDURE QPalette_color (self: QPalette; cg: ColorGroup; cr: ColorRole; ):
  QColor =
  VAR
    ret    : ADDRESS;
    result : QColor;
...
PROCEDURE QPalette_brush (self: QPalette; cg: ColorGroup; cr: ColorRole; ):
  QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
...
PROCEDURE QPalette_setColor
  (self: QPalette; cg: ColorGroup; cr: ColorRole; color: QColor; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_setColor1
  (self: QPalette; cr: ColorRole; color: QColor; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_setBrush
  (self: QPalette; cr: ColorRole; brush: QBrush; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_isBrushSet
  (self: QPalette; cg: ColorGroup; cr: ColorRole; ): BOOLEAN =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QPalette_setBrush1
  (self: QPalette; cg: ColorGroup; cr: ColorRole; brush: QBrush; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_setColorGroup
  ...
  BEGIN
    QtPaletteRaw.QPalette_setColorGroup(
      selfAdr, ORD(cr), arg3tmp, arg4tmp, arg5tmp, arg6tmp, arg7tmp,
      arg8tmp, arg9tmp, arg10tmp, arg11tmp);
  END QPalette_setColorGroup;

PROCEDURE QPalette_isEqual (self: QPalette; cr1, cr2: ColorGroup; ):
  BOOLEAN =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QPalette_color1 (self: QPalette; cr: ColorRole; ): QColor =
  VAR
    ret    : ADDRESS;
    result : QColor;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_brush1 (self: QPalette; cr: ColorRole; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_foreground (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_windowText (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_button (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_light (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_dark (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_mid (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_text (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_base (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_alternateBase (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_toolTipBase (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_toolTipText (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_background (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_window (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_midlight (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_brightText (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_buttonText (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_shadow (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_highlight (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_highlightedText (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_link (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_linkVisited (self: QPalette; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_Op_Brush_Equals (self, p: QPalette; ): BOOLEAN =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_Op_Brush_NotEquals (self, p: QPalette; ): BOOLEAN =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(p.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QPalette_isCopyOf (self, p: QPalette; ): BOOLEAN =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(p.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QPalette_serialNumber (self: QPalette; ): INTEGER =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtPaletteRaw.QPalette_serialNumber(selfAdr);
  END QPalette_serialNumber;

PROCEDURE QPalette_cacheKey (self: QPalette; ): CARDINAL =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtPaletteRaw.QPalette_cacheKey(selfAdr);
  END QPalette_cacheKey;

PROCEDURE QPalette_resolve (self, arg2: QPalette; ): QPalette =
  VAR
    ret    : ADDRESS;
    result : QPalette;
    selfAdr: ADDRESS  := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QPalette_resolve1 (self: QPalette; ): CARDINAL =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
REVEAL
  QPalette = QPalettePublic BRANDED OBJECT
             OVERRIDES
