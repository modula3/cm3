...
PROCEDURE QTableView_setModel ( self: QTableView;
...
PROCEDURE QTableView_setRootIndex ( self: QTableView;
 index: QModelIndex;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_setSelectionModel ( self: QTableView;
...
PROCEDURE QTableView_horizontalHeader ( self: QTableView;
): QHeaderView =
VAR
...
PROCEDURE QTableView_verticalHeader ( self: QTableView;
): QHeaderView =
VAR
ret:ADDRESS; result : QHeaderView;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_setHorizontalHeader ( self: QTableView;
 header: QHeaderView;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_setVerticalHeader ( self: QTableView;
 header: QHeaderView;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_rowViewportPosition ( self: QTableView;
row: INTEGER;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_rowAt ( self: QTableView;
y: INTEGER;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_setRowHeight ( self: QTableView;
row, height: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_rowHeight ( self: QTableView;
row: INTEGER;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_columnViewportPosition ( self: QTableView;
column: INTEGER;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
RETURN QtTableViewRaw.QTableView_columnViewportPosition(selfAdr, column);
END QTableView_columnViewportPosition;

PROCEDURE QTableView_columnAt ( self: QTableView;
x: INTEGER;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_setColumnWidth ( self: QTableView;
...
PROCEDURE QTableView_columnWidth ( self: QTableView;
column: INTEGER;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_isRowHidden ( self: QTableView;
row: INTEGER;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_setRowHidden ( self: QTableView;
row: INTEGER;
hide: BOOLEAN;
) =
VAR
...
PROCEDURE QTableView_isColumnHidden ( self: QTableView;
column: INTEGER;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_setColumnHidden ( self: QTableView;
column: INTEGER;
hide: BOOLEAN;
) =
VAR
...
PROCEDURE QTableView_setSortingEnabled ( self: QTableView;
enable: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_isSortingEnabled ( self: QTableView;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTableView_showGrid ( self: QTableView;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTableView_gridStyle ( self: QTableView;
): PenStyle =
VAR
ret:INTEGER; result : PenStyle;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTableView_setGridStyle ( self: QTableView;
style: PenStyle;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_setWordWrap ( self: QTableView;
on: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_wordWrap ( self: QTableView;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTableView_setCornerButtonEnabled ( self: QTableView;
enable: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_isCornerButtonEnabled ( self: QTableView;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTableView_visualRect ( self: QTableView;
 index: QModelIndex;
): QRect =
VAR
...
PROCEDURE QTableView_scrollTo ( self: QTableView;
 index: QModelIndex;
hint: ScrollHint;
) =
VAR
...
PROCEDURE QTableView_scrollTo1 ( self: QTableView;
 index: QModelIndex;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_setSpan ( self: QTableView;
row, column, rowSpan, columnSpan: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtTableViewRaw.QTableView_setSpan(selfAdr, row, column, rowSpan, columnSpan);
END QTableView_setSpan;

PROCEDURE QTableView_rowSpan ( self: QTableView;
row, column: INTEGER;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_columnSpan ( self: QTableView;
row, column: INTEGER;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_sortByColumn ( self: QTableView;
column: INTEGER;
order: SortOrder;
) =
VAR
...
PROCEDURE QTableView_selectRow ( self: QTableView;
row: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_selectColumn ( self: QTableView;
column: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_hideRow ( self: QTableView;
row: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_hideColumn ( self: QTableView;
column: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_showRow ( self: QTableView;
row: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_showColumn ( self: QTableView;
column: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_resizeRowToContents ( self: QTableView;
row: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_resizeColumnToContents ( self: QTableView;
column: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_sortByColumn1 ( self: QTableView;
column: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTableView_setShowGrid ( self: QTableView;
show: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE Cleanup_QTableView(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
