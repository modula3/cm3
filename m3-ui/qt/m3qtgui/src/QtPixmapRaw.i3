...
PROCEDURE New_QPixmap1 (data: ADDRESS; ): QPixmap;

<* EXTERNAL New_QPixmap2 *>
PROCEDURE New_QPixmap2 (w, h: C.int; ): QPixmap;

<* EXTERNAL New_QPixmap3 *>
PROCEDURE New_QPixmap3 (arg1: ADDRESS; ): QPixmap;
...
PROCEDURE New_QPixmap5 (fileName: ADDRESS; format: C.char_star; ): QPixmap;

<* EXTERNAL New_QPixmap6 *>
PROCEDURE New_QPixmap6 (fileName: ADDRESS; ): QPixmap;

<* EXTERNAL New_QPixmap7 *>
PROCEDURE New_QPixmap7 (arg1: ADDRESS; ): QPixmap;
...
PROCEDURE QPixmap_alphaChannel (self: QPixmap; ): ADDRESS;

<* EXTERNAL QPixmap_setAlphaChannel *>
PROCEDURE QPixmap_setAlphaChannel (self: QPixmap; arg2: ADDRESS; );
...
PROCEDURE QPixmap_loadFromData1
  (self: QPixmap; buf: ADDRESS; len: CARDINAL; format: C.char_star; ):
  BOOLEAN;
...
PROCEDURE QPixmap_serialNumber (self: QPixmap; ): C.int;
...
PROCEDURE QPixmap_pixmapData (self: QPixmap; ): ADDRESS;
