...
PROCEDURE QStackedWidget_addWidget (self: QStackedWidget; w: QWidget; ):
  INTEGER =
  VAR
...
PROCEDURE QStackedWidget_insertWidget
  (self: QStackedWidget; index: INTEGER; w: QWidget; ): INTEGER =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg3tmp          := LOOPHOLE(w.cxxObj, ADDRESS);
  BEGIN
    RETURN QtStackedWidgetRaw.QStackedWidget_insertWidget(
             selfAdr, index, arg3tmp);
  END QStackedWidget_insertWidget;

PROCEDURE QStackedWidget_removeWidget
  (self: QStackedWidget; w: QWidget; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(w.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QStackedWidget_currentWidget (self: QStackedWidget; ): QWidget =
  VAR
    ret    : ADDRESS;
    result : QWidget;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QStackedWidget_currentIndex (self: QStackedWidget; ): INTEGER =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtStackedWidgetRaw.QStackedWidget_currentIndex(selfAdr);
  END QStackedWidget_currentIndex;

PROCEDURE QStackedWidget_indexOf (self: QStackedWidget; arg2: QWidget; ):
  INTEGER =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QStackedWidget_widget (self: QStackedWidget; arg2: INTEGER; ):
  QWidget =
  VAR
    ret    : ADDRESS;
    result : QWidget;
...
PROCEDURE QStackedWidget_count (self: QStackedWidget; ): INTEGER =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QStackedWidget_setCurrentIndex
  (self: QStackedWidget; index: INTEGER; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE Cleanup_QStackedWidget
...
REVEAL
  QStackedWidget = QStackedWidgetPublic BRANDED OBJECT
                   OVERRIDES
