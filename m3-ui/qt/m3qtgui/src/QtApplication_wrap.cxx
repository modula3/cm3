...
SWIGEXPORT int KeyboardModifiers() {
  Qt::KeyboardModifiers result;
  int cresult ;
  
  result = QApplication::keyboardModifiers();
  cresult = (int)result;
  return cresult;
}


SWIGEXPORT int QueryKeyboardModifiers() {
  Qt::KeyboardModifiers result;
  int cresult ;
  
  result = QApplication::queryKeyboardModifiers();
  cresult = (int)result;
  return cresult;
}


SWIGEXPORT int MouseButtons() {
  Qt::MouseButtons result;
  int cresult ;
  
  result = QApplication::mouseButtons();
  cresult = (int)result;
  return cresult;
}
