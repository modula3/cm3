...
PROCEDURE New_QTabBar0 (self:QTabBar; parent: QWidget;
): QTabBar =
VAR
result : ADDRESS;
...
PROCEDURE QTabBar_shape ( self: QTabBar;
): Shape =
VAR
...
PROCEDURE QTabBar_setShape ( self: QTabBar;
shape: Shape;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTabBar_addTab ( self: QTabBar;
 text: TEXT;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTabBar_addTab1 ( self: QTabBar;
 icon: QIcon;
 text: TEXT;
): INTEGER =
VAR
...
PROCEDURE QTabBar_insertTab ( self: QTabBar;
index: INTEGER;
 text: TEXT;
): INTEGER =
VAR
...
PROCEDURE QTabBar_insertTab1 ( self: QTabBar;
index: INTEGER;
 icon: QIcon;
 text: TEXT;
): INTEGER =
...
BEGIN
RETURN QtTabBarRaw.QTabBar_insertTab1(selfAdr, index, arg3tmp, arg4tmp);
END QTabBar_insertTab1;

PROCEDURE QTabBar_removeTab ( self: QTabBar;
index: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTabBar_moveTab ( self: QTabBar;
from, to: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTabBar_isTabEnabled ( self: QTabBar;
index: INTEGER;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTabBar_setTabEnabled ( self: QTabBar;
index: INTEGER;
arg3: BOOLEAN;
) =
VAR
...
PROCEDURE QTabBar_tabText ( self: QTabBar;
index: INTEGER;
): TEXT =
VAR
ret : ADDRESS;
...
PROCEDURE QTabBar_setTabText ( self: QTabBar;
index: INTEGER;
 text: TEXT;
) =
VAR
...
PROCEDURE QTabBar_tabTextColor ( self: QTabBar;
index: INTEGER;
): QColor =
VAR
...
PROCEDURE QTabBar_setTabTextColor ( self: QTabBar;
index: INTEGER;
 color: QColor;
) =
VAR
...
PROCEDURE QTabBar_tabIcon ( self: QTabBar;
index: INTEGER;
): QIcon =
VAR
...
PROCEDURE QTabBar_setTabIcon ( self: QTabBar;
index: INTEGER;
 icon: QIcon;
) =
VAR
...
PROCEDURE QTabBar_elideMode ( self: QTabBar;
): TextElideMode =
VAR
...
PROCEDURE QTabBar_setElideMode ( self: QTabBar;
arg2: TextElideMode;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTabBar_setTabToolTip ( self: QTabBar;
index: INTEGER;
 tip: TEXT;
) =
VAR
...
PROCEDURE QTabBar_tabToolTip ( self: QTabBar;
index: INTEGER;
): TEXT =
VAR
ret : ADDRESS;
...
PROCEDURE QTabBar_setTabWhatsThis ( self: QTabBar;
index: INTEGER;
 text: TEXT;
) =
VAR
...
PROCEDURE QTabBar_tabWhatsThis ( self: QTabBar;
index: INTEGER;
): TEXT =
VAR
ret : ADDRESS;
...
PROCEDURE QTabBar_tabRect ( self: QTabBar;
index: INTEGER;
): QRect =
VAR
...
PROCEDURE QTabBar_tabAt ( self: QTabBar;
 pos: QPoint;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTabBar_currentIndex ( self: QTabBar;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTabBar_count ( self: QTabBar;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTabBar_sizeHint ( self: QTabBar;
): QSize =
VAR
...
PROCEDURE QTabBar_minimumSizeHint ( self: QTabBar;
): QSize =
VAR
ret:ADDRESS; result : QSize;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTabBar_setDrawBase ( self: QTabBar;
drawTheBase: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTabBar_drawBase ( self: QTabBar;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTabBar_iconSize ( self: QTabBar;
): QSize =
VAR
ret:ADDRESS; result : QSize;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTabBar_setIconSize ( self: QTabBar;
 size: QSize;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTabBar_usesScrollButtons ( self: QTabBar;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTabBar_setUsesScrollButtons ( self: QTabBar;
useButtons: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTabBar_tabsClosable ( self: QTabBar;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTabBar_setTabsClosable ( self: QTabBar;
closable: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
BEGIN
QtTabBarRaw.QTabBar_setTabButton(selfAdr, index, ORD(position), arg4tmp);
END QTabBar_setTabButton;

PROCEDURE QTabBar_tabButton ( self: QTabBar;
index: INTEGER;
position: ButtonPosition;
): QWidget =
VAR
...
PROCEDURE QTabBar_setSelectionBehaviorOnRemove ( self: QTabBar;
behavior: SelectionBehavior;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtTabBarRaw.QTabBar_setSelectionBehaviorOnRemove(selfAdr, ORD(behavior));
END QTabBar_setSelectionBehaviorOnRemove;

PROCEDURE QTabBar_expanding ( self: QTabBar;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTabBar_setExpanding ( self: QTabBar;
enabled: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTabBar_isMovable ( self: QTabBar;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTabBar_setMovable ( self: QTabBar;
movable: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTabBar_documentMode ( self: QTabBar;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QTabBar_setDocumentMode ( self: QTabBar;
set: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QTabBar_setCurrentIndex ( self: QTabBar;
index: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE Cleanup_QTabBar(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QTabBar := ref;
BEGIN
  Delete_QTabBar(obj);
 END Cleanup_QTabBar;
