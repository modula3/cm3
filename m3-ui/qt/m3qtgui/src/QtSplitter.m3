...
PROCEDURE New_QSplitter0 (self:QSplitter; parent: QWidget;
): QSplitter =
VAR
result : ADDRESS;
...
PROCEDURE New_QSplitter2 (self:QSplitter;arg1: Orientation;
 parent: QWidget;
): QSplitter =
VAR
result : ADDRESS;
...
PROCEDURE Cleanup_QSplitter(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
QSplitter =
QSplitterPublic BRANDED OBJECT
OVERRIDES
...
PROCEDURE New_QSplitterHandle0 (self:QSplitterHandle;o: Orientation;
 parent: QSplitter;
): QSplitterHandle =
VAR
result : ADDRESS;
...
PROCEDURE Cleanup_QSplitterHandle(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
QSplitterHandle =
QSplitterHandlePublic BRANDED OBJECT
OVERRIDES
