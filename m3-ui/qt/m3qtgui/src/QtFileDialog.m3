...
PROCEDURE New_QFileDialog0 (self:QFileDialog; parent: QWidget;
f: WindowTypes;
): QFileDialog =
VAR
result : ADDRESS;
...
PROCEDURE New_QFileDialog1 (self:QFileDialog; parent: QWidget;
 caption, directory, filter: TEXT;
): QFileDialog =
VAR
result : ADDRESS;
arg1tmp :=  LOOPHOLE(parent.cxxObj,ADDRESS);
...
BEGIN
result := QtFileDialogRaw.New_QFileDialog1(arg1tmp, arg2tmp, arg3tmp, arg4tmp);
...
PROCEDURE New_QFileDialog2 (self:QFileDialog; parent: QWidget;
...
PROCEDURE New_QFileDialog3 (self:QFileDialog; parent: QWidget;
 caption: TEXT;
): QFileDialog =
VAR
result : ADDRESS;
...
PROCEDURE QFileDialog_setDirectory ( self: QFileDialog;
 directory: TEXT;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_setDirectory1 ( self: QFileDialog;
 directory: QDir;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_directory ( self: QFileDialog;
): QDir =
VAR
ret:ADDRESS; result : QDir;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QFileDialog_selectFile ( self: QFileDialog;
 filename: TEXT;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_selectedFiles ( self: QFileDialog;
): QStringList =
VAR
...
PROCEDURE QFileDialog_setNameFilterDetailsVisible ( self: QFileDialog;
enabled: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtFileDialogRaw.QFileDialog_setNameFilterDetailsVisible(selfAdr, enabled);
...
PROCEDURE QFileDialog_setNameFilter ( self: QFileDialog;
 filter: TEXT;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_setNameFilters ( self: QFileDialog;
 filters: QStringList;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_nameFilters ( self: QFileDialog;
): QStringList =
VAR
ret:ADDRESS; result : QStringList;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_selectNameFilter ( self: QFileDialog;
 filter: TEXT;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_selectedNameFilter ( self: QFileDialog;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE QFileDialog_setViewMode ( self: QFileDialog;
mode: ViewMode;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_viewMode ( self: QFileDialog;
): ViewMode =
VAR
ret:INTEGER; result : ViewMode;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QFileDialog_setFileMode ( self: QFileDialog;
mode: FileMode;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_fileMode ( self: QFileDialog;
): FileMode =
VAR
ret:INTEGER; result : FileMode;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QFileDialog_setAcceptMode ( self: QFileDialog;
mode: AcceptMode;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_acceptMode ( self: QFileDialog;
): AcceptMode =
VAR
ret:INTEGER; result : AcceptMode;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QFileDialog_setReadOnly ( self: QFileDialog;
enabled: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_isReadOnly ( self: QFileDialog;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QFileDialog_setResolveSymlinks ( self: QFileDialog;
enabled: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_resolveSymlinks ( self: QFileDialog;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QFileDialog_saveState ( self: QFileDialog;
): QByteArray =
VAR
...
PROCEDURE QFileDialog_restoreState ( self: QFileDialog;
 state: QByteArray;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_setConfirmOverwrite ( self: QFileDialog;
enabled: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_confirmOverwrite ( self: QFileDialog;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QFileDialog_setDefaultSuffix ( self: QFileDialog;
 suffix: TEXT;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_defaultSuffix ( self: QFileDialog;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE QFileDialog_setHistory ( self: QFileDialog;
 paths: QStringList;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_history ( self: QFileDialog;
): QStringList =
VAR
ret:ADDRESS; result : QStringList;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_setItemDelegate ( self: QFileDialog;
...
PROCEDURE QFileDialog_setIconProvider ( self: QFileDialog;
...
VAR
ret:ADDRESS; result : QFileIconProvider;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QFileDialog_setLabelText ( self: QFileDialog;
label: DialogLabel;
 text: TEXT;
) =
VAR
...
PROCEDURE QFileDialog_labelText ( self: QFileDialog;
label: DialogLabel;
): TEXT =
VAR
ret : ADDRESS;
...
PROCEDURE QFileDialog_setProxyModel ( self: QFileDialog;
...
VAR
ret:ADDRESS; result : QAbstractProxyModel;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QFileDialog_setOption ( self: QFileDialog;
option: Option;
on: BOOLEAN;
) =
VAR
...
PROCEDURE QFileDialog_setOption1 ( self: QFileDialog;
option: Option;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_testOption ( self: QFileDialog;
option: Option;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_setOptions ( self: QFileDialog;
options: Options;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QFileDialog_options ( self: QFileDialog;
): Options =
VAR
ret:INTEGER; result : Options;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QFileDialog_open1 ( self: QFileDialog;
 receiver: QObject;
 member: TEXT;
) =
VAR
...
PROCEDURE QFileDialog_setVisible ( self: QFileDialog;
visible: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE GetOpenFileName ( parent: QWidget;
...
BEGIN
ret := QtFileDialogRaw.GetOpenFileName(arg1tmp, arg2tmp, arg3tmp, arg4tmp, arg5tmp, ORD(options));
...
PROCEDURE GetOpenFileName1 ( parent: QWidget;
 caption, dir, filter, selectedFilter: TEXT;
): TEXT =
VAR
ret : ADDRESS;
...
arg5tmp :=  LOOPHOLE(qstr_selectedFilter.cxxObj,ADDRESS);
BEGIN
ret := QtFileDialogRaw.GetOpenFileName1(arg1tmp, arg2tmp, arg3tmp, arg4tmp, arg5tmp);
...
PROCEDURE GetOpenFileName2 ( parent: QWidget;
 caption, dir, filter: TEXT;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
arg4tmp :=  LOOPHOLE(qstr_filter.cxxObj,ADDRESS);
BEGIN
ret := QtFileDialogRaw.GetOpenFileName2(arg1tmp, arg2tmp, arg3tmp, arg4tmp);
...
PROCEDURE GetOpenFileName3 ( parent: QWidget;
 caption, dir: TEXT;
): TEXT =
VAR
ret : ADDRESS;
...
PROCEDURE GetOpenFileName4 ( parent: QWidget;
 caption: TEXT;
): TEXT =
VAR
ret : ADDRESS;
...
PROCEDURE GetOpenFileName5 ( parent: QWidget;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE GetSaveFileName ( parent: QWidget;
 caption, dir, filter, selectedFilter: TEXT;
options: Options;
): TEXT =
VAR
...
arg5tmp :=  LOOPHOLE(qstr_selectedFilter.cxxObj,ADDRESS);
BEGIN
ret := QtFileDialogRaw.GetSaveFileName(arg1tmp, arg2tmp, arg3tmp, arg4tmp, arg5tmp, ORD(options));
...
PROCEDURE GetSaveFileName1 ( parent: QWidget;
 caption, dir, filter, selectedFilter: TEXT;
): TEXT =
VAR
ret : ADDRESS;
...
arg5tmp :=  LOOPHOLE(qstr_selectedFilter.cxxObj,ADDRESS);
BEGIN
ret := QtFileDialogRaw.GetSaveFileName1(arg1tmp, arg2tmp, arg3tmp, arg4tmp, arg5tmp);
...
PROCEDURE GetSaveFileName2 ( parent: QWidget;
 caption, dir, filter: TEXT;
): TEXT =
VAR
ret : ADDRESS;
...
arg4tmp :=  LOOPHOLE(qstr_filter.cxxObj,ADDRESS);
BEGIN
ret := QtFileDialogRaw.GetSaveFileName2(arg1tmp, arg2tmp, arg3tmp, arg4tmp);
...
PROCEDURE GetSaveFileName3 ( parent: QWidget;
 caption, dir: TEXT;
): TEXT =
VAR
ret : ADDRESS;
...
PROCEDURE GetSaveFileName4 ( parent: QWidget;
 caption: TEXT;
): TEXT =
VAR
ret : ADDRESS;
...
PROCEDURE GetSaveFileName5 ( parent: QWidget;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE GetExistingDirectory ( parent: QWidget;
 caption, dir: TEXT;
options: Options;
): TEXT =
VAR
...
arg3tmp :=  LOOPHOLE(qstr_dir.cxxObj,ADDRESS);
BEGIN
ret := QtFileDialogRaw.GetExistingDirectory(arg1tmp, arg2tmp, arg3tmp, ORD(options));
...
PROCEDURE GetExistingDirectory1 ( parent: QWidget;
 caption, dir: TEXT;
): TEXT =
VAR
ret : ADDRESS;
...
arg3tmp :=  LOOPHOLE(qstr_dir.cxxObj,ADDRESS);
BEGIN
ret := QtFileDialogRaw.GetExistingDirectory1(arg1tmp, arg2tmp, arg3tmp);
...
PROCEDURE GetExistingDirectory2 ( parent: QWidget;
 caption: TEXT;
): TEXT =
VAR
ret : ADDRESS;
...
PROCEDURE GetExistingDirectory3 ( parent: QWidget;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE GetOpenFileNames ( parent: QWidget;
 caption, dir, filter, selectedFilter: TEXT;
options: Options;
): QStringList =
VAR
...
arg5tmp :=  LOOPHOLE(qstr_selectedFilter.cxxObj,ADDRESS);
BEGIN
ret := QtFileDialogRaw.GetOpenFileNames(arg1tmp, arg2tmp, arg3tmp, arg4tmp, arg5tmp, ORD(options));
...
PROCEDURE GetOpenFileNames1 ( parent: QWidget;
 caption, dir, filter, selectedFilter: TEXT;
): QStringList =
VAR
ret:ADDRESS; result : QStringList;
...
arg5tmp :=  LOOPHOLE(qstr_selectedFilter.cxxObj,ADDRESS);
BEGIN
ret := QtFileDialogRaw.GetOpenFileNames1(arg1tmp, arg2tmp, arg3tmp, arg4tmp, arg5tmp);
...
PROCEDURE GetOpenFileNames2 ( parent: QWidget;
 caption, dir, filter: TEXT;
): QStringList =
VAR
ret:ADDRESS; result : QStringList;
...
arg4tmp :=  LOOPHOLE(qstr_filter.cxxObj,ADDRESS);
BEGIN
ret := QtFileDialogRaw.GetOpenFileNames2(arg1tmp, arg2tmp, arg3tmp, arg4tmp);
...
PROCEDURE GetOpenFileNames3 ( parent: QWidget;
 caption, dir: TEXT;
): QStringList =
VAR
ret:ADDRESS; result : QStringList;
...
PROCEDURE GetOpenFileNames4 ( parent: QWidget;
 caption: TEXT;
): QStringList =
VAR
ret:ADDRESS; result : QStringList;
...
PROCEDURE GetOpenFileNames5 ( parent: QWidget;
): QStringList =
VAR
ret:ADDRESS; result : QStringList;
arg1tmp :=  LOOPHOLE(parent.cxxObj,ADDRESS);
...
PROCEDURE Cleanup_QFileDialog(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
