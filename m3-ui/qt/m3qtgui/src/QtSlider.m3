...
PROCEDURE New_QSlider0 (self:QSlider; parent: QWidget;
): QSlider =
VAR
result : ADDRESS;
...
PROCEDURE New_QSlider2 (self:QSlider;orientation: Orientation;
 parent: QWidget;
): QSlider =
VAR
result : ADDRESS;
...
VAR
ret:INTEGER; result : TickPosition;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE Cleanup_QSlider(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QSlider := ref;
BEGIN
  Delete_QSlider(obj);
 END Cleanup_QSlider;
