...
SWIGEXPORT Qt::ItemFlags QListWidgetItem_flags(QListWidgetItem const * self) {
  QListWidgetItem *arg1 = (QListWidgetItem *) 0 ;
  Qt::ItemFlags cresult ;
  
  arg1 = *(QListWidgetItem **)&self; 
  *(Qt::ItemFlags **)&cresult = new Qt::ItemFlags((const Qt::ItemFlags &)((QListWidgetItem const *)arg1)->flags());
  return cresult;
}


SWIGEXPORT void QListWidgetItem_setFlags(QListWidgetItem * self, Qt::ItemFlags flags) {
  QListWidgetItem *arg1 = (QListWidgetItem *) 0 ;
  Qt::ItemFlags arg2 ;
...
SWIGEXPORT long Modula3_QListWidgetToQListView(long objectRef) {
    long baseptr = 0;
    *(QListView **)&baseptr = *(QListWidget **)&objectRef;
    return baseptr;
}
