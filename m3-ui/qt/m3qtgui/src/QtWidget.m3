...
PROCEDURE QWidget_inputContext (self: QWidget; ): REFANY =
  VAR
    ret    : ADDRESS;
...
PROCEDURE QWidget_setInputContext (self: QWidget; arg2: REFANY; ) =
  VAR
    selfAdr := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp := LOOPHOLE(NARROW(arg2, QInputContext).cxxObj, ADDRESS);
  BEGIN
