...
PROCEDURE New_QListView0 (self:QListView; parent: QWidget;
): QListView =
VAR
result : ADDRESS;
...
PROCEDURE QListView_setMovement ( self: QListView;
movement: Movement;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QListView_movement ( self: QListView;
): Movement =
VAR
ret:INTEGER; result : Movement;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QListView_setFlow ( self: QListView;
flow: Flow;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QListView_flow ( self: QListView;
): Flow =
VAR
ret:INTEGER; result : Flow;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QListView_setWrapping ( self: QListView;
enable: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QListView_isWrapping ( self: QListView;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QListView_setResizeMode ( self: QListView;
mode: ResizeMode;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QListView_resizeMode ( self: QListView;
): ResizeMode =
VAR
...
PROCEDURE QListView_setLayoutMode ( self: QListView;
mode: LayoutMode;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QListView_layoutMode ( self: QListView;
): LayoutMode =
VAR
ret:INTEGER; result : LayoutMode;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QListView_setSpacing ( self: QListView;
space: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QListView_spacing ( self: QListView;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QListView_setBatchSize ( self: QListView;
batchSize: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QListView_batchSize ( self: QListView;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QListView_setGridSize ( self: QListView;
 size: QSize;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QListView_gridSize ( self: QListView;
): QSize =
VAR
...
PROCEDURE QListView_setViewMode ( self: QListView;
mode: ViewMode;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QListView_viewMode ( self: QListView;
): ViewMode =
VAR
...
PROCEDURE QListView_isRowHidden ( self: QListView;
row: INTEGER;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QListView_setRowHidden ( self: QListView;
row: INTEGER;
hide: BOOLEAN;
) =
VAR
...
PROCEDURE QListView_setModelColumn ( self: QListView;
column: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QListView_modelColumn ( self: QListView;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QListView_setUniformItemSizes ( self: QListView;
enable: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QListView_uniformItemSizes ( self: QListView;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QListView_setWordWrap ( self: QListView;
on: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QListView_wordWrap ( self: QListView;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QListView_setSelectionRectVisible ( self: QListView;
show: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QListView_isSelectionRectVisible ( self: QListView;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QListView_visualRect ( self: QListView;
 index: QModelIndex;
): QRect =
VAR
...
PROCEDURE QListView_scrollTo ( self: QListView;
 index: QModelIndex;
hint: ScrollHint;
) =
VAR
...
PROCEDURE QListView_scrollTo1 ( self: QListView;
 index: QModelIndex;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QListView_setRootIndex ( self: QListView;
 index: QModelIndex;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE Cleanup_QListView(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
