...
PROCEDURE New_QItemSelectionRange0 (self: QItemSelectionRange; ):
  QItemSelectionRange =
  VAR result: ADDRESS;
  BEGIN
...
PROCEDURE New_QItemSelectionRange1
  (self: QItemSelectionRange; other: QItemSelectionRange; ):
  QItemSelectionRange =
  VAR
    result : ADDRESS;
...
PROCEDURE New_QItemSelectionRange2
  (self: QItemSelectionRange; topLeft, bottomRight: QModelIndex; ):
  QItemSelectionRange =
  VAR
    result : ADDRESS;
  ...
  BEGIN
    result :=
      QtItemSelectionModelRaw.New_QItemSelectionRange2(arg1tmp, arg2tmp);
...
PROCEDURE New_QItemSelectionRange3
  (self: QItemSelectionRange; index: QModelIndex; ): QItemSelectionRange =
  VAR
    result : ADDRESS;
...
PROCEDURE QItemSelectionRange_top (self: QItemSelectionRange; ): INTEGER =
...
PROCEDURE QItemSelectionRange_left (self: QItemSelectionRange; ): INTEGER =
  VAR arg1tmp := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QItemSelectionRange_bottomRight (self: QItemSelectionRange; ):
  ...
  BEGIN
    ret :=
      QtItemSelectionModelRaw.QItemSelectionRange_bottomRight(arg1tmp);
...
PROCEDURE QItemSelectionRange_contains
  (self: QItemSelectionRange; index: QModelIndex; ): BOOLEAN =
  VAR
    arg1tmp := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp := LOOPHOLE(index.cxxObj, ADDRESS);
  BEGIN
    RETURN QtItemSelectionModelRaw.QItemSelectionRange_contains(
             arg1tmp, arg2tmp);
...
PROCEDURE QItemSelectionRange_contains1
  (self       : QItemSelectionRange;
   row, column: INTEGER;
   parentIndex: QModelIndex;         ): BOOLEAN =
  VAR
    arg1tmp := LOOPHOLE(self.cxxObj, ADDRESS);
    arg4tmp := LOOPHOLE(parentIndex.cxxObj, ADDRESS);
  BEGIN
    RETURN QtItemSelectionModelRaw.QItemSelectionRange_contains1(
             arg1tmp, row, column, arg4tmp);
  END QItemSelectionRange_contains1;

PROCEDURE QItemSelectionRange_intersects
  (self, other: QItemSelectionRange; ): BOOLEAN =
  VAR
    arg1tmp := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp := LOOPHOLE(other.cxxObj, ADDRESS);
  BEGIN
    RETURN QtItemSelectionModelRaw.QItemSelectionRange_intersects(
             arg1tmp, arg2tmp);
  END QItemSelectionRange_intersects;

PROCEDURE QItemSelectionRange_intersect
  (self, other: QItemSelectionRange; ): QItemSelectionRange =
  VAR
    ret    : ADDRESS;
    result : QItemSelectionRange;
    arg1tmp                      := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp                      := LOOPHOLE(other.cxxObj, ADDRESS);
  BEGIN
    ret := QtItemSelectionModelRaw.QItemSelectionRange_intersect(
             arg1tmp, arg2tmp);
...
PROCEDURE QItemSelectionRange_intersected
  (self, other: QItemSelectionRange; ): QItemSelectionRange =
  VAR
    ret    : ADDRESS;
    result : QItemSelectionRange;
    ...
    arg2tmp                      := LOOPHOLE(other.cxxObj, ADDRESS);
  BEGIN
    ret := QtItemSelectionModelRaw.QItemSelectionRange_intersected(
             arg1tmp, arg2tmp);
...
PROCEDURE Cleanup_QItemSelectionRange
...
REVEAL
  QItemSelectionRange = QItemSelectionRangePublic BRANDED OBJECT
                        OVERRIDES
...
PROCEDURE New_QItemSelectionModel0
  (self: QItemSelectionModel; model: QAbstractItemModel; ):
  QItemSelectionModel =
  VAR
    result : ADDRESS;
...
PROCEDURE New_QItemSelectionModel1 (self  : QItemSelectionModel;
  ...
  BEGIN
    result :=
      QtItemSelectionModelRaw.New_QItemSelectionModel1(arg1tmp, arg2tmp);
...
PROCEDURE QItemSelectionModel_currentIndex (self: QItemSelectionModel; ):
  ...
  BEGIN
    ret :=
      QtItemSelectionModelRaw.QItemSelectionModel_currentIndex(arg1tmp);
...
PROCEDURE QItemSelectionModel_isSelected
  (self: QItemSelectionModel; index: QModelIndex; ): BOOLEAN =
  VAR
    arg1tmp := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp := LOOPHOLE(index.cxxObj, ADDRESS);
  BEGIN
    RETURN QtItemSelectionModelRaw.QItemSelectionModel_isSelected(
             arg1tmp, arg2tmp);
  END QItemSelectionModel_isSelected;

PROCEDURE QItemSelectionModel_isRowSelected
  (self: QItemSelectionModel; row: INTEGER; parent: QModelIndex; ):
  BOOLEAN =
  VAR
    arg1tmp := LOOPHOLE(self.cxxObj, ADDRESS);
    arg3tmp := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    RETURN QtItemSelectionModelRaw.QItemSelectionModel_isRowSelected(
             arg1tmp, row, arg3tmp);
  END QItemSelectionModel_isRowSelected;

PROCEDURE QItemSelectionModel_isColumnSelected
  (self: QItemSelectionModel; column: INTEGER; parent: QModelIndex; ):
  BOOLEAN =
  VAR
    arg1tmp := LOOPHOLE(self.cxxObj, ADDRESS);
    arg3tmp := LOOPHOLE(parent.cxxObj, ADDRESS);
  BEGIN
    RETURN QtItemSelectionModelRaw.QItemSelectionModel_isColumnSelected(
...
PROCEDURE QItemSelectionModel_rowIntersectsSelection
  ...
  BEGIN
    RETURN
      QtItemSelectionModelRaw.QItemSelectionModel_rowIntersectsSelection(
        arg1tmp, row, arg3tmp);
...
PROCEDURE QItemSelectionModel_columnIntersectsSelection
  ...
  BEGIN
    RETURN
      QtItemSelectionModelRaw.QItemSelectionModel_columnIntersectsSelection(
        arg1tmp, column, arg3tmp);
...
PROCEDURE QItemSelectionModel_hasSelection (self: QItemSelectionModel; ):
  ...
  BEGIN
    RETURN
      QtItemSelectionModelRaw.QItemSelectionModel_hasSelection(arg1tmp);
  END QItemSelectionModel_hasSelection;

PROCEDURE QItemSelectionModel_selectedIndexes
  (self: QItemSelectionModel; ): QModelIndexList =
  VAR
    ret    : ADDRESS;
    result : QModelIndexList;
    arg1tmp                  := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    ret :=
      QtItemSelectionModelRaw.QItemSelectionModel_selectedIndexes(arg1tmp);
...
PROCEDURE QItemSelectionModel_selectedRows
  (self: QItemSelectionModel; column: INTEGER; ): QModelIndexList =
  VAR
    ret    : ADDRESS;
    result : QModelIndexList;
    arg1tmp                  := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    ret := QtItemSelectionModelRaw.QItemSelectionModel_selectedRows(
             arg1tmp, column);
...
PROCEDURE QItemSelectionModel_selectedRows1 (self: QItemSelectionModel; ):
  ...
  BEGIN
    ret :=
      QtItemSelectionModelRaw.QItemSelectionModel_selectedRows1(arg1tmp);
...
PROCEDURE QItemSelectionModel_selectedColumns
  (self: QItemSelectionModel; row: INTEGER; ): QModelIndexList =
  VAR
    ret    : ADDRESS;
    result : QModelIndexList;
    arg1tmp                  := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    ret := QtItemSelectionModelRaw.QItemSelectionModel_selectedColumns(
             arg1tmp, row);
...
PROCEDURE QItemSelectionModel_selectedColumns1
  (self: QItemSelectionModel; ): QModelIndexList =
  VAR
    ret    : ADDRESS;
    result : QModelIndexList;
    arg1tmp                  := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    ret := QtItemSelectionModelRaw.QItemSelectionModel_selectedColumns1(
             arg1tmp);
...
PROCEDURE QItemSelectionModel_setCurrentIndex (self : QItemSelectionModel;
  ...
  VAR
    ...
    arg2tmp := LOOPHOLE(index.cxxObj, ADDRESS);
  BEGIN
    QtItemSelectionModelRaw.QItemSelectionModel_setCurrentIndex(
      arg1tmp, arg2tmp, ORD(command));
...
PROCEDURE QItemSelectionModel_select (self   : QItemSelectionModel;
  ...
  VAR
    ...
    arg2tmp := LOOPHOLE(index.cxxObj, ADDRESS);
  BEGIN
    QtItemSelectionModelRaw.QItemSelectionModel_select(
      arg1tmp, arg2tmp, ORD(command));
...
PROCEDURE QItemSelectionModel_select1 (self     : QItemSelectionModel;
  ...
  BEGIN
    QtItemSelectionModelRaw.QItemSelectionModel_select1(
      arg1tmp, arg2tmp, ORD(command));
...
PROCEDURE QItemSelectionModel_clearSelection
...
PROCEDURE Cleanup_QItemSelectionModel
  (<* UNUSED *> READONLY self: WeakRef.T; ref: REFANY) =
...
PROCEDURE New_QItemSelection1
  (self: QItemSelection; topLeft, bottomRight: QModelIndex; ):
  QItemSelection =
  VAR
    result : ADDRESS;
    arg1tmp          := LOOPHOLE(topLeft.cxxObj, ADDRESS);
  ...
  BEGIN
    result :=
      QtItemSelectionModelRaw.New_QItemSelection1(arg1tmp, arg2tmp);
...
PROCEDURE QItemSelection_select
  (self: QItemSelection; topLeft, bottomRight: QModelIndex; ) =
  VAR
    arg1tmp := LOOPHOLE(self.cxxObj, ADDRESS);
  ...
  BEGIN
    QtItemSelectionModelRaw.QItemSelection_select(
      arg1tmp, arg2tmp, arg3tmp);
  END QItemSelection_select;

PROCEDURE QItemSelection_contains
  (self: QItemSelection; index: QModelIndex; ): BOOLEAN =
  VAR
    arg1tmp := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp := LOOPHOLE(index.cxxObj, ADDRESS);
  BEGIN
    RETURN
      QtItemSelectionModelRaw.QItemSelection_contains(arg1tmp, arg2tmp);
...
PROCEDURE QItemSelection_merge
  (self, other: QItemSelection; command: SelectionFlags; ) =
  VAR
    arg1tmp := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp := LOOPHOLE(other.cxxObj, ADDRESS);
  BEGIN
    QtItemSelectionModelRaw.QItemSelection_merge(
      arg1tmp, arg2tmp, ORD(command));
  END QItemSelection_merge;

PROCEDURE Split
  (range, other: QItemSelectionRange; result: QItemSelection; ) =
  VAR
...
PROCEDURE Cleanup_QItemSelection
  (<* UNUSED *> READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
  QItemSelection = QItemSelectionPublic BRANDED OBJECT
                   OVERRIDES
