...
PROCEDURE New_QSplashScreen0 (self:QSplashScreen; pixmap: QPixmap;
f: WindowTypes;
): QSplashScreen =
VAR
result : ADDRESS;
...
PROCEDURE New_QSplashScreen3 (self:QSplashScreen; parent: QWidget;
 pixmap: QPixmap;
f: WindowTypes;
): QSplashScreen =
VAR
...
BEGIN
result := QtSplashScreenRaw.New_QSplashScreen3(arg1tmp, arg2tmp, ORD(f));
...
PROCEDURE New_QSplashScreen4 (self:QSplashScreen; parent: QWidget;
 pixmap: QPixmap;
): QSplashScreen =
VAR
result : ADDRESS;
...
BEGIN
QtSplashScreenRaw.QSplashScreen_showMessage(selfAdr, arg2tmp, alignment, arg4tmp);
...
arg2tmp :=  LOOPHOLE(qstr_message.cxxObj,ADDRESS);
BEGIN
QtSplashScreenRaw.QSplashScreen_showMessage1(selfAdr, arg2tmp, alignment);
...
PROCEDURE Cleanup_QSplashScreen(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
QSplashScreen =
QSplashScreenPublic BRANDED OBJECT
OVERRIDES
