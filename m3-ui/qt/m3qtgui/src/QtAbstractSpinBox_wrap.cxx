...
SWIGEXPORT void QAbstractSpinBox_setAlignment(QAbstractSpinBox * self, Qt::Alignment flag) {
  QAbstractSpinBox *arg1 = (QAbstractSpinBox *) 0 ;
  Qt::Alignment arg2 ;
...
SWIGEXPORT Qt::Alignment QAbstractSpinBox_alignment(QAbstractSpinBox const * self) {
  QAbstractSpinBox *arg1 = (QAbstractSpinBox *) 0 ;
  Qt::Alignment cresult ;
  
  arg1 = *(QAbstractSpinBox **)&self; 
  *(Qt::Alignment **)&cresult = new Qt::Alignment((const Qt::Alignment &)((QAbstractSpinBox const *)arg1)->alignment());
  return cresult;
}
...
SWIGEXPORT long Modula3_QAbstractSpinBoxToQWidget(long objectRef) {
    long baseptr = 0;
    *(QWidget **)&baseptr = *(QAbstractSpinBox **)&objectRef;
    return baseptr;
}
