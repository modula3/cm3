...
PROCEDURE New_QDateTimeEdit2 (self:QDateTimeEdit; dt: QDateTime;
 parent: QWidget;
): QDateTimeEdit =
VAR
result : ADDRESS;
...
PROCEDURE New_QDateTimeEdit4 (self:QDateTimeEdit; d: QDate;
 parent: QWidget;
): QDateTimeEdit =
VAR
result : ADDRESS;
...
PROCEDURE New_QDateTimeEdit6 (self:QDateTimeEdit; t: QTime;
 parent: QWidget;
): QDateTimeEdit =
VAR
result : ADDRESS;
...
PROCEDURE QDateTimeEdit_dateTime ( self: QDateTimeEdit;
): QDateTime =
VAR
...
PROCEDURE QDateTimeEdit_date ( self: QDateTimeEdit;
): QDate =
VAR
...
PROCEDURE QDateTimeEdit_time ( self: QDateTimeEdit;
): QTime =
VAR
...
PROCEDURE QDateTimeEdit_setMinimumDateTime ( self: QDateTimeEdit;
 dt: QDateTime;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_setMaximumDateTime ( self: QDateTimeEdit;
 dt: QDateTime;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_setDateTimeRange ( self: QDateTimeEdit;
 min, max: QDateTime;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
BEGIN
QtDateTimeEditRaw.QDateTimeEdit_setDateTimeRange(selfAdr, arg2tmp, arg3tmp);
END QDateTimeEdit_setDateTimeRange;

PROCEDURE QDateTimeEdit_minimumDate ( self: QDateTimeEdit;
): QDate =
VAR
ret:ADDRESS; result : QDate;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_setMinimumDate ( self: QDateTimeEdit;
 min: QDate;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_maximumDate ( self: QDateTimeEdit;
): QDate =
VAR
ret:ADDRESS; result : QDate;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_setMaximumDate ( self: QDateTimeEdit;
 max: QDate;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_setDateRange ( self: QDateTimeEdit;
 min, max: QDate;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_minimumTime ( self: QDateTimeEdit;
): QTime =
VAR
ret:ADDRESS; result : QTime;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_setMinimumTime ( self: QDateTimeEdit;
 min: QTime;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_maximumTime ( self: QDateTimeEdit;
): QTime =
VAR
ret:ADDRESS; result : QTime;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_setMaximumTime ( self: QDateTimeEdit;
 max: QTime;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_setTimeRange ( self: QDateTimeEdit;
 min, max: QTime;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_currentSection ( self: QDateTimeEdit;
): Section =
VAR
ret:INTEGER; result : Section;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QDateTimeEdit_sectionAt ( self: QDateTimeEdit;
index: INTEGER;
): Section =
VAR
ret:INTEGER; result : Section;
...
PROCEDURE QDateTimeEdit_setCurrentSection ( self: QDateTimeEdit;
section: Section;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtDateTimeEditRaw.QDateTimeEdit_setCurrentSection(selfAdr, ORD(section));
...
PROCEDURE QDateTimeEdit_setCurrentSectionIndex ( self: QDateTimeEdit;
index: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
VAR
ret:ADDRESS; result : QCalendarWidget;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QDateTimeEdit_setCalendarWidget ( self: QDateTimeEdit;
...
PROCEDURE QDateTimeEdit_sectionCount ( self: QDateTimeEdit;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QDateTimeEdit_setSelectedSection ( self: QDateTimeEdit;
section: Section;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtDateTimeEditRaw.QDateTimeEdit_setSelectedSection(selfAdr, ORD(section));
END QDateTimeEdit_setSelectedSection;

PROCEDURE QDateTimeEdit_sectionText ( self: QDateTimeEdit;
section: Section;
): TEXT =
VAR
ret : ADDRESS;
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtDateTimeEditRaw.QDateTimeEdit_sectionText(selfAdr, ORD(section));
...
PROCEDURE QDateTimeEdit_displayFormat ( self: QDateTimeEdit;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE QDateTimeEdit_setDisplayFormat ( self: QDateTimeEdit;
 format: TEXT;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_calendarPopup ( self: QDateTimeEdit;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QDateTimeEdit_setCalendarPopup ( self: QDateTimeEdit;
enable: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_timeSpec ( self: QDateTimeEdit;
): TimeSpec =
VAR
...
PROCEDURE QDateTimeEdit_setTimeSpec ( self: QDateTimeEdit;
spec: TimeSpec;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_sizeHint ( self: QDateTimeEdit;
): QSize =
VAR
...
PROCEDURE QDateTimeEdit_stepBy ( self: QDateTimeEdit;
steps: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_setDateTime ( self: QDateTimeEdit;
 dateTime: QDateTime;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_setDate ( self: QDateTimeEdit;
 date: QDate;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QDateTimeEdit_setTime ( self: QDateTimeEdit;
 time: QTime;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE Cleanup_QDateTimeEdit(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
PROCEDURE New_QTimeEdit0 (self:QTimeEdit; parent: QWidget;
): QTimeEdit =
VAR
result : ADDRESS;
arg1tmp :=  LOOPHOLE(parent.cxxObj,ADDRESS);
...
PROCEDURE New_QTimeEdit2 (self:QTimeEdit; time: QTime;
 parent: QWidget;
): QTimeEdit =
VAR
result : ADDRESS;
...
PROCEDURE New_QTimeEdit3 (self:QTimeEdit; time: QTime;
): QTimeEdit =
VAR
result : ADDRESS;
arg1tmp :=  LOOPHOLE(time.cxxObj,ADDRESS);
...
PROCEDURE Cleanup_QTimeEdit(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
QTimeEdit =
QTimeEditPublic BRANDED OBJECT
OVERRIDES
...
PROCEDURE New_QDateEdit0 (self:QDateEdit; parent: QWidget;
): QDateEdit =
VAR
result : ADDRESS;
arg1tmp :=  LOOPHOLE(parent.cxxObj,ADDRESS);
...
PROCEDURE New_QDateEdit2 (self:QDateEdit; date: QDate;
 parent: QWidget;
): QDateEdit =
VAR
result : ADDRESS;
...
PROCEDURE New_QDateEdit3 (self:QDateEdit; date: QDate;
): QDateEdit =
VAR
result : ADDRESS;
arg1tmp :=  LOOPHOLE(date.cxxObj,ADDRESS);
...
PROCEDURE Cleanup_QDateEdit(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
QDateEdit =
QDateEditPublic BRANDED OBJECT
OVERRIDES
