...
PROCEDURE New_QPageSetupDialog0 (self:QPageSetupDialog; printer: QPrinter;
 parent: QWidget;
): QPageSetupDialog =
VAR
result : ADDRESS;
...
PROCEDURE New_QPageSetupDialog1 (self:QPageSetupDialog; printer: QPrinter;
): QPageSetupDialog =
VAR
result : ADDRESS;
arg1tmp :=  LOOPHOLE(printer.cxxObj,ADDRESS);
...
PROCEDURE New_QPageSetupDialog2 (self:QPageSetupDialog; parent: QWidget;
): QPageSetupDialog =
VAR
result : ADDRESS;
...
PROCEDURE New_QPageSetupDialog3 (self:QPageSetupDialog;): QPageSetupDialog =
VAR
result : ADDRESS;
BEGIN
...
option: PageSetupDialogOption;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtPageSetupDialogRaw.QPageSetupDialog_addEnabledOption(selfAdr, ORD(option));
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtPageSetupDialogRaw.QPageSetupDialog_setEnabledOptions(selfAdr, ORD(options));
...
VAR
ret:INTEGER; result : QPageSetupDialog_PageSetupDialogOptions;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
RETURN QtPageSetupDialogRaw.QPageSetupDialog_isOptionEnabled(selfAdr, ORD(option));
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtPageSetupDialogRaw.QPageSetupDialog_setOption(selfAdr, ORD(option), on);
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
RETURN QtPageSetupDialogRaw.QPageSetupDialog_testOption(selfAdr, ORD(option));
...
PROCEDURE Cleanup_QPageSetupDialog(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
