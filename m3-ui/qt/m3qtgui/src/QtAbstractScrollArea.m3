...
PROCEDURE New_QAbstractScrollArea0 (self:QAbstractScrollArea; parent: QWidget;
): QAbstractScrollArea =
VAR
result : ADDRESS;
...
PROCEDURE New_QAbstractScrollArea1 (self:QAbstractScrollArea;): QAbstractScrollArea =
VAR
result : ADDRESS;
BEGIN
...
PROCEDURE QAbstractScrollArea_verticalScrollBarPolicy ( self: QAbstractScrollArea;
): ScrollBarPolicy =
VAR
ret:INTEGER; result : ScrollBarPolicy;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtAbstractScrollAreaRaw.QAbstractScrollArea_verticalScrollBarPolicy(selfAdr);
result := VAL(ret,ScrollBarPolicy);  
RETURN result;
END QAbstractScrollArea_verticalScrollBarPolicy;

PROCEDURE QAbstractScrollArea_setVerticalScrollBarPolicy ( self: QAbstractScrollArea;
arg2: ScrollBarPolicy;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtAbstractScrollAreaRaw.QAbstractScrollArea_setVerticalScrollBarPolicy(selfAdr, ORD(arg2));
END QAbstractScrollArea_setVerticalScrollBarPolicy;

PROCEDURE QAbstractScrollArea_verticalScrollBar ( self: QAbstractScrollArea;
): QScrollBar =
VAR
ret:ADDRESS; result : QScrollBar;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtAbstractScrollAreaRaw.QAbstractScrollArea_verticalScrollBar(selfAdr);
...
PROCEDURE QAbstractScrollArea_setVerticalScrollBar ( self: QAbstractScrollArea;
...
BEGIN
QtAbstractScrollAreaRaw.QAbstractScrollArea_setVerticalScrollBar(selfAdr, arg2tmp);
END QAbstractScrollArea_setVerticalScrollBar;

PROCEDURE QAbstractScrollArea_horizontalScrollBarPolicy ( self: QAbstractScrollArea;
): ScrollBarPolicy =
VAR
ret:INTEGER; result : ScrollBarPolicy;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtAbstractScrollAreaRaw.QAbstractScrollArea_horizontalScrollBarPolicy(selfAdr);
result := VAL(ret,ScrollBarPolicy);  
RETURN result;
END QAbstractScrollArea_horizontalScrollBarPolicy;

PROCEDURE QAbstractScrollArea_setHorizontalScrollBarPolicy ( self: QAbstractScrollArea;
arg2: ScrollBarPolicy;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtAbstractScrollAreaRaw.QAbstractScrollArea_setHorizontalScrollBarPolicy(selfAdr, ORD(arg2));
END QAbstractScrollArea_setHorizontalScrollBarPolicy;

PROCEDURE QAbstractScrollArea_horizontalScrollBar ( self: QAbstractScrollArea;
): QScrollBar =
VAR
ret:ADDRESS; result : QScrollBar;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtAbstractScrollAreaRaw.QAbstractScrollArea_horizontalScrollBar(selfAdr);
...
PROCEDURE QAbstractScrollArea_setHorizontalScrollBar ( self: QAbstractScrollArea;
 scrollbar: QScrollBar;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(scrollbar.cxxObj,ADDRESS);
BEGIN
QtAbstractScrollAreaRaw.QAbstractScrollArea_setHorizontalScrollBar(selfAdr, arg2tmp);
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtAbstractScrollAreaRaw.QAbstractScrollArea_cornerWidget(selfAdr);
...
PROCEDURE QAbstractScrollArea_setCornerWidget ( self: QAbstractScrollArea;
 widget: QWidget;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
BEGIN
QtAbstractScrollAreaRaw.QAbstractScrollArea_setCornerWidget(selfAdr, arg2tmp);
END QAbstractScrollArea_setCornerWidget;

PROCEDURE QAbstractScrollArea_addScrollBarWidget ( self: QAbstractScrollArea;
 widget: QWidget;
...
arg2tmp :=  LOOPHOLE(widget.cxxObj,ADDRESS);
BEGIN
QtAbstractScrollAreaRaw.QAbstractScrollArea_addScrollBarWidget(selfAdr, arg2tmp, ORD(alignment));
END QAbstractScrollArea_addScrollBarWidget;

PROCEDURE QAbstractScrollArea_scrollBarWidgets ( self: QAbstractScrollArea;
alignment: AlignmentFlag;
): QWidgetList =
VAR
ret:ADDRESS; result : QWidgetList;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtAbstractScrollAreaRaw.QAbstractScrollArea_scrollBarWidgets(selfAdr, ORD(alignment));
...
PROCEDURE QAbstractScrollArea_setViewport ( self: QAbstractScrollArea;
 widget: QWidget;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(widget.cxxObj,ADDRESS);
BEGIN
QtAbstractScrollAreaRaw.QAbstractScrollArea_setViewport(selfAdr, arg2tmp);
END QAbstractScrollArea_setViewport;

PROCEDURE QAbstractScrollArea_maximumViewportSize ( self: QAbstractScrollArea;
): QSize =
VAR
ret:ADDRESS; result : QSize;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtAbstractScrollAreaRaw.QAbstractScrollArea_maximumViewportSize(selfAdr);
...
PROCEDURE QAbstractScrollArea_minimumSizeHint ( self: QAbstractScrollArea;
): QSize =
VAR
ret:ADDRESS; result : QSize;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtAbstractScrollAreaRaw.QAbstractScrollArea_minimumSizeHint(selfAdr);
...
PROCEDURE Cleanup_QAbstractScrollArea(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
