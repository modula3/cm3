...
PROCEDURE New_QMdiArea0 (self:QMdiArea; parent: QWidget;
): QMdiArea =
VAR
result : ADDRESS;
...
PROCEDURE QMdiArea_sizeHint ( self: QMdiArea;
): QSize =
VAR
...
PROCEDURE QMdiArea_minimumSizeHint ( self: QMdiArea;
): QSize =
VAR
ret:ADDRESS; result : QSize;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMdiArea_currentSubWindow ( self: QMdiArea;
): QMdiSubWindow =
VAR
ret:ADDRESS; result : QMdiSubWindow;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QMdiArea_activeSubWindow ( self: QMdiArea;
): QMdiSubWindow =
VAR
ret:ADDRESS; result : QMdiSubWindow;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMdiArea_addSubWindow ( self: QMdiArea;
 widget: QWidget;
flags: WindowTypes;
): QMdiSubWindow =
VAR
...
BEGIN
ret := QtMdiAreaRaw.QMdiArea_addSubWindow(selfAdr, arg2tmp, ORD(flags));
...
PROCEDURE QMdiArea_addSubWindow1 ( self: QMdiArea;
 widget: QWidget;
): QMdiSubWindow =
VAR
ret:ADDRESS; result : QMdiSubWindow;
...
PROCEDURE QMdiArea_removeSubWindow ( self: QMdiArea;
 widget: QWidget;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMdiArea_background ( self: QMdiArea;
): QBrush =
VAR
...
PROCEDURE QMdiArea_setBackground ( self: QMdiArea;
 background: QBrush;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMdiArea_activationOrder ( self: QMdiArea;
): WindowOrder =
VAR
ret:INTEGER; result : WindowOrder;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QMdiArea_setActivationOrder ( self: QMdiArea;
order: WindowOrder;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMdiArea_setOption ( self: QMdiArea;
option: AreaOption;
on: BOOLEAN;
) =
VAR
...
PROCEDURE QMdiArea_setOption1 ( self: QMdiArea;
option: AreaOption;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMdiArea_testOption ( self: QMdiArea;
opton: AreaOption;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMdiArea_setViewMode ( self: QMdiArea;
mode: ViewMode;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMdiArea_viewMode ( self: QMdiArea;
): ViewMode =
VAR
...
PROCEDURE QMdiArea_documentMode ( self: QMdiArea;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QMdiArea_setDocumentMode ( self: QMdiArea;
enabled: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMdiArea_setTabShape ( self: QMdiArea;
shape: TabShape;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMdiArea_tabShape ( self: QMdiArea;
): TabShape =
VAR
...
PROCEDURE QMdiArea_setTabPosition ( self: QMdiArea;
...
PROCEDURE QMdiArea_tabPosition ( self: QMdiArea;
): TabPosition =
VAR
...
PROCEDURE QMdiArea_setActiveSubWindow ( self: QMdiArea;
...
PROCEDURE Cleanup_QMdiArea(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
