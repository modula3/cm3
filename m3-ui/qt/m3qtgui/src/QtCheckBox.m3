...
PROCEDURE New_QCheckBox0 (self:QCheckBox; parent: QWidget;
): QCheckBox =
VAR
result : ADDRESS;
...
PROCEDURE New_QCheckBox2 (self:QCheckBox; text: TEXT;
 parent: QWidget;
): QCheckBox =
VAR
result : ADDRESS;
...
PROCEDURE New_QCheckBox3 (self:QCheckBox; text: TEXT;
): QCheckBox =
VAR
result : ADDRESS;
qstr_text := NEW(QString).initQString(text);
...
PROCEDURE Cleanup_QCheckBox(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
QCheckBox =
QCheckBoxPublic BRANDED OBJECT
OVERRIDES
