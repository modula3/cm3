...
FROM QtNamespace IMPORT ToolBarArea, Orientation, ToolBarAreas,
                        ToolButtonStyle;
...
PROCEDURE New_QToolBar0 (self: QToolBar; title: TEXT; parent: QWidget; ):
  QToolBar =
  VAR
    result    : ADDRESS;
...
PROCEDURE New_QToolBar1 (self: QToolBar; title: TEXT; ): QToolBar =
  VAR
    result    : ADDRESS;
    qstr_title          := NEW(QString).initQString(title);
    arg1tmp             := LOOPHOLE(qstr_title.cxxObj, ADDRESS);
...
PROCEDURE New_QToolBar2 (self: QToolBar; parent: QWidget; ): QToolBar =
  VAR
    result : ADDRESS;
...
PROCEDURE QToolBar_setMovable (self: QToolBar; movable: BOOLEAN; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtToolBarRaw.QToolBar_setMovable(selfAdr, movable);
  END QToolBar_setMovable;

PROCEDURE QToolBar_isMovable (self: QToolBar; ): BOOLEAN =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtToolBarRaw.QToolBar_isMovable(selfAdr);
  END QToolBar_isMovable;

PROCEDURE QToolBar_setAllowedAreas
  (self: QToolBar; areas: ToolBarAreas; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtToolBarRaw.QToolBar_setAllowedAreas(selfAdr, ORD(areas));
  END QToolBar_setAllowedAreas;

PROCEDURE QToolBar_allowedAreas (self: QToolBar; ): ToolBarAreas =
  VAR
    ret    : INTEGER;
    result : ToolBarAreas;
...
PROCEDURE QToolBar_isAreaAllowed (self: QToolBar; area: ToolBarArea; ):
  BOOLEAN =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QToolBar_setOrientation
  (self: QToolBar; orientation: Orientation; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtToolBarRaw.QToolBar_setOrientation(selfAdr, ORD(orientation));
  END QToolBar_setOrientation;

PROCEDURE QToolBar_orientation (self: QToolBar; ): Orientation =
  VAR
    ret    : INTEGER;
    result : Orientation;
    selfAdr: ADDRESS     := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QToolBar_addAction0_0 (self: QToolBar; action: QAction; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QToolBar_addAction1 (self: QToolBar; text: TEXT; ): QAction =
  VAR
    ret      : ADDRESS;
    result   : QAction;
    selfAdr  : ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QToolBar_addAction2 (self: QToolBar; icon: QIcon; text: TEXT; ):
  QAction =
  VAR
    ret      : ADDRESS;
    result   : QAction;
...
PROCEDURE QToolBar_addAction3
  (self: QToolBar; text: TEXT; receiver: QObject; member: TEXT; ):
  QAction =
  VAR
    ret      : ADDRESS;
    result   : QAction;
  ...
  BEGIN
    ...
    ret :=
      QtToolBarRaw.QToolBar_addAction3(selfAdr, arg2tmp, arg3tmp, arg4tmp);
...
PROCEDURE QToolBar_addAction4 (self    : QToolBar;
  ...
  BEGIN
    ...
    ret := QtToolBarRaw.QToolBar_addAction4(
...
PROCEDURE QToolBar_addSeparator (self: QToolBar; ): QAction =
  VAR
    ret    : ADDRESS;
    result : QAction;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QToolBar_insertSeparator (self: QToolBar; before: QAction; ):
  QAction =
  VAR
    ret    : ADDRESS;
    result : QAction;
...
PROCEDURE QToolBar_addWidget (self: QToolBar; widget: QWidget; ): QAction =
  VAR
    ret    : ADDRESS;
    result : QAction;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QToolBar_insertWidget
  (self: QToolBar; before: QAction; widget: QWidget; ): QAction =
  VAR
    ret    : ADDRESS;
    result : QAction;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QToolBar_actionGeometry (self: QToolBar; action: QAction; ):
  QRect =
  VAR
    ret    : ADDRESS;
    result : QRect;
...
PROCEDURE QToolBar_actionAt (self: QToolBar; p: QPoint; ): QAction =
  VAR
    ret    : ADDRESS;
    result : QAction;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QToolBar_actionAt1 (self: QToolBar; x, y: INTEGER; ): QAction =
  VAR
    ret    : ADDRESS;
    result : QAction;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QToolBar_toggleViewAction (self: QToolBar; ): QAction =
  VAR
    ret    : ADDRESS;
    result : QAction;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QToolBar_iconSize (self: QToolBar; ): QSize =
  VAR
    ret    : ADDRESS;
    result : QSize;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QToolBar_toolButtonStyle (self: QToolBar; ): ToolButtonStyle =
  VAR
    ret    : INTEGER;
...
PROCEDURE QToolBar_widgetForAction (self: QToolBar; action: QAction; ):
  QWidget =
  VAR
    ret    : ADDRESS;
    result : QWidget;
...
PROCEDURE QToolBar_isFloatable (self: QToolBar; ): BOOLEAN =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtToolBarRaw.QToolBar_isFloatable(selfAdr);
  END QToolBar_isFloatable;

PROCEDURE QToolBar_setFloatable (self: QToolBar; floatable: BOOLEAN; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtToolBarRaw.QToolBar_setFloatable(selfAdr, floatable);
  END QToolBar_setFloatable;

PROCEDURE QToolBar_isFloating (self: QToolBar; ): BOOLEAN =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtToolBarRaw.QToolBar_isFloating(selfAdr);
  END QToolBar_isFloating;

PROCEDURE QToolBar_setIconSize (self: QToolBar; iconSize: QSize; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QToolBar_setToolButtonStyle
  (self: QToolBar; toolButtonStyle: ToolButtonStyle; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtToolBarRaw.QToolBar_setToolButtonStyle(selfAdr, ORD(toolButtonStyle));
  END QToolBar_setToolButtonStyle;

PROCEDURE Cleanup_QToolBar
...
REVEAL
  QToolBar = QToolBarPublic BRANDED OBJECT
             OVERRIDES
