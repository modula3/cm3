...
SWIGEXPORT QWizard * New_QWizard0(QWidget * parent, Qt::WindowFlags flags) {
...
SWIGEXPORT void QWizard_setOptions(QWizard * self, WizardOptions options) {
  QWizard *arg1 = (QWizard *) 0 ;
  WizardOptions arg2 ;
...
SWIGEXPORT WizardOptions QWizard_options(QWizard const * self) {
  QWizard *arg1 = (QWizard *) 0 ;
  WizardOptions cresult ;
  
  arg1 = *(QWizard **)&self; 
  *(WizardOptions **)&cresult = new WizardOptions((const WizardOptions &)((QWizard const *)arg1)->options());
  return cresult;
}
...
SWIGEXPORT long Modula3_QWizardToQDialog(long objectRef) {
    long baseptr = 0;
    *(QDialog **)&baseptr = *(QWizard **)&objectRef;
    return baseptr;
}

SWIGEXPORT long Modula3_QWizardPageToQWidget(long objectRef) {
    long baseptr = 0;
    *(QWidget **)&baseptr = *(QWizardPage **)&objectRef;
    return baseptr;
}
