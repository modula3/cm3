...
PROCEDURE New_QBrush1 (bs: C.int;
): QBrush;

<* EXTERNAL New_QBrush2 *>
PROCEDURE New_QBrush2 ( color: ADDRESS;
bs: C.int;
): QBrush;

<* EXTERNAL New_QBrush3 *>
PROCEDURE New_QBrush3 ( color: ADDRESS;
): QBrush;

<* EXTERNAL New_QBrush4 *>
PROCEDURE New_QBrush4 (color, bs: C.int;
): QBrush;

<* EXTERNAL New_QBrush5 *>
PROCEDURE New_QBrush5 (color: C.int;
): QBrush;

<* EXTERNAL New_QBrush6 *>
PROCEDURE New_QBrush6 ( color, pixmap: ADDRESS;
): QBrush;

<* EXTERNAL New_QBrush7 *>
PROCEDURE New_QBrush7 (color: C.int;
 pixmap: ADDRESS;
): QBrush;

<* EXTERNAL New_QBrush8 *>
PROCEDURE New_QBrush8 ( pixmap: ADDRESS;
): QBrush;

<* EXTERNAL New_QBrush9 *>
PROCEDURE New_QBrush9 ( image: ADDRESS;
): QBrush;

<* EXTERNAL New_QBrush10 *>
PROCEDURE New_QBrush10 ( brush: ADDRESS;
): QBrush;

<* EXTERNAL New_QBrush11 *>
PROCEDURE New_QBrush11 ( gradient: ADDRESS;
): QBrush;
...
PROCEDURE QBrush_Op_Brush_Assign ( self: QBrush;
 brush: ADDRESS;
): ADDRESS;
...
PROCEDURE QBrush_Op_Brush_Equals ( self: QBrush;
 b: ADDRESS;
): BOOLEAN;

<* EXTERNAL QBrush_Op_Brush_NotEquals *>
PROCEDURE QBrush_Op_Brush_NotEquals ( self: QBrush;
 b: ADDRESS;
): BOOLEAN;
...
PROCEDURE QGradient_Op_Grad_Equals ( self: QGradient;
 gradient: ADDRESS;
): BOOLEAN;

<* EXTERNAL QGradient_OpGrad_NotEquals *>
PROCEDURE QGradient_OpGrad_NotEquals ( self: QGradient;
 other: ADDRESS;
): BOOLEAN;

<* EXTERNAL QGradient_Op_Grad_Equals1 *>
PROCEDURE QGradient_Op_Grad_Equals1 ( self: QGradient;
 gradient: ADDRESS;
): BOOLEAN;
...
PROCEDURE New_QLinearGradient2 (xStart, yStart, xFinalStop, yFinalStop: C.double;
): QLinearGradient;
...
PROCEDURE New_QRadialGradient3 ( center: ADDRESS;
radius: C.double;
): QRadialGradient;
