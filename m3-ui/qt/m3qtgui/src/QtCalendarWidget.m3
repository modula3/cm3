...
PROCEDURE QCalendarWidget_sizeHint ( self: QCalendarWidget;
): QSize =
VAR
...
PROCEDURE QCalendarWidget_selectedDate ( self: QCalendarWidget;
): QDate =
VAR
...
PROCEDURE QCalendarWidget_yearShown ( self: QCalendarWidget;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QCalendarWidget_monthShown ( self: QCalendarWidget;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QCalendarWidget_minimumDate ( self: QCalendarWidget;
): QDate =
VAR
ret:ADDRESS; result : QDate;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QCalendarWidget_setMinimumDate ( self: QCalendarWidget;
 date: QDate;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QCalendarWidget_maximumDate ( self: QCalendarWidget;
): QDate =
VAR
ret:ADDRESS; result : QDate;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QCalendarWidget_setMaximumDate ( self: QCalendarWidget;
 date: QDate;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QCalendarWidget_setFirstDayOfWeek ( self: QCalendarWidget;
dayOfWeek: DayOfWeek;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtCalendarWidgetRaw.QCalendarWidget_setFirstDayOfWeek(selfAdr, ORD(dayOfWeek));
...
PROCEDURE QCalendarWidget_setHeaderVisible ( self: QCalendarWidget;
show: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
RETURN QtCalendarWidgetRaw.QCalendarWidget_isNavigationBarVisible(selfAdr);
...
PROCEDURE QCalendarWidget_setSelectionMode ( self: QCalendarWidget;
mode: SelectionMode;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtCalendarWidgetRaw.QCalendarWidget_setSelectionMode(selfAdr, ORD(mode));
END QCalendarWidget_setSelectionMode;

PROCEDURE QCalendarWidget_horizontalHeaderFormat ( self: QCalendarWidget;
): HorizontalHeaderFormat =
VAR
ret:INTEGER; result : HorizontalHeaderFormat;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtCalendarWidgetRaw.QCalendarWidget_horizontalHeaderFormat(selfAdr);
result := VAL(ret,HorizontalHeaderFormat);  
RETURN result;
END QCalendarWidget_horizontalHeaderFormat;

PROCEDURE QCalendarWidget_setHorizontalHeaderFormat ( self: QCalendarWidget;
format: HorizontalHeaderFormat;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtCalendarWidgetRaw.QCalendarWidget_setHorizontalHeaderFormat(selfAdr, ORD(format));
END QCalendarWidget_setHorizontalHeaderFormat;

PROCEDURE QCalendarWidget_verticalHeaderFormat ( self: QCalendarWidget;
): VerticalHeaderFormat =
VAR
ret:INTEGER; result : VerticalHeaderFormat;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtCalendarWidgetRaw.QCalendarWidget_verticalHeaderFormat(selfAdr);
result := VAL(ret,VerticalHeaderFormat);  
RETURN result;
END QCalendarWidget_verticalHeaderFormat;

PROCEDURE QCalendarWidget_setVerticalHeaderFormat ( self: QCalendarWidget;
format: VerticalHeaderFormat;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtCalendarWidgetRaw.QCalendarWidget_setVerticalHeaderFormat(selfAdr, ORD(format));
END QCalendarWidget_setVerticalHeaderFormat;

PROCEDURE QCalendarWidget_setHeaderTextFormat ( self: QCalendarWidget;
...
BEGIN
QtCalendarWidgetRaw.QCalendarWidget_setHeaderTextFormat(selfAdr, arg2tmp);
END QCalendarWidget_setHeaderTextFormat;

PROCEDURE QCalendarWidget_setWeekdayTextFormat ( self: QCalendarWidget;
dayOfWeek: DayOfWeek;
 format: QTextCharFormat;
) =
VAR
...
BEGIN
QtCalendarWidgetRaw.QCalendarWidget_setWeekdayTextFormat(selfAdr, ORD(dayOfWeek), arg3tmp);
END QCalendarWidget_setWeekdayTextFormat;

PROCEDURE QCalendarWidget_setDateTextFormat ( self: QCalendarWidget;
 date: QDate;
 format: QTextCharFormat;
) =
VAR
...
arg3tmp :=  LOOPHOLE(format.cxxObj,ADDRESS);
BEGIN
QtCalendarWidgetRaw.QCalendarWidget_setDateTextFormat(selfAdr, arg2tmp, arg3tmp);
...
PROCEDURE QCalendarWidget_setDateEditEnabled ( self: QCalendarWidget;
enable: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
RETURN QtCalendarWidgetRaw.QCalendarWidget_dateEditAcceptDelay(selfAdr);
END QCalendarWidget_dateEditAcceptDelay;

PROCEDURE QCalendarWidget_setDateEditAcceptDelay ( self: QCalendarWidget;
delay: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtCalendarWidgetRaw.QCalendarWidget_setDateEditAcceptDelay(selfAdr, delay);
END QCalendarWidget_setDateEditAcceptDelay;

PROCEDURE QCalendarWidget_setSelectedDate ( self: QCalendarWidget;
 date: QDate;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QCalendarWidget_setDateRange ( self: QCalendarWidget;
 min, max: QDate;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
BEGIN
QtCalendarWidgetRaw.QCalendarWidget_setDateRange(selfAdr, arg2tmp, arg3tmp);
END QCalendarWidget_setDateRange;

PROCEDURE QCalendarWidget_setCurrentPage ( self: QCalendarWidget;
year, month: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtCalendarWidgetRaw.QCalendarWidget_setCurrentPage(selfAdr, year, month);
END QCalendarWidget_setCurrentPage;

PROCEDURE QCalendarWidget_setGridVisible ( self: QCalendarWidget;
show: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QCalendarWidget_setNavigationBarVisible ( self: QCalendarWidget;
visible: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtCalendarWidgetRaw.QCalendarWidget_setNavigationBarVisible(selfAdr, visible);
...
PROCEDURE Cleanup_QCalendarWidget(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
