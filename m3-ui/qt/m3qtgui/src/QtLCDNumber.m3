...
PROCEDURE New_QLCDNumber2 (self:QLCDNumber;numDigits: CARDINAL;
 parent: QWidget;
): QLCDNumber =
VAR
result : ADDRESS;
...
VAR
ret:INTEGER; result : SegmentStyle;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE Cleanup_QLCDNumber(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
QLCDNumber =
QLCDNumberPublic BRANDED OBJECT
OVERRIDES
