...
setOption(option: WizardOption;
on: BOOLEAN;
);
setOption1(option: WizardOption;
);
testOption(option: WizardOption;
): BOOLEAN;
setOptions(options: WizardOptions;
);
options(): WizardOptions;
setButtonText(which: WizardButton;
 text: TEXT;
);
buttonText(which: WizardButton;
): TEXT;
setButton(which: WizardButton;
 button: QAbstractButton;
);
button(which: WizardButton;
): QAbstractButton;
...
setPixmap(which: WizardPixmap;
 pixmap: QPixmap;
);
pixmap(which: WizardPixmap;
): QPixmap;
