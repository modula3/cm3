...
PROCEDURE New_QProgressDialog0 ( parent: ADDRESS;
flags: C.int;
): QProgressDialog;

<* EXTERNAL New_QProgressDialog1 *>
PROCEDURE New_QProgressDialog1 ( parent: ADDRESS;
): QProgressDialog;
...
PROCEDURE New_QProgressDialog5 ( labelText, cancelButtonText: ADDRESS;
minimum, maximum: C.int;
): QProgressDialog;
