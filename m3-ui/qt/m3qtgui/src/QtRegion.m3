...
PROCEDURE New_QRegion1 (self:QRegion;x, y, w, h: INTEGER;
t: RegionType;
): QRegion =
VAR
result : ADDRESS;
...
PROCEDURE New_QRegion2 (self:QRegion;x, y, w, h: INTEGER;
): QRegion =
VAR
result : ADDRESS;
BEGIN
...
PROCEDURE New_QRegion3 (self:QRegion; r: QRect;
t: RegionType;
): QRegion =
VAR
result : ADDRESS;
...
PROCEDURE New_QRegion4 (self:QRegion; r: QRect;
): QRegion =
VAR
result : ADDRESS;
arg1tmp :=  LOOPHOLE(r.cxxObj,ADDRESS);
...
PROCEDURE New_QRegion5 (self:QRegion; pa: QPolygon;
fillRule: FillRule;
): QRegion =
VAR
result : ADDRESS;
...
PROCEDURE New_QRegion6 (self:QRegion; pa: QPolygon;
): QRegion =
VAR
result : ADDRESS;
arg1tmp :=  LOOPHOLE(pa.cxxObj,ADDRESS);
...
PROCEDURE New_QRegion7 (self:QRegion; region: QRegion;
): QRegion =
VAR
result : ADDRESS;
...
PROCEDURE New_QRegion8 (self:QRegion; bitmap: REFANY;
): QRegion =
VAR
result : ADDRESS;
BEGIN
...
PROCEDURE QRegion_isEmpty ( self: QRegion;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QRegion_contains ( self: QRegion;
 p: QPoint;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QRegion_contains1 ( self: QRegion;
 r: QRect;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QRegion_translate ( self: QRegion;
dx, dy: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QRegion_translate1 ( self: QRegion;
 p: QPoint;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QRegion_translated ( self: QRegion;
dx, dy: INTEGER;
): QRegion =
VAR
...
PROCEDURE QRegion_translated1 ( self: QRegion;
 p: QPoint;
): QRegion =
VAR
ret:ADDRESS; result : QRegion;
...
PROCEDURE QRegion_unite ( self, r: QRegion;
): QRegion =
VAR
ret:ADDRESS; result : QRegion;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QRegion_unite1 ( self: QRegion;
 r: QRect;
): QRegion =
VAR
ret:ADDRESS; result : QRegion;
...
PROCEDURE QRegion_intersect ( self, r: QRegion;
): QRegion =
VAR
ret:ADDRESS; result : QRegion;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QRegion_intersect1 ( self: QRegion;
 r: QRect;
): QRegion =
VAR
ret:ADDRESS; result : QRegion;
...
PROCEDURE QRegion_subtract ( self, r: QRegion;
): QRegion =
VAR
ret:ADDRESS; result : QRegion;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QRegion_eor ( self, r: QRegion;
): QRegion =
VAR
ret:ADDRESS; result : QRegion;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QRegion_united ( self, r: QRegion;
): QRegion =
VAR
ret:ADDRESS; result : QRegion;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QRegion_united1 ( self: QRegion;
 r: QRect;
): QRegion =
VAR
ret:ADDRESS; result : QRegion;
...
PROCEDURE QRegion_intersected ( self, r: QRegion;
): QRegion =
VAR
ret:ADDRESS; result : QRegion;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QRegion_intersected1 ( self: QRegion;
 r: QRect;
): QRegion =
VAR
ret:ADDRESS; result : QRegion;
...
PROCEDURE QRegion_subtracted ( self, r: QRegion;
): QRegion =
VAR
ret:ADDRESS; result : QRegion;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QRegion_xored ( self, r: QRegion;
): QRegion =
VAR
ret:ADDRESS; result : QRegion;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QRegion_intersects ( self, r: QRegion;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
arg2tmp :=  LOOPHOLE(r.cxxObj,ADDRESS);
...
PROCEDURE QRegion_intersects1 ( self: QRegion;
 r: QRect;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QRegion_boundingRect ( self: QRegion;
): QRect =
VAR
...
PROCEDURE QRegion_setRects ( self: QRegion;
 rect: QRect;
num: INTEGER;
) =
VAR
...
PROCEDURE QRegion_rectCount ( self: QRegion;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE Cleanup_QRegion(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QRegion := ref;
BEGIN
  Delete_QRegion(obj);
 END Cleanup_QRegion;
