...
PROCEDURE New_QKeySequence2
  (self: QKeySequence; key: TEXT; format: SequenceFormat; ): QKeySequence =
  VAR
    result  : ADDRESS;
    qstr_key          := NEW(QString).initQString(key);
    arg1tmp           := LOOPHOLE(qstr_key.cxxObj, ADDRESS);
  BEGIN
    result := QtKeySequenceRaw.New_QKeySequence2(arg1tmp, ORD(format));
...
PROCEDURE New_QKeySequence3
  (self: QKeySequence; k1, k2, k3, k4: INTEGER; ): QKeySequence =
  VAR result: ADDRESS;
  BEGIN
    result := QtKeySequenceRaw.New_QKeySequence3(k1, k2, k3, k4);
...
PROCEDURE New_QKeySequence4 (self: QKeySequence; k1, k2, k3: INTEGER; ):
  QKeySequence =
  VAR result: ADDRESS;
  BEGIN
    result := QtKeySequenceRaw.New_QKeySequence4(k1, k2, k3);
...
PROCEDURE New_QKeySequence5 (self: QKeySequence; k1, k2: INTEGER; ):
  QKeySequence =
  VAR result: ADDRESS;
  BEGIN
    result := QtKeySequenceRaw.New_QKeySequence5(k1, k2);
...
PROCEDURE New_QKeySequence6 (self: QKeySequence; k1: INTEGER; ):
  QKeySequence =
  VAR result: ADDRESS;
  BEGIN
    result := QtKeySequenceRaw.New_QKeySequence6(k1);
...
PROCEDURE New_QKeySequence7 (self: QKeySequence; ks: QKeySequence; ):
  QKeySequence =
  VAR
    result : ADDRESS;
    arg1tmp          := LOOPHOLE(ks.cxxObj, ADDRESS);
  BEGIN
    result := QtKeySequenceRaw.New_QKeySequence7(arg1tmp);
...
PROCEDURE New_QKeySequence8 (self: QKeySequence; key: StandardKey; ):
  QKeySequence =
  VAR result: ADDRESS;
  BEGIN
    result := QtKeySequenceRaw.New_QKeySequence8(ORD(key));

    self.cxxObj := result;
    EVAL WeakRef.FromRef(self, Cleanup_QKeySequence);

    RETURN self;
  END New_QKeySequence8;
...
PROCEDURE QKeySequence_swap (self, other: QKeySequence; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(other.cxxObj, ADDRESS);
  BEGIN
    QtKeySequenceRaw.QKeySequence_swap(selfAdr, arg2tmp);
  END QKeySequence_swap;
