...
PROCEDURE New_QKeySequence2 (self:QKeySequence;k1, k2, k3, k4: INTEGER;
): QKeySequence =
VAR
result : ADDRESS;
BEGIN
...
PROCEDURE QKeySequence_matches ( self, seq: QKeySequence;
): SequenceMatch =
VAR
ret:INTEGER; result : SequenceMatch;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE Cleanup_QKeySequence(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
