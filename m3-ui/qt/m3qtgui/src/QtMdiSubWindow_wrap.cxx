...
SWIGEXPORT QMdiSubWindow * New_QMdiSubWindow0(QWidget * parent, Qt::WindowFlags flags) {
...
SWIGEXPORT long Modula3_QMdiSubWindowToQWidget(long objectRef) {
    long baseptr = 0;
    *(QWidget **)&baseptr = *(QMdiSubWindow **)&objectRef;
    return baseptr;
}
