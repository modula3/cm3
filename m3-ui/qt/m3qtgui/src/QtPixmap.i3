...
TYPE
  ...
  QPixmapPublic =
    ...
    METHODS
      init_0 (): QPixmap;
      init_1 (data: QPixmapData; ): QPixmap;
      init_2 (w, h: INTEGER; ): QPixmap;
      init_3 (arg1: QSize; ): QPixmap;
      init_4 (fileName, format: TEXT; flags: ImageConversionFlags; ):
              QPixmap;
      init_5          (fileName, format: TEXT; ): QPixmap;
      init_6          (fileName: TEXT; ): QPixmap;
      init_7          (arg1: QPixmap; ): QPixmap;
      isNull          (): BOOLEAN;
      ...
      fill1           ();
      fill2           (widget: REFANY; ofs: QPoint; );
      fill3           (widget: REFANY; xofs, yofs: INTEGER; );
      setMask         (arg1: REFANY; );
      ...
      scaled1 (w, h: INTEGER; aspectMode: AspectRatioMode; ): QPixmap;
      scaled2 (w, h: INTEGER; ): QPixmap;
      scaled3 (s         : QSize;
               aspectMode: AspectRatioMode;
               mode      : TransformationMode; ): QPixmap;
      scaled4         (s: QSize; aspectMode: AspectRatioMode; ): QPixmap;
      scaled5         (s: QSize; ): QPixmap;
      scaledToWidth   (w: INTEGER; mode: TransformationMode; ): QPixmap;
      scaledToWidth1  (w: INTEGER; ): QPixmap;
      scaledToHeight  (h: INTEGER; mode: TransformationMode; ): QPixmap;
      scaledToHeight1 (h: INTEGER; ): QPixmap;
      transformed     (arg1: QMatrix; mode: TransformationMode; ): QPixmap;
      transformed1    (arg1: QMatrix; ): QPixmap;
      transformed2 (arg1: QTransform; mode: TransformationMode; ): QPixmap;
      transformed3 (arg1: QTransform; ): QPixmap;
      toImage      (): QImage;
      load (fileName, format: TEXT; flags: ImageConversionFlags; ):
            BOOLEAN;
      ...
      loadFromData1 (buf: UNTRACED REF CHAR; len: CARDINAL; format: TEXT; ):
                     BOOLEAN;
      loadFromData2 (buf: UNTRACED REF CHAR; len: CARDINAL; ): BOOLEAN;
      loadFromData3 (data  : QByteArray;
                     format: TEXT;
                     flags : ImageConversionFlags; ): BOOLEAN;
      loadFromData4 (data: QByteArray; format: TEXT; ): BOOLEAN;
      loadFromData5 (data: QByteArray; ): BOOLEAN;
      ...
      copy  (x, y, width, height: INTEGER; ): QPixmap;
      copy1 (rect: QRect; ): QPixmap;
      copy2 (): QPixmap;
      scroll  (dx, dy, x, y, width, height: INTEGER; exposed: QRegion; );
      scroll1 (dx, dy, x, y, width, height: INTEGER; );
      scroll2 (dx, dy: INTEGER; rect: QRect; exposed: QRegion; );
      scroll3 (dx, dy: INTEGER; rect: QRect; );
