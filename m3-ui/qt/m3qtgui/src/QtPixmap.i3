...
TYPE
  ...
  QPixmapPublic =
    ...
    METHODS
      init_0 (): QPixmap;
      init_1 (w, h: INTEGER; ): QPixmap;
      init_2 (arg1: QSize; ): QPixmap;
      init_3 (fileName, format: TEXT; flags: ImageConversionFlags; ):
              QPixmap;
      init_4          (fileName, format: TEXT; ): QPixmap;
      init_5          (fileName: TEXT; ): QPixmap;
      init_6          (arg1: QPixmap; ): QPixmap;
      swap            (other: QPixmap; );
      isNull          (): BOOLEAN;
      ...
      loadFromData (buf   : ADDRESS;
                    len   : CARDINAL;
                    format: TEXT;
                    flags : ImageConversionFlags; ): BOOLEAN;
      loadFromData1 (buf: ADDRESS; len: CARDINAL; format: TEXT; ): BOOLEAN;
      loadFromData2 (buf: ADDRESS; len: CARDINAL; ): BOOLEAN;
      ...
      convertFromImage (img: QImage; flags: ImageConversionFlags; ):
                        BOOLEAN;
      convertFromImage1 (img: QImage; ): BOOLEAN;
