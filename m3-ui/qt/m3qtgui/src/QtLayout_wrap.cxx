...
SWIGEXPORT bool QLayout_setAlignment(QLayout * self, QWidget * w, int alignment) {
  QLayout *arg1 = (QLayout *) 0 ;
...
SWIGEXPORT bool QLayout_setAlignment1(QLayout * self, QLayout * l, int alignment) {
  QLayout *arg1 = (QLayout *) 0 ;
...
SWIGEXPORT void QLayout_setAlignment2_0(QLayout * self, int a) {
  QLayout *arg1 = (QLayout *) 0 ;
  Qt::Alignment arg2 ;
...
SWIGEXPORT int QLayout_expandingDirections(QLayout * self) {
  QLayout *arg1 = (QLayout *) 0 ;
  Qt::Orientations result;
  int cresult ;
  
  arg1 = *(QLayout **)&self; 
  result = ((QLayout const *)arg1)->expandingDirections();
  cresult = (int)result;
  return cresult;
}
