...
PROCEDURE New_QSpinBox0 (self:QSpinBox; parent: QWidget;
): QSpinBox =
VAR
result : ADDRESS;
...
PROCEDURE Cleanup_QSpinBox(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
PROCEDURE Cleanup_QDoubleSpinBox(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
QDoubleSpinBox =
QDoubleSpinBoxPublic BRANDED OBJECT
OVERRIDES
