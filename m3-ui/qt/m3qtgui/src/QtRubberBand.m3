...
PROCEDURE New_QRubberBand0 (self:QRubberBand;arg1: Shape;
 arg2: QWidget;
): QRubberBand =
VAR
result : ADDRESS;
...
PROCEDURE Cleanup_QRubberBand(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
QRubberBand =
QRubberBandPublic BRANDED OBJECT
OVERRIDES
