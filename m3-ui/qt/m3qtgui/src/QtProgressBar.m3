...
PROCEDURE QProgressBar_minimum ( self: QProgressBar;
): INTEGER =
VAR
...
PROCEDURE QProgressBar_maximum ( self: QProgressBar;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QProgressBar_value ( self: QProgressBar;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QProgressBar_text ( self: QProgressBar;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE QProgressBar_setTextVisible ( self: QProgressBar;
visible: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QProgressBar_isTextVisible ( self: QProgressBar;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QProgressBar_alignment ( self: QProgressBar;
): AlignmentFlag =
VAR
...
PROCEDURE QProgressBar_setAlignment ( self: QProgressBar;
...
PROCEDURE QProgressBar_sizeHint ( self: QProgressBar;
): QSize =
VAR
...
PROCEDURE QProgressBar_minimumSizeHint ( self: QProgressBar;
): QSize =
VAR
ret:ADDRESS; result : QSize;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QProgressBar_orientation ( self: QProgressBar;
): Orientation =
VAR
...
PROCEDURE QProgressBar_setInvertedAppearance ( self: QProgressBar;
invert: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QProgressBar_invertedAppearance ( self: QProgressBar;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QProgressBar_setTextDirection ( self: QProgressBar;
textDirection: Direction;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtProgressBarRaw.QProgressBar_setTextDirection(selfAdr, ORD(textDirection));
END QProgressBar_setTextDirection;

PROCEDURE QProgressBar_textDirection ( self: QProgressBar;
): Direction =
VAR
ret:INTEGER; result : Direction;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QProgressBar_setFormat ( self: QProgressBar;
 format: TEXT;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QProgressBar_format ( self: QProgressBar;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE QProgressBar_setRange ( self: QProgressBar;
...
PROCEDURE QProgressBar_setMinimum ( self: QProgressBar;
minimum: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QProgressBar_setMaximum ( self: QProgressBar;
maximum: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QProgressBar_setValue ( self: QProgressBar;
value: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QProgressBar_setOrientation ( self: QProgressBar;
arg2: Orientation;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE Cleanup_QProgressBar(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
