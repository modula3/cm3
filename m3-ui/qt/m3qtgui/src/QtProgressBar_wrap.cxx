...
SWIGEXPORT int QProgressBar_alignment(QProgressBar const * self) {
  QProgressBar *arg1 = (QProgressBar *) 0 ;
  Qt::Alignment result;
  int cresult ;
  
  arg1 = *(QProgressBar **)&self; 
  result = ((QProgressBar const *)arg1)->alignment();
  cresult = (int)result;
  return cresult;
}


SWIGEXPORT void QProgressBar_setAlignment(QProgressBar * self, int alignment) {
  QProgressBar *arg1 = (QProgressBar *) 0 ;
  Qt::Alignment arg2 ;
