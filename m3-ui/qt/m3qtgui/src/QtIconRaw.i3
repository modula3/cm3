...
<* EXTERNAL New_QIcon1 *>
PROCEDURE New_QIcon1 ( pixmap: ADDRESS;
): QIcon;

<* EXTERNAL New_QIcon2 *>
PROCEDURE New_QIcon2 ( other: ADDRESS;
): QIcon;

<* EXTERNAL New_QIcon3 *>
PROCEDURE New_QIcon3 ( fileName: ADDRESS;
): QIcon;

<* EXTERNAL New_QIcon4 *>
PROCEDURE New_QIcon4 ( engine: ADDRESS;
): QIcon;

<* EXTERNAL New_QIcon5 *>
PROCEDURE New_QIcon5 ( engine: ADDRESS;
): QIcon;
...
<* EXTERNAL FromTheme *>
PROCEDURE FromTheme ( name, fallback: ADDRESS;
): ADDRESS;

<* EXTERNAL FromTheme1 *>
PROCEDURE FromTheme1 ( name: ADDRESS;
): ADDRESS;

<* EXTERNAL HasThemeIcon *>
PROCEDURE HasThemeIcon ( name: ADDRESS;
): BOOLEAN;
