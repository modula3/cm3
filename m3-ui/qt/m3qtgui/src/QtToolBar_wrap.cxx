...
SWIGEXPORT void QToolBar_setAllowedAreas(QToolBar * self, int areas) {
  QToolBar *arg1 = (QToolBar *) 0 ;
...
SWIGEXPORT int QToolBar_allowedAreas(QToolBar const * self) {
  QToolBar *arg1 = (QToolBar *) 0 ;
  Qt::ToolBarAreas result;
  int cresult ;
  
  arg1 = *(QToolBar **)&self; 
  result = ((QToolBar const *)arg1)->allowedAreas();
  cresult = (int)result;
  return cresult;
}
