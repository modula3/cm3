...
PROCEDURE New_QMenuBar0 (self:QMenuBar; parent: QWidget;
): QMenuBar =
VAR
result : ADDRESS;
...
PROCEDURE QMenuBar_addAction0_0 ( self: QMenuBar;
 action: QAction;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenuBar_addAction1 ( self: QMenuBar;
 text: TEXT;
): QAction =
VAR
...
PROCEDURE QMenuBar_addAction2 ( self: QMenuBar;
 text: TEXT;
 receiver: QObject;
 member: TEXT;
): QAction =
...
ret := QtMenuBarRaw.QMenuBar_addAction2(selfAdr, arg2tmp, arg3tmp, arg4tmp);
...
PROCEDURE QMenuBar_addMenu ( self: QMenuBar;
 menu: QMenu;
): QAction =
VAR
ret:ADDRESS; result : QAction;
...
PROCEDURE QMenuBar_addMenu1 ( self: QMenuBar;
 title: TEXT;
): QMenu =
VAR
...
PROCEDURE QMenuBar_addMenu2 ( self: QMenuBar;
 icon: QIcon;
 title: TEXT;
): QMenu =
VAR
...
PROCEDURE QMenuBar_addSeparator ( self: QMenuBar;
): QAction =
VAR
ret:ADDRESS; result : QAction;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenuBar_insertSeparator ( self: QMenuBar;
 before: QAction;
): QAction =
VAR
ret:ADDRESS; result : QAction;
...
PROCEDURE QMenuBar_insertMenu ( self: QMenuBar;
 before: QAction;
 menu: QMenu;
): QAction =
VAR
...
PROCEDURE QMenuBar_activeAction ( self: QMenuBar;
): QAction =
VAR
ret:ADDRESS; result : QAction;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenuBar_setActiveAction ( self: QMenuBar;
 action: QAction;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenuBar_setDefaultUp ( self: QMenuBar;
arg2: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenuBar_isDefaultUp ( self: QMenuBar;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QMenuBar_sizeHint ( self: QMenuBar;
): QSize =
VAR
...
PROCEDURE QMenuBar_minimumSizeHint ( self: QMenuBar;
): QSize =
VAR
ret:ADDRESS; result : QSize;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenuBar_heightForWidth ( self: QMenuBar;
arg2: INTEGER;
): INTEGER =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenuBar_actionGeometry ( self: QMenuBar;
 arg2: QAction;
): QRect =
VAR
...
PROCEDURE QMenuBar_actionAt ( self: QMenuBar;
 arg2: QPoint;
): QAction =
VAR
ret:ADDRESS; result : QAction;
...
PROCEDURE QMenuBar_setCornerWidget ( self: QMenuBar;
 w: QWidget;
corner: Corner;
) =
VAR
...
PROCEDURE QMenuBar_setCornerWidget1 ( self: QMenuBar;
 w: QWidget;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenuBar_cornerWidget ( self: QMenuBar;
corner: Corner;
): QWidget =
VAR
...
PROCEDURE QMenuBar_cornerWidget1 ( self: QMenuBar;
): QWidget =
VAR
ret:ADDRESS; result : QWidget;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenuBar_isNativeMenuBar ( self: QMenuBar;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QMenuBar_setNativeMenuBar ( self: QMenuBar;
...
PROCEDURE QMenuBar_setVisible ( self: QMenuBar;
visible: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE Cleanup_QMenuBar(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
