...
PROCEDURE New_QBrush1 (self: QBrush; bs: BrushStyle; ): QBrush =
  VAR result: ADDRESS;
  BEGIN
...
PROCEDURE New_QBrush2 (self: QBrush; color: QColor; bs: BrushStyle; ):
  QBrush =
  VAR
    result : ADDRESS;
...
PROCEDURE New_QBrush3 (self: QBrush; color: QColor; ): QBrush =
  VAR
    result : ADDRESS;
    arg1tmp          := LOOPHOLE(color.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE New_QBrush4 (self: QBrush; color: GlobalColor; bs: BrushStyle; ):
  QBrush =
  VAR result: ADDRESS;
  BEGIN
...
PROCEDURE New_QBrush5 (self: QBrush; color: GlobalColor; ): QBrush =
  VAR result: ADDRESS;
  BEGIN
...
PROCEDURE New_QBrush6 (self: QBrush; color: QColor; pixmap: QPixmap; ):
  QBrush =
  VAR
    result : ADDRESS;
    arg1tmp          := LOOPHOLE(color.cxxObj, ADDRESS);
...
PROCEDURE New_QBrush7
  (self: QBrush; color: GlobalColor; pixmap: QPixmap; ): QBrush =
  VAR
    result : ADDRESS;
    arg2tmp          := LOOPHOLE(pixmap.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE New_QBrush8 (self: QBrush; pixmap: QPixmap; ): QBrush =
  VAR
    result : ADDRESS;
...
PROCEDURE New_QBrush9 (self: QBrush; image: QImage; ): QBrush =
  VAR
    result : ADDRESS;
...
PROCEDURE New_QBrush10 (self: QBrush; brush: QBrush; ): QBrush =
  VAR
    result : ADDRESS;
...
PROCEDURE New_QBrush11 (self: QBrush; gradient: QGradient; ): QBrush =
  VAR
    result : ADDRESS;
...
PROCEDURE QBrush_Op_Brush_Assign (self, brush: QBrush; ): QBrush =
  VAR
    ret    : ADDRESS;
    result : QBrush;
...
PROCEDURE QBrush_swap (self, other: QBrush; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(other.cxxObj, ADDRESS);
  BEGIN
    QtBrushRaw.QBrush_swap(selfAdr, arg2tmp);
  END QBrush_swap;

PROCEDURE QBrush_style (self: QBrush; ): BrushStyle =
  VAR
    ret    : INTEGER;
    result : BrushStyle;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QBrush_setStyle (self: QBrush; arg2: BrushStyle; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtBrushRaw.QBrush_setStyle(selfAdr, ORD(arg2));
  END QBrush_setStyle;

PROCEDURE QBrush_matrix (self: QBrush; ): QMatrix =
  VAR
    ret    : ADDRESS;
    result : QMatrix;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QBrush_setMatrix (self: QBrush; mat: QMatrix; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QBrush_transform (self: QBrush; ): QTransform =
  VAR
    ret    : ADDRESS;
    result : QTransform;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QBrush_setTransform (self: QBrush; arg2: QTransform; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QBrush_texture (self: QBrush; ): QPixmap =
  VAR
    ret    : ADDRESS;
    result : QPixmap;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QBrush_setTexture (self: QBrush; pixmap: QPixmap; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(pixmap.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QBrush_textureImage (self: QBrush; ): QImage =
  VAR
    ret    : ADDRESS;
    result : QImage;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QBrush_setTextureImage (self: QBrush; image: QImage; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QBrush_color (self: QBrush; ): QColor =
  VAR
    ret    : ADDRESS;
    result : QColor;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QBrush_setColor (self: QBrush; color: QColor; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QBrush_setColor1 (self: QBrush; color: GlobalColor; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtBrushRaw.QBrush_setColor1(selfAdr, ORD(color));
  END QBrush_setColor1;

PROCEDURE QBrush_gradient (self: QBrush; ): QGradient =
  VAR
    ret    : ADDRESS;
    result : QGradient;
    selfAdr: ADDRESS   := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QBrush_Op_Brush_Equals (self, b: QBrush; ): BOOLEAN =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QBrush_Op_Brush_NotEquals (self, b: QBrush; ): BOOLEAN =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(b.cxxObj, ADDRESS);
  BEGIN
...
REVEAL
  QBrush = QBrushPublic BRANDED OBJECT
           OVERRIDES
             init_0             := New_QBrush0;
             init_1             := New_QBrush1;
             init_2             := New_QBrush2;
...
PROCEDURE QGradient_type (self: QGradient; ): Type =
  VAR
    ret    : INTEGER;
    result : Type;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QGradient_setSpread (self: QGradient; spread: Spread; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtBrushRaw.QGradient_setSpread(selfAdr, ORD(spread));
  END QGradient_setSpread;

PROCEDURE QGradient_spread (self: QGradient; ): Spread =
  VAR
    ret    : INTEGER;
    result : Spread;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QGradient_setColorAt
  (self: QGradient; pos: LONGREAL; color: QColor; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QGradient_setStops (self: QGradient; stops: QGradientStops; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QGradient_stops (self: QGradient; ): QGradientStops =
  VAR
    ret    : ADDRESS;
    result : QGradientStops;
    selfAdr: ADDRESS        := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QGradient_coordinateMode (self: QGradient; ): CoordinateMode =
  VAR
    ret    : INTEGER;
    result : CoordinateMode;
    selfAdr: ADDRESS        := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QGradient_setCoordinateMode
  (self: QGradient; mode: CoordinateMode; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QGradient_setInterpolationMode
  (self: QGradient; mode: InterpolationMode; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtBrushRaw.QGradient_setInterpolationMode(selfAdr, ORD(mode));
  END QGradient_setInterpolationMode;

PROCEDURE QGradient_Op_Grad_Equals (self, gradient: QGradient; ): BOOLEAN =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QGradient_OpGrad_NotEquals (self, other: QGradient; ): BOOLEAN =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(other.cxxObj, ADDRESS);
  BEGIN
...
REVEAL
  QGradient = QGradientPublic BRANDED OBJECT
              OVERRIDES
...
PROCEDURE New_QLinearGradient1
  (self: QLinearGradient; start, finalStop: QPointF; ): QLinearGradient =
  VAR
    result : ADDRESS;
...
PROCEDURE New_QLinearGradient2
  (self: QLinearGradient; xStart, yStart, xFinalStop, yFinalStop: LONGREAL; ):
  QLinearGradient =
  VAR result: ADDRESS;
  BEGIN
    result := QtBrushRaw.New_QLinearGradient2(
                xStart, yStart, xFinalStop, yFinalStop);
...
PROCEDURE QLinearGradient_start (self: QLinearGradient; ): QPointF =
  VAR
    ret    : ADDRESS;
    result : QPointF;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QLinearGradient_setStart
  (self: QLinearGradient; start: QPointF; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QLinearGradient_setStart1
  (self: QLinearGradient; x, y: LONGREAL; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtBrushRaw.QLinearGradient_setStart1(selfAdr, x, y);
  END QLinearGradient_setStart1;

PROCEDURE QLinearGradient_finalStop (self: QLinearGradient; ): QPointF =
  VAR
    ret    : ADDRESS;
    result : QPointF;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QLinearGradient_setFinalStop
  (self: QLinearGradient; stop: QPointF; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE Cleanup_QLinearGradient
  (<* UNUSED *> READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
  QLinearGradient = QLinearGradientPublic BRANDED OBJECT
                    OVERRIDES
...
PROCEDURE New_QRadialGradient1 (self      : QRadialGradient;
                                center    : QPointF;
                                radius    : LONGREAL;
                                focalPoint: QPointF;         ):
  QRadialGradient =
...
PROCEDURE New_QRadialGradient2
  (self: QRadialGradient; cx, cy, radius, fx, fy: LONGREAL; ):
  QRadialGradient =
  VAR result: ADDRESS;
  BEGIN
...
PROCEDURE New_QRadialGradient3
  (self: QRadialGradient; center: QPointF; radius: LONGREAL; ):
  QRadialGradient =
  VAR
    result : ADDRESS;
    arg1tmp          := LOOPHOLE(center.cxxObj, ADDRESS);
...
PROCEDURE New_QRadialGradient4
  (self: QRadialGradient; cx, cy, radius: LONGREAL; ): QRadialGradient =
  VAR result: ADDRESS;
  BEGIN
...
PROCEDURE New_QRadialGradient5 (self        : QRadialGradient;
                                center      : QPointF;
  ...
  VAR
    ...
    arg3tmp          := LOOPHOLE(focalPoint.cxxObj, ADDRESS);
  BEGIN
    result := QtBrushRaw.New_QRadialGradient5(
                arg1tmp, centerRadius, arg3tmp, focalRadius);

    self.cxxObj := result;
    EVAL WeakRef.FromRef(self, Cleanup_QRadialGradient);

    RETURN self;
  END New_QRadialGradient5;

PROCEDURE New_QRadialGradient6
  (self                                     : QRadialGradient;
   cx, cy, centerRadius, fx, fy, focalRadius: LONGREAL;        ):
  QRadialGradient =
  VAR result: ADDRESS;
  BEGIN
    result := QtBrushRaw.New_QRadialGradient6(
                cx, cy, centerRadius, fx, fy, focalRadius);

    self.cxxObj := result;
    EVAL WeakRef.FromRef(self, Cleanup_QRadialGradient);

    RETURN self;
  END New_QRadialGradient6;

PROCEDURE QRadialGradient_center (self: QRadialGradient; ): QPointF =
  VAR
    ret    : ADDRESS;
    result : QPointF;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QRadialGradient_setCenter
  (self: QRadialGradient; center: QPointF; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QRadialGradient_setCenter1
  (self: QRadialGradient; x, y: LONGREAL; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtBrushRaw.QRadialGradient_setCenter1(selfAdr, x, y);
  END QRadialGradient_setCenter1;

PROCEDURE QRadialGradient_focalPoint (self: QRadialGradient; ): QPointF =
  VAR
    ret    : ADDRESS;
    result : QPointF;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QRadialGradient_setFocalPoint
  (self: QRadialGradient; focalPoint: QPointF; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QRadialGradient_radius (self: QRadialGradient; ): LONGREAL =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QRadialGradient_setRadius
  (self: QRadialGradient; radius: LONGREAL; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtBrushRaw.QRadialGradient_setRadius(selfAdr, radius);
  END QRadialGradient_setRadius;

PROCEDURE QRadialGradient_centerRadius (self: QRadialGradient; ):
  LONGREAL =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtBrushRaw.QRadialGradient_centerRadius(selfAdr);
  END QRadialGradient_centerRadius;

PROCEDURE QRadialGradient_setCenterRadius
  (self: QRadialGradient; radius: LONGREAL; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtBrushRaw.QRadialGradient_setCenterRadius(selfAdr, radius);
  END QRadialGradient_setCenterRadius;

PROCEDURE QRadialGradient_focalRadius (self: QRadialGradient; ): LONGREAL =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtBrushRaw.QRadialGradient_focalRadius(selfAdr);
  END QRadialGradient_focalRadius;

PROCEDURE QRadialGradient_setFocalRadius
  (self: QRadialGradient; radius: LONGREAL; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtBrushRaw.QRadialGradient_setFocalRadius(selfAdr, radius);
  END QRadialGradient_setFocalRadius;
...
PROCEDURE Cleanup_QRadialGradient
  (<* UNUSED *> READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
  QRadialGradient = QRadialGradientPublic BRANDED OBJECT
                    OVERRIDES
                      ...
                      init_5          := New_QRadialGradient5;
                      init_6          := New_QRadialGradient6;
                      ...
                      centerRadius    := QRadialGradient_centerRadius;
                      setCenterRadius := QRadialGradient_setCenterRadius;
                      focalRadius     := QRadialGradient_focalRadius;
                      setFocalRadius  := QRadialGradient_setFocalRadius;
                      destroyCxx      := Destroy_QRadialGradient;
                    END;

PROCEDURE New_QConicalGradient0 (self: QConicalGradient; ):
  QConicalGradient =
  VAR result: ADDRESS;
  BEGIN
...
PROCEDURE New_QConicalGradient1
  (self: QConicalGradient; center: QPointF; startAngle: LONGREAL; ):
  QConicalGradient =
  VAR
    result : ADDRESS;
    arg1tmp          := LOOPHOLE(center.cxxObj, ADDRESS);
...
PROCEDURE New_QConicalGradient2
  (self: QConicalGradient; cx, cy, startAngle: LONGREAL; ):
  QConicalGradient =
  VAR result: ADDRESS;
  BEGIN
...
PROCEDURE QConicalGradient_center (self: QConicalGradient; ): QPointF =
  VAR
    ret    : ADDRESS;
    result : QPointF;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QConicalGradient_setCenter
  (self: QConicalGradient; center: QPointF; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(center.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QConicalGradient_setCenter1
  (self: QConicalGradient; x, y: LONGREAL; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtBrushRaw.QConicalGradient_setCenter1(selfAdr, x, y);
  END QConicalGradient_setCenter1;

PROCEDURE QConicalGradient_angle (self: QConicalGradient; ): LONGREAL =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QConicalGradient_setAngle
  (self: QConicalGradient; angle: LONGREAL; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE Cleanup_QConicalGradient
  (<* UNUSED *> READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
  QConicalGradient = QConicalGradientPublic BRANDED OBJECT
                     OVERRIDES
