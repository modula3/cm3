...
PROCEDURE New_QMenu0 (self:QMenu; parent: QWidget;
): QMenu =
VAR
result : ADDRESS;
...
PROCEDURE New_QMenu2 (self:QMenu; title: TEXT;
 parent: QWidget;
): QMenu =
VAR
result : ADDRESS;
...
PROCEDURE New_QMenu3 (self:QMenu; title: TEXT;
): QMenu =
VAR
result : ADDRESS;
qstr_title := NEW(QString).initQString(title);
...
PROCEDURE QMenu_addAction0_0 ( self: QMenu;
 action: QAction;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenu_addAction1 ( self: QMenu;
 text: TEXT;
): QAction =
VAR
...
PROCEDURE QMenu_addAction2 ( self: QMenu;
 icon: QIcon;
 text: TEXT;
): QAction =
VAR
...
ret := QtMenuRaw.QMenu_addAction3(selfAdr, arg2tmp, arg3tmp, arg4tmp, arg5tmp);
...
PROCEDURE QMenu_addAction4 ( self: QMenu;
 text: TEXT;
 receiver: QObject;
 member: TEXT;
): QAction =
...
ret := QtMenuRaw.QMenu_addAction5(selfAdr, arg2tmp, arg3tmp, arg4tmp, arg5tmp, arg6tmp);
...
BEGIN
arg5tmp := M3toC.CopyTtoS(member);
ret := QtMenuRaw.QMenu_addAction6(selfAdr, arg2tmp, arg3tmp, arg4tmp, arg5tmp);
...
PROCEDURE QMenu_addMenu ( self, menu: QMenu;
): QAction =
VAR
ret:ADDRESS; result : QAction;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenu_addMenu1 ( self: QMenu;
 title: TEXT;
): QMenu =
VAR
...
PROCEDURE QMenu_addMenu2 ( self: QMenu;
 icon: QIcon;
 title: TEXT;
): QMenu =
VAR
...
PROCEDURE QMenu_addSeparator ( self: QMenu;
): QAction =
VAR
ret:ADDRESS; result : QAction;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenu_insertMenu ( self: QMenu;
 before: QAction;
 menu: QMenu;
): QAction =
VAR
...
PROCEDURE QMenu_insertSeparator ( self: QMenu;
 before: QAction;
): QAction =
VAR
ret:ADDRESS; result : QAction;
...
PROCEDURE QMenu_isEmpty ( self: QMenu;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QMenu_setTearOffEnabled ( self: QMenu;
arg2: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenu_isTearOffEnabled ( self: QMenu;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QMenu_isTearOffMenuVisible ( self: QMenu;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QMenu_setDefaultAction ( self: QMenu;
 arg2: QAction;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenu_defaultAction ( self: QMenu;
): QAction =
VAR
ret:ADDRESS; result : QAction;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenu_setActiveAction ( self: QMenu;
 act: QAction;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenu_activeAction ( self: QMenu;
): QAction =
VAR
ret:ADDRESS; result : QAction;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenu_popup ( self: QMenu;
 pos: QPoint;
 at: QAction;
) =
VAR
...
PROCEDURE QMenu_popup1 ( self: QMenu;
 pos: QPoint;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenu_sizeHint ( self: QMenu;
): QSize =
VAR
...
PROCEDURE QMenu_actionGeometry ( self: QMenu;
 arg2: QAction;
): QRect =
VAR
...
PROCEDURE QMenu_actionAt ( self: QMenu;
 arg2: QPoint;
): QAction =
VAR
ret:ADDRESS; result : QAction;
...
PROCEDURE QMenu_menuAction ( self: QMenu;
): QAction =
VAR
ret:ADDRESS; result : QAction;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenu_title ( self: QMenu;
): TEXT =
VAR
ret : ADDRESS;
qstr := NEW(QString);
...
PROCEDURE QMenu_setTitle ( self: QMenu;
 title: TEXT;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenu_icon ( self: QMenu;
): QIcon =
VAR
...
PROCEDURE QMenu_setIcon ( self: QMenu;
 icon: QIcon;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenu_setNoReplayFor ( self: QMenu;
 widget: QWidget;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE QMenu_separatorsCollapsible ( self: QMenu;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE QMenu_setSeparatorsCollapsible ( self: QMenu;
collapse: BOOLEAN;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
...
PROCEDURE Cleanup_QMenu(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QMenu := ref;
BEGIN
  Delete_QMenu(obj);
 END Cleanup_QMenu;
