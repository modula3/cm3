...
TYPE
  ...
  QStylePublic =
    ...
    METHODS
      polish    (arg1: REFANY (*QWidget*); ); (* virtual *)
      unpolish  (arg1: REFANY (*QWidget*); ); (* virtual *)
      polish1   (arg1: REFANY (* QApplication *); ); (* virtual *)
      unpolish1 (arg1: REFANY (* QApplication *); ); (* virtual *)
      polish2   (arg1: QPalette; ); (* virtual *)
      itemTextRect (fm     : QFontMetrics;
                    r      : QRect;
                    flags  : INTEGER;
                    enabled: BOOLEAN;
                    text   : TEXT;         ): QRect; (* virtual *)
      itemPixmapRect (r: QRect; flags: INTEGER; pixmap: QPixmap; ):
                      QRect;     (* virtual *)
      ...
      drawItemPixmap (painter  : QPainter;
                      rect     : QRect;
                      alignment: INTEGER;
                      pixmap   : QPixmap;  ); (* virtual *)
      standardPalette (): QPalette; (* virtual *)
      standardIcon (standardIcon: StandardPixmap;
                    option      : QStyleOption;
                    widget      : REFANY (*QWidget*); ): QIcon;
      standardIcon1 (standardIcon: StandardPixmap; option: QStyleOption; ):
                     QIcon;
      standardIcon2 (standardIcon: StandardPixmap; ): QIcon;
