...
PROCEDURE New_QImage1 ( size: ADDRESS;
format: C.int;
): QImage;

<* EXTERNAL New_QImage2 *>
PROCEDURE New_QImage2 (width, height, format: C.int;
): QImage;

<* EXTERNAL New_QImage3 *>
PROCEDURE New_QImage3 ( data: UNTRACED REF CHAR;
width, height, format: C.int;
): QImage;

<* EXTERNAL New_QImage4 *>
PROCEDURE New_QImage4 ( data: UNTRACED REF CHAR;
width, height, format: C.int;
): QImage;

<* EXTERNAL New_QImage5 *>
PROCEDURE New_QImage5 ( data: UNTRACED REF CHAR;
width, height, bytesPerLine, format: C.int;
): QImage;

<* EXTERNAL New_QImage6 *>
PROCEDURE New_QImage6 ( data: UNTRACED REF CHAR;
width, height, bytesPerLine, format: C.int;
): QImage;

<* EXTERNAL New_QImage7 *>
PROCEDURE New_QImage7 ( fileName: ADDRESS;
 format: C.char_star;
): QImage;

<* EXTERNAL New_QImage8 *>
PROCEDURE New_QImage8 ( fileName: ADDRESS;
): QImage;

<* EXTERNAL New_QImage9 *>
PROCEDURE New_QImage9 ( fileName, format: C.char_star;
): QImage;

<* EXTERNAL New_QImage10 *>
PROCEDURE New_QImage10 ( fileName: C.char_star;
): QImage;

<* EXTERNAL New_QImage11 *>
PROCEDURE New_QImage11 ( arg1: ADDRESS;
): QImage;
...
PROCEDURE QImage_setAlphaChannel ( self: QImage;
 alphaChannel: ADDRESS;
);
...
PROCEDURE Image_TrueMatrix ( arg1: ADDRESS;
w, h: C.int;
): ADDRESS;
...
PROCEDURE Image_TrueMatrix1 ( arg1: ADDRESS;
w, h: C.int;
): ADDRESS;
...
PROCEDURE Image_FromData2 ( data: ADDRESS;
 format: C.char_star;
): ADDRESS;

<* EXTERNAL Image_FromData3 *>
PROCEDURE Image_FromData3 ( data: ADDRESS;
): ADDRESS;
