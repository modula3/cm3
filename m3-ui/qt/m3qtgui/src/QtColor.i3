...
METHODS
init_0 () : QColor;
init_1 (color: GlobalColor;
) : QColor;
init_2 (r, g, b, a: INTEGER;
) : QColor;
init_3 (r, g, b: INTEGER;
) : QColor;
init_4 (rgb: QtRgb.T;
) : QColor;
init_5 ( name: TEXT;
...
darker1(): QColor;
Op_Assign( arg1: QColor;
): QColor;
Op_Assign1(color: GlobalColor;
): QColor;
Op_Equals( c: QColor;
): BOOLEAN;
Op_NotEquals( c: QColor;
): BOOLEAN;
destroyCxx();
END;
