...
BEGIN
ret := QtStyleRaw.QStyle_itemTextRect(selfAdr, arg2tmp, arg3tmp, flags, enabled, arg6tmp);
...
BEGIN
ret := QtStyleRaw.QStyle_itemPixmapRect(selfAdr, arg2tmp, flags, arg4tmp);
...
BEGIN
QtStyleRaw.QStyle_drawItemText(selfAdr, arg2tmp, arg3tmp, flags, arg5tmp, enabled, arg7tmp, ORD(textRole));
...
arg7tmp :=  LOOPHOLE(qstr_text.cxxObj,ADDRESS);
BEGIN
QtStyleRaw.QStyle_drawItemText1(selfAdr, arg2tmp, arg3tmp, flags, arg5tmp, enabled, arg7tmp);
...
BEGIN
QtStyleRaw.QStyle_drawItemPixmap(selfAdr, arg2tmp, arg3tmp, alignment, arg5tmp);
...
BEGIN
ret := QtStyleRaw.QStyle_standardIcon(selfAdr, ORD(standardIcon), arg3tmp, arg4tmp);
...
arg3tmp :=  LOOPHOLE(option.cxxObj,ADDRESS);
BEGIN
ret := QtStyleRaw.QStyle_standardIcon1(selfAdr, ORD(standardIcon), arg3tmp);
...
BEGIN
RETURN QtStyleRaw.SliderPositionFromValue(min, max, val, space, upsideDown);
...
BEGIN
RETURN QtStyleRaw.SliderValueFromPosition(min, max, pos, space, upsideDown);
...
BEGIN
ret := QtStyleRaw.AlignedRect(ORD(direction), ORD(alignment), arg3tmp, arg4tmp);
...
BEGIN
RETURN QtStyleRaw.QStyle_layoutSpacing(selfAdr, ORD(control1), ORD(control2), ORD(orientation), arg5tmp, arg6tmp);
...
arg5tmp :=  LOOPHOLE(option.cxxObj,ADDRESS);
BEGIN
RETURN QtStyleRaw.QStyle_layoutSpacing1(selfAdr, ORD(control1), ORD(control2), ORD(orientation), arg5tmp);
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
RETURN QtStyleRaw.QStyle_layoutSpacing2(selfAdr, ORD(control1), ORD(control2), ORD(orientation));
...
arg6tmp :=  LOOPHOLE(NARROW(widget,QWidget).cxxObj,ADDRESS);
BEGIN
RETURN QtStyleRaw.QStyle_combinedLayoutSpacing(selfAdr, ORD(controls1), ORD(controls2), ORD(orientation), arg5tmp, arg6tmp);
...
arg5tmp :=  LOOPHOLE(option.cxxObj,ADDRESS);
BEGIN
RETURN QtStyleRaw.QStyle_combinedLayoutSpacing1(selfAdr, ORD(controls1), ORD(controls2), ORD(orientation), arg5tmp);
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
RETURN QtStyleRaw.QStyle_combinedLayoutSpacing2(selfAdr, ORD(controls1), ORD(controls2), ORD(orientation));
...
PROCEDURE Cleanup_QStyle(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QStyle := ref;
BEGIN
  Delete_QStyle(obj);
 END Cleanup_QStyle;
