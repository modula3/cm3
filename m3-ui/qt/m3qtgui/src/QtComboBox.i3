...
findData( data: QVariant;
role: INTEGER;
flags: MatchFlags;
): INTEGER;
findData1( data: QVariant;
role: INTEGER;
): INTEGER;
findData2( data: QVariant;
): INTEGER;
...
itemData(index, role: INTEGER;
): QVariant;
itemData1(index: INTEGER;
): QVariant;
addItem( text: TEXT;
 userData: QVariant;
);
...
insertItem3(index: INTEGER;
 icon: QIcon;
 text: TEXT;
);
insertItems(index: INTEGER;
 texts: QStringList;
);
...
setItemData(index: INTEGER;
 value: QVariant;
role: INTEGER;
);
setItemData1(index: INTEGER;
 value: QVariant;
);
