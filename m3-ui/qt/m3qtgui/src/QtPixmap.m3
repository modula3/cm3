...
PROCEDURE New_QPixmap1 (self:QPixmap; data: QPixmapData;
): QPixmap =
VAR
result : ADDRESS;
...
PROCEDURE New_QPixmap2 (self:QPixmap;w, h: INTEGER;
): QPixmap =
VAR
result : ADDRESS;
BEGIN
...
PROCEDURE New_QPixmap3 (self:QPixmap; arg1: QSize;
): QPixmap =
VAR
result : ADDRESS;
...
PROCEDURE New_QPixmap4 (self:QPixmap; fileName, format: TEXT;
...
PROCEDURE New_QPixmap5 (self:QPixmap; fileName, format: TEXT;
): QPixmap =
VAR
result : ADDRESS;
qstr_fileName := NEW(QString).initQString(fileName);
...
PROCEDURE New_QPixmap6 (self:QPixmap; fileName: TEXT;
): QPixmap =
VAR
result : ADDRESS;
qstr_fileName := NEW(QString).initQString(fileName);
...
PROCEDURE New_QPixmap7 (self:QPixmap; arg1: QPixmap;
): QPixmap =
VAR
result : ADDRESS;
arg1tmp :=  LOOPHOLE(arg1.cxxObj,ADDRESS);
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtPixmapRaw.QPixmap_scaled(selfAdr, w, h, ORD(aspectMode), ORD(mode));
...
BEGIN
ret := QtPixmapRaw.QPixmap_scaled3(selfAdr, arg2tmp, ORD(aspectMode), ORD(mode));
...
result := QtPixmapRaw.QPixmap_load(selfAdr, arg2tmp, arg3tmp, ORD(flags));
...
result := QtPixmapRaw.QPixmap_loadFromData(selfAdr, arg2tmp, len, arg4tmp, ORD(flags));
...
BEGIN
arg4tmp := M3toC.CopyTtoS(format);
result := QtPixmapRaw.QPixmap_loadFromData1(selfAdr, arg2tmp, len, arg4tmp);
...
BEGIN
arg3tmp := M3toC.CopyTtoS(format);
result := QtPixmapRaw.QPixmap_loadFromData3(selfAdr, arg2tmp, arg3tmp, ORD(flags));
...
BEGIN
arg3tmp := M3toC.CopyTtoS(format);
result := QtPixmapRaw.QPixmap_save3(selfAdr, arg2tmp, arg3tmp, quality);
...
BEGIN
QtPixmapRaw.QPixmap_scroll(selfAdr, dx, dy, x, y, width, height, arg8tmp);
END QPixmap_scroll;
...
VAR
ret:ADDRESS; result : QPixmapData;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE Cleanup_QPixmap(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QPixmap := ref;
BEGIN
  Delete_QPixmap(obj);
 END Cleanup_QPixmap;
