...
SWIGEXPORT void QAbstractItemView_setEditTriggers(QAbstractItemView * self, int triggers) {
  QAbstractItemView *arg1 = (QAbstractItemView *) 0 ;
  EditTriggers arg2 ;
...
SWIGEXPORT int QAbstractItemView_editTriggers(QAbstractItemView const * self) {
  QAbstractItemView *arg1 = (QAbstractItemView *) 0 ;
  EditTriggers result;
  int cresult ;
  
  arg1 = *(QAbstractItemView **)&self; 
  result = ((QAbstractItemView const *)arg1)->editTriggers();
  cresult = (int)result;
  return cresult;
}
