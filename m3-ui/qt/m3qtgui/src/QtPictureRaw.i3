...
PROCEDURE New_QPicture0 (formatVersion: C.int;
): QPicture;
...
PROCEDURE New_QPicture2 ( arg1: ADDRESS;
): QPicture;
...
<* EXTERNAL PicFormat *>
PROCEDURE PicFormat ( fileName: ADDRESS;
): C.char_star;
...
PROCEDURE New_QPictureIO1 ( ioDevice: ADDRESS;
 format: C.char_star;
): QPictureIO;

<* EXTERNAL New_QPictureIO2 *>
PROCEDURE New_QPictureIO2 ( fileName: ADDRESS;
 format: C.char_star;
): QPictureIO;
...
PROCEDURE PictureFormat ( fileName: ADDRESS;
): ADDRESS;

<* EXTERNAL PictureFormat1 *>
PROCEDURE PictureFormat1 ( arg1: ADDRESS;
): ADDRESS;
