...
isFirstColumnSpanned(row: INTEGER;
 parent: QModelIndex;
): BOOLEAN;
...
isExpanded( index: QModelIndex;
): BOOLEAN;
setExpanded( index: QModelIndex;
expand: BOOLEAN;
);
...
indexAbove( index: QModelIndex;
): QModelIndex;
indexBelow( index: QModelIndex;
): QModelIndex;
...
dataChanged( topLeft, bottomRight: QModelIndex;
);  (*  virtual *)
selectAll();  (*  virtual *)
