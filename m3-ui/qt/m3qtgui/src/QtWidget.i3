...
mapToGlobal( arg1: QPoint;
): QPoint;
mapFromGlobal( arg1: QPoint;
): QPoint;
mapToParent( arg1: QPoint;
): QPoint;
mapFromParent( arg1: QPoint;
): QPoint;
mapTo( arg1: QWidget;
 arg2: QPoint;
): QPoint;
mapFrom( arg1: QWidget;
 arg2: QPoint;
): QPoint;
window(): QWidget;
...
grabKeyboard();
releaseKeyboard();
grabShortcut( key: QKeySequence;
context: ShortcutContext;
): INTEGER;
grabShortcut1( key: QKeySequence;
): INTEGER;
releaseShortcut(id: INTEGER;
);
setShortcutEnabled(id: INTEGER;
enable: BOOLEAN;
);
setShortcutEnabled1(id: INTEGER;
);
setShortcutAutoRepeat(id: INTEGER;
enable: BOOLEAN;
);
...
setParent1( parent: QWidget;
f: WindowTypes;
);
scroll(dx, dy: INTEGER;
);
scroll1(dx, dy: INTEGER;
 arg3: QRect;
);
focusWidget(): QWidget;
...
setAttribute(arg1: WidgetAttribute;
on: BOOLEAN;
);
setAttribute1(arg1: WidgetAttribute;
);
testAttribute(arg1: WidgetAttribute;
): BOOLEAN;
