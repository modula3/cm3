...
PROCEDURE New_QApplication0 (self:QApplication; argc: INTEGER;
...
END;
m3argv[m3argc] := NIL;
result := QtApplicationRaw.New_QApplication0(m3argc, ADR(m3argv[0]), arg3);
...
PROCEDURE New_QApplication1 (self:QApplication; argc: INTEGER;
READONLY argv: ARRAY OF TEXT;
): QApplication =
VAR
result : ADDRESS;
...
PROCEDURE New_QApplication2 (self:QApplication; argc: INTEGER;
READONLY argv: ARRAY OF TEXT;
GUIenabled: BOOLEAN;
arg4: INTEGER;
): QApplication =
...
END;
m3argv[m3argc] := NIL;
result := QtApplicationRaw.New_QApplication2(m3argc, ADR(m3argv[0]), GUIenabled, arg4);
...
PROCEDURE New_QApplication3 (self:QApplication; argc: INTEGER;
READONLY argv: ARRAY OF TEXT;
GUIenabled: BOOLEAN;
): QApplication =
VAR
...
END;
m3argv[m3argc] := NIL;
result := QtApplicationRaw.New_QApplication3(m3argc, ADR(m3argv[0]), GUIenabled);
...
PROCEDURE New_QApplication4 (self:QApplication; argc: INTEGER;
READONLY argv: ARRAY OF TEXT;
arg3: Type;
arg4: INTEGER;
): QApplication =
...
END;
m3argv[m3argc] := NIL;
result := QtApplicationRaw.New_QApplication4(m3argc, ADR(m3argv[0]), ORD(arg3), arg4);
...
PROCEDURE New_QApplication5 (self:QApplication; argc: INTEGER;
READONLY argv: ARRAY OF TEXT;
arg3: Type;
): QApplication =
VAR
...
END;
m3argv[m3argc] := NIL;
result := QtApplicationRaw.New_QApplication5(m3argc, ADR(m3argv[0]), ORD(arg3));
...
VAR
arg1tmp :=  LOOPHOLE(act.cxxObj,ADDRESS);
BEGIN
...
VAR
ret:INTEGER; result : KeyboardModifierFlags;
BEGIN
...
VAR
ret:INTEGER; result : MouseButtonFlags;
BEGIN
...
PROCEDURE Cleanup_QApplication(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
