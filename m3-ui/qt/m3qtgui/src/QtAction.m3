...
PROCEDURE New_QAction0 (self:QAction; parent: QObject;
): QAction =
VAR
result : ADDRESS;
...
PROCEDURE New_QAction1 (self:QAction; text: TEXT;
 parent: QObject;
): QAction =
VAR
result : ADDRESS;
...
PROCEDURE New_QAction2 (self:QAction; icon: QIcon;
 text: TEXT;
 parent: QObject;
): QAction =
VAR
...
VAR
ret:ADDRESS; result : QActionGroup;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
VAR
ret:INTEGER; result : ShortcutContext;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
VAR
ret:INTEGER; result : SoftKeyRole;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
...
PROCEDURE Cleanup_QAction(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
VAR obj : QAction := ref;
BEGIN
  Delete_QAction(obj);
 END Cleanup_QAction;
