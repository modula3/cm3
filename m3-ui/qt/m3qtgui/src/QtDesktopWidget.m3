...
BEGIN
RETURN QtDesktopWidgetRaw.QDesktopWidget_screenNumber(selfAdr, arg2tmp);
...
BEGIN
RETURN QtDesktopWidgetRaw.QDesktopWidget_screenNumber2(selfAdr, arg2tmp);
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtDesktopWidgetRaw.QDesktopWidget_screenGeometry(selfAdr, screen);
...
arg2tmp :=  LOOPHOLE(widget.cxxObj,ADDRESS);
BEGIN
ret := QtDesktopWidgetRaw.QDesktopWidget_screenGeometry2(selfAdr, arg2tmp);
...
BEGIN
ret := QtDesktopWidgetRaw.QDesktopWidget_screenGeometry3(selfAdr, arg2tmp);
...
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtDesktopWidgetRaw.QDesktopWidget_availableGeometry(selfAdr, screen);
...
arg2tmp :=  LOOPHOLE(widget.cxxObj,ADDRESS);
BEGIN
ret := QtDesktopWidgetRaw.QDesktopWidget_availableGeometry2(selfAdr, arg2tmp);
...
arg2tmp :=  LOOPHOLE(point.cxxObj,ADDRESS);
BEGIN
ret := QtDesktopWidgetRaw.QDesktopWidget_availableGeometry3(selfAdr, arg2tmp);
...
PROCEDURE Cleanup_QDesktopWidget(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
