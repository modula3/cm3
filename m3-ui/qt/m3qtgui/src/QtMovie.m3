...
PROCEDURE New_QMovie0 (self: QMovie; parent: QObject; ): QMovie =
  VAR
    result : ADDRESS;
...
PROCEDURE New_QMovie2
  (self: QMovie; device: QIODevice; format: QByteArray; parent: QObject; ):
  QMovie =
  VAR
    result : ADDRESS;
...
PROCEDURE New_QMovie3
  (self: QMovie; device: QIODevice; format: QByteArray; ): QMovie =
  VAR
    result : ADDRESS;
    arg1tmp          := LOOPHOLE(device.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(format.cxxObj, ADDRESS);
...
PROCEDURE New_QMovie4 (self: QMovie; device: QIODevice; ): QMovie =
  VAR
    result : ADDRESS;
    arg1tmp          := LOOPHOLE(device.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE New_QMovie5
  (self: QMovie; fileName: TEXT; format: QByteArray; parent: QObject; ):
  QMovie =
  VAR
    result       : ADDRESS;
...
PROCEDURE New_QMovie6 (self: QMovie; fileName: TEXT; format: QByteArray; ):
  QMovie =
  VAR
    result       : ADDRESS;
    qstr_fileName          := NEW(QString).initQString(fileName);
...
PROCEDURE New_QMovie7 (self: QMovie; fileName: TEXT; ): QMovie =
  VAR
    result       : ADDRESS;
    qstr_fileName          := NEW(QString).initQString(fileName);
    arg1tmp                := LOOPHOLE(qstr_fileName.cxxObj, ADDRESS);
...
PROCEDURE QMovie_setDevice (self: QMovie; device: QIODevice; ) =
  VAR
...
PROCEDURE QMovie_device (self: QMovie; ): QIODevice =
  VAR
    ret    : ADDRESS;
    result : QIODevice;
    selfAdr: ADDRESS   := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QMovie_setFileName (self: QMovie; fileName: TEXT; ) =
  VAR
    selfAdr      : ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    qstr_fileName          := NEW(QString).initQString(fileName);
...
PROCEDURE QMovie_fileName (self: QMovie; ): TEXT =
  VAR
    ret    : ADDRESS;
    qstr                := NEW(QString);
    ba     : QByteArray;
...
PROCEDURE QMovie_setFormat (self: QMovie; format: QByteArray; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
    arg2tmp          := LOOPHOLE(format.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QMovie_format (self: QMovie; ): QByteArray =
  VAR
    ret    : ADDRESS;
    result : QByteArray;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QMovie_setBackgroundColor (self: QMovie; color: QColor; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QMovie_state (self: QMovie; ): MovieState =
  VAR
    ret    : INTEGER;
    result : MovieState;
    selfAdr: ADDRESS    := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QMovie_frameRect (self: QMovie; ): QRect =
  VAR
    ret    : ADDRESS;
    result : QRect;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QMovie_currentImage (self: QMovie; ): QImage =
  VAR
    ret    : ADDRESS;
    result : QImage;
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QMovie_isValid (self: QMovie; ): BOOLEAN =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtMovieRaw.QMovie_isValid(selfAdr);
  END QMovie_isValid;

PROCEDURE QMovie_jumpToFrame (self: QMovie; frameNumber: INTEGER; ):
  BOOLEAN =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QMovie_setScaledSize (self: QMovie; size: QSize; ) =
  VAR
    selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QMovie_cacheMode (self: QMovie; ): CacheMode =
  VAR
    ret    : INTEGER;
    result : CacheMode;
    selfAdr: ADDRESS   := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QMovie_setCacheMode (self: QMovie; mode: CacheMode; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtMovieRaw.QMovie_setCacheMode(selfAdr, ORD(mode));
  END QMovie_setCacheMode;

PROCEDURE QMovie_cacheMode1 (self: QMovie; ): CacheMode =
  VAR
    ret    : INTEGER;
    result : CacheMode;
    selfAdr: ADDRESS   := LOOPHOLE(self.cxxObj, ADDRESS);
...
PROCEDURE QMovie_jumpToNextFrame (self: QMovie; ): BOOLEAN =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    RETURN QtMovieRaw.QMovie_jumpToNextFrame(selfAdr);
  END QMovie_jumpToNextFrame;

PROCEDURE QMovie_setPaused (self: QMovie; paused: BOOLEAN; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
...
PROCEDURE QMovie_setSpeed (self: QMovie; percentSpeed: INTEGER; ) =
  VAR selfAdr: ADDRESS := LOOPHOLE(self.cxxObj, ADDRESS);
  BEGIN
    QtMovieRaw.QMovie_setSpeed(selfAdr, percentSpeed);
  END QMovie_setSpeed;

PROCEDURE Cleanup_QMovie
...
REVEAL
  QMovie = QMoviePublic BRANDED OBJECT
           OVERRIDES
             init_0             := New_QMovie0;
             init_1             := New_QMovie1;
             init_2             := New_QMovie2;
