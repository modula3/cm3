...
PROCEDURE New_QInputDialog0 ( parent: ADDRESS;
flags: C.int;
): QInputDialog;

<* EXTERNAL New_QInputDialog1 *>
PROCEDURE New_QInputDialog1 ( parent: ADDRESS;
): QInputDialog;
...
<* EXTERNAL GetText2 *>
PROCEDURE GetText2 ( parent, title, label: ADDRESS;
echo: C.int;
 text: ADDRESS;
): ADDRESS;

<* EXTERNAL GetText3 *>
PROCEDURE GetText3 ( parent, title, label: ADDRESS;
echo: C.int;
): ADDRESS;

<* EXTERNAL GetText4 *>
PROCEDURE GetText4 ( parent, title, label: ADDRESS;
): ADDRESS;
...
<* EXTERNAL GetInt3 *>
PROCEDURE GetInt3 ( parent, title, label: ADDRESS;
value, minValue, maxValue: C.int;
): C.int;

<* EXTERNAL GetInt4 *>
PROCEDURE GetInt4 ( parent, title, label: ADDRESS;
value, minValue: C.int;
): C.int;

<* EXTERNAL GetInt5 *>
PROCEDURE GetInt5 ( parent, title, label: ADDRESS;
value: C.int;
): C.int;

<* EXTERNAL GetInt6 *>
PROCEDURE GetInt6 ( parent, title, label: ADDRESS;
): C.int;
...
<* EXTERNAL GetDouble3 *>
PROCEDURE GetDouble3 ( parent, title, label: ADDRESS;
value, minValue, maxValue: C.double;
): C.double;

<* EXTERNAL GetDouble4 *>
PROCEDURE GetDouble4 ( parent, title, label: ADDRESS;
value, minValue: C.double;
): C.double;

<* EXTERNAL GetDouble5 *>
PROCEDURE GetDouble5 ( parent, title, label: ADDRESS;
value: C.double;
): C.double;

<* EXTERNAL GetDouble6 *>
PROCEDURE GetDouble6 ( parent, title, label: ADDRESS;
): C.double;
...
<* EXTERNAL GetItem3 *>
PROCEDURE GetItem3 ( parent, title, label, items: ADDRESS;
current: C.int;
): ADDRESS;

<* EXTERNAL GetItem4 *>
PROCEDURE GetItem4 ( parent, title, label, items: ADDRESS;
): ADDRESS;
...
PROCEDURE GetInteger3 ( parent, title, label: ADDRESS;
value, minValue, maxValue: C.int;
): C.int;

<* EXTERNAL GetInteger4 *>
PROCEDURE GetInteger4 ( parent, title, label: ADDRESS;
value, minValue: C.int;
): C.int;

<* EXTERNAL GetInteger5 *>
PROCEDURE GetInteger5 ( parent, title, label: ADDRESS;
value: C.int;
): C.int;

<* EXTERNAL GetInteger6 *>
PROCEDURE GetInteger6 ( parent, title, label: ADDRESS;
): C.int;
