...
PROCEDURE QAbstractPrintDialog_addEnabledOption ( self: QAbstractPrintDialog;
option: PrintDialogOption;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtAbstractPrintDialogRaw.QAbstractPrintDialog_addEnabledOption(selfAdr, ORD(option));
END QAbstractPrintDialog_addEnabledOption;

PROCEDURE QAbstractPrintDialog_setEnabledOptions ( self: QAbstractPrintDialog;
options: PrintDialogOptions;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtAbstractPrintDialogRaw.QAbstractPrintDialog_setEnabledOptions(selfAdr, ORD(options));
END QAbstractPrintDialog_setEnabledOptions;

PROCEDURE QAbstractPrintDialog_enabledOptions ( self: QAbstractPrintDialog;
): PrintDialogOptions =
VAR
ret:INTEGER; result : PrintDialogOptions;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtAbstractPrintDialogRaw.QAbstractPrintDialog_enabledOptions(selfAdr);
result := VAL(ret,PrintDialogOptions);  
RETURN result;
END QAbstractPrintDialog_enabledOptions;

PROCEDURE QAbstractPrintDialog_isOptionEnabled ( self: QAbstractPrintDialog;
option: PrintDialogOption;
): BOOLEAN =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
RETURN QtAbstractPrintDialogRaw.QAbstractPrintDialog_isOptionEnabled(selfAdr, ORD(option));
END QAbstractPrintDialog_isOptionEnabled;

PROCEDURE QAbstractPrintDialog_setPrintRange ( self: QAbstractPrintDialog;
range: PrintRange;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtAbstractPrintDialogRaw.QAbstractPrintDialog_setPrintRange(selfAdr, ORD(range));
END QAbstractPrintDialog_setPrintRange;

PROCEDURE QAbstractPrintDialog_printRange ( self: QAbstractPrintDialog;
): PrintRange =
VAR
ret:INTEGER; result : PrintRange;
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
ret := QtAbstractPrintDialogRaw.QAbstractPrintDialog_printRange(selfAdr);
result := VAL(ret,PrintRange);  
RETURN result;
END QAbstractPrintDialog_printRange;

PROCEDURE QAbstractPrintDialog_setMinMax ( self: QAbstractPrintDialog;
min, max: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtAbstractPrintDialogRaw.QAbstractPrintDialog_setMinMax(selfAdr, min, max);
...
PROCEDURE QAbstractPrintDialog_setFromTo ( self: QAbstractPrintDialog;
fromPage, toPage: INTEGER;
) =
VAR
selfAdr: ADDRESS := LOOPHOLE(self.cxxObj,ADDRESS);
BEGIN
QtAbstractPrintDialogRaw.QAbstractPrintDialog_setFromTo(selfAdr, fromPage, toPage);
...
PROCEDURE Cleanup_QAbstractPrintDialog(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
