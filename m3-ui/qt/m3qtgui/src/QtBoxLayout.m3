...
PROCEDURE New_QBoxLayout0 (self:QBoxLayout;arg1: Direction;
 parent: QWidget;
): QBoxLayout =
VAR
result : ADDRESS;
...
BEGIN
QtBoxLayoutRaw.QBoxLayout_addWidget(selfAdr, arg2tmp, stretch, ORD(alignment));
...
BEGIN
QtBoxLayoutRaw.QBoxLayout_insertWidget(selfAdr, index, arg3tmp, stretch, ORD(alignment));
...
arg3tmp :=  LOOPHOLE(widget.cxxObj,ADDRESS);
BEGIN
QtBoxLayoutRaw.QBoxLayout_insertWidget1(selfAdr, index, arg3tmp, stretch);
...
BEGIN
QtBoxLayoutRaw.QBoxLayout_insertLayout(selfAdr, index, arg3tmp, stretch);
...
BEGIN
RETURN QtBoxLayoutRaw.QBoxLayout_setStretchFactor(selfAdr, arg2tmp, stretch);
...
BEGIN
RETURN QtBoxLayoutRaw.QBoxLayout_setStretchFactor1(selfAdr, arg2tmp, stretch);
...
PROCEDURE Cleanup_QBoxLayout(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
QBoxLayout =
QBoxLayoutPublic BRANDED OBJECT
OVERRIDES
...
PROCEDURE Cleanup_QHBoxLayout(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
QHBoxLayout =
QHBoxLayoutPublic BRANDED OBJECT
OVERRIDES
...
PROCEDURE Cleanup_QVBoxLayout(<*UNUSED*>READONLY self: WeakRef.T; ref: REFANY) =
...
REVEAL
QVBoxLayout =
QVBoxLayoutPublic BRANDED OBJECT
OVERRIDES
