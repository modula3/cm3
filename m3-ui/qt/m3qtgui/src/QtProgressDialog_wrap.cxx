...
SWIGEXPORT QProgressDialog * New_QProgressDialog0(QWidget * parent, int flags) {
...
SWIGEXPORT QProgressDialog * New_QProgressDialog3(QString * labelText, QString * cancelButtonText, int minimum, int maximum, QWidget * parent, int flags) {
  QString *arg1 = 0 ;
  QString *arg2 = 0 ;
  int arg3 ;
  int arg4 ;
