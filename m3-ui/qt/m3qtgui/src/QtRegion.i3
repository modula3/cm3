...
METHODS
init_0 () : QRegion;
init_1 (x, y, w, h: INTEGER;
t: RegionType;
) : QRegion;
init_2 (x, y, w, h: INTEGER;
) : QRegion;
init_3 ( r: QRect;
t: RegionType;
) : QRegion;
...
init_7 ( region: QRegion;
) : QRegion;
init_8 ( bitmap: REFANY;
) : QRegion;
isEmpty(): BOOLEAN;
contains( p: QPoint;
): BOOLEAN;
...
intersected( r: QRegion;
): QRegion;
intersected1( r: QRect;
): QRegion;
subtracted( r: QRegion;
): QRegion;
xored( r: QRegion;
): QRegion;
intersects( r: QRegion;
): BOOLEAN;
intersects1( r: QRect;
): BOOLEAN;
boundingRect(): QRect;
