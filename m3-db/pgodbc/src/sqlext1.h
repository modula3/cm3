...
RETCODE SQL_API	SQLDriverConnect (HDBC,HWND,UCHAR FAR*,SWORD,UCHAR FAR*,SWORD,
			SWORD FAR*,UWORD);

RETCODE SQL_API	SQLGetConnectOption(HDBC, UWORD, PTR );

RETCODE SQL_API	SQLGetData(HSTMT,UWORD,SWORD,PTR,SDWORD,SDWORD FAR*);

RETCODE SQL_API	SQLPutData( HSTMT,PTR,SDWORD);

RETCODE SQL_API	SQLParamData (HSTMT, PTR FAR*);


RETCODE SQL_API	SQLGetInfo(HDBC,UWORD,PTR,SWORD,SWORD FAR*);


RETCODE SQL_API SQLGetFunctions(HDBC,UWORD,UWORD FAR*);


RETCODE SQL_API	SQLSetStmtOption (HSTMT,UWORD,UDWORD);


RETCODE SQL_API	SQLGetStmtOption (HSTMT,UWORD,PTR);
...
/* Level 2 prototypes */
RETCODE SQL_API	SQLExtendedFetch ( HSTMT,UWORD,SDWORD,UDWORD FAR*,UWORD  FAR*);

RETCODE SQL_API	SQLMoreResults( HSTMT);


RETCODE SQL_API	SQLSetPos ( HSTMT, UWORD,UWORD,UWORD);

RETCODE SQL_API	SQLNumParams (HSTMT, SWORD FAR*);

RETCODE SQL_API	SQLBrowseConnect ( HDBC,HWND,UCHAR FAR*,SWORD,UCHAR FAR*,
			SWORD,SWORD FAR*);

RETCODE SQL_API	SQLNativeSql(HDBC,UCHAR  FAR*,SDWORD,UCHAR  FAR*,SDWORD,
			SDWORD FAR*);

RETCODE SQL_API	SQLDescribeParam (HSTMT,UWORD,SWORD  FAR*,UDWORD FAR*,
			SWORD  FAR*,SWORD  FAR*);

RETCODE SQL_API	SQLDataSources( HENV,UWORD,UCHAR  FAR*,SWORD,SWORD  FAR*,
			UCHAR  FAR*,SWORD,SWORD  FAR*);

RETCODE SQL_API	SQLDrivers(HENV,UWORD,UCHAR  FAR*,SWORD,SWORD  FAR*,UCHAR  FAR*,
                           SWORD,SWORD  FAR*);

RETCODE SQL_API	SQLBindParameter (HSTMT,UWORD,SWORD,SWORD,SWORD,
			UDWORD,SWORD,PTR,SDWORD,SDWORD FAR* );


RETCODE SQL_API SQLParamOptions(HSTMT,UDWORD,UDWORD FAR*);

RETCODE SQL_API	SQLSetScrollOptions( HSTMT,UWORD,SDWORD,UWORD);
