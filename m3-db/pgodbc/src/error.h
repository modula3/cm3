...
static  HERR    popsqlerr( HERR herr )
{
...
void    freesqlerrlist( HERR herrlist )
{
	HERR    list;
...
# define        PUSHSYSERR(list, msg)   \
			list = (HERR)_pushsqlerr( (HERR)(list), 0, (char*)msg ) 
# define        PUSHSQLERR(list, code)  \
			list = (HERR)pushsqlerr( (HERR)(list), (int)(code), NULL ) 
