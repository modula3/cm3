...
\midrule
{\tt SchemeStubs("Foo")}           & Generate stubs for {\tt Foo.i3} \\
{\tt Smodule("Foo")}               & {\tt Module} + {\tt SchemeStubs} \\
{\tt Sinterface("Foo")}            & {\tt Interface} + {\tt SchemeStubs} \\
...
\item \textbf{Phase~1} ({\tt make-standard-stuff}): For each {\tt
  SchemeStubs("Foo")} call, {\tt sstubgen} processes {\tt Foo.i3} and
  generates {\tt FooSchemeStubs.i3} and {\tt FooSchemeStubs.m3}.
