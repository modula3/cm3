...
\begin{itemize}
\item Full numeric tower: exact integers (fixnum/bignum), exact rationals,
  inexact reals ({\tt LONGREAL}), arbitrary-precision floats (MPFR),
  and complex numbers.
...
values, MPFR arbitrary-precision floats, and complex numbers are
all supported.  {\tt exact?} returns {\tt \#t} for integers and
...
MScheme's numeric tower includes exact integers, exact rationals,
inexact {\tt LONGREAL}, MPFR floats, and complex numbers.
