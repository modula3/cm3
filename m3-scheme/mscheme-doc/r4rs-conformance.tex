...
\item {\tt exact->inexact} --- converts exact integers and rationals
  to {\tt LONGREAL}.  {\tt inexact->exact} converts integer-valued
  floats to exact integers.
...
\midrule
{\tt rationalize} & Non-essential & Not yet implemented \\
\bottomrule
\end{tabular}
\end{center}
