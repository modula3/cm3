...
\texttt{quotient}, \texttt{remainder}) unwrap both operands via
\texttt{NARROW(x, SchemeLongReal.T)\^{}}, perform the arithmetic,
and wrap the result with \texttt{SchemeLongReal.FromLR()}.
