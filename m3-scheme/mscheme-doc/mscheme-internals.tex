...
\item \textbf{Numbers} use a single representation: \texttt{REF LONGREAL}.
  There is no exact/inexact distinction and no bignum support for
  arithmetic (though \texttt{BigInt.T} appears in the pickling code).
