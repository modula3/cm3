...
(test "floor neg" -4.0 (floor -3.2))
(test "ceiling" 4.0 (ceiling 3.2))
(test "ceiling neg" -3.0 (ceiling -3.7))
(test "round" 4.0 (round 3.5))
(test "round neg" -4.0 (round -3.5))
(test "truncate" 3.0 (truncate 3.9))
(test "truncate neg" -3.0 (truncate -3.9))
