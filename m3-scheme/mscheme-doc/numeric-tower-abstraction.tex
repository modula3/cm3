...
\begin{quote}
\textbf{Status:} This is a historical design document.
The abstractions described here have been implemented;
see the current source code for the definitive API.
\end{quote}
