...
LOGS=${LOGS:-/var/www/modula3.elegosoft.com/cm3/m3tests}
FNPAT1=${FNPAT1:-'m3tests-'}
...
<html>
  <head>
    <title>CM3 Compiler and Runtime Regression Tests</title>
  ...
  <body>
    <h2>CM3 Compiler and Runtime Regression Tests</h2>
