#!/bin/sh
# $Id: sysinfo.sh,v 1.59 2008-01-31 00:11:25 wagner Exp $
...
#
CM3VERSION=${CM3VERSION:-"d5.6.0"}
CM3VERSIONNUM=${CM3VERSIONNUM:-"050600"}
CM3LASTCHANGED=${CM3LASTCHANGED:-"2008-01-31"}
