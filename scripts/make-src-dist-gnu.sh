#!/bin/sh
# $Id: make-src-dist-gnu.sh,v 1.6.2.3 2009-08-29 01:11:03 jkrell Exp $
...
ARCHIVE="${STAGE}/cm3-src-gnu-${CM3VERSION}.tgz"
...
/bin/ls -1d m3overrides m3-sys/m3cc m3-sys/m3gdb >> .tar-include
