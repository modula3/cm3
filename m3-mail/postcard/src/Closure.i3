...
(* Last modified on Fri Apr 22 16:41:52 PDT 1994 by birrell   *)

INTERFACE Closure;

IMPORT Cursor, FormsVBT, Rd, Rsrc, TextPort, VBT;
...
TYPE T = OBJECT
  ...
  METHODS
    ...
    GetPSPrintFilter(): TEXT;
      ...
      (* LL < VBT.mu *)
    SetTextPortColors(fv: FormsVBT.T; name: TEXT);
      (* Set a named TextPort's color scheme for its text,
