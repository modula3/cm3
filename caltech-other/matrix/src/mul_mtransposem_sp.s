...
..B1.9:                         # Preds ..B1.8
        movl      40(%esp), %edi                                #
        movl      %eax, 12(%esp)                                #12.13
        movl      %ecx, 32(%esp)                                #12.13
        lea       (%ebx,%edi), %edi                             #
        movl      %edi, 36(%esp)                                #
        movl      %edi, 8(%esp)                                 #
        movl      %edi, %ecx                                    #12.13
        lea       (%edi,%edx,4), %edi                           #12.13
...
..B1.13:                        # Preds ..B1.13 ..B1.12
        movaps    %xmm0, (%edi,%edx,4)                          #12.13
        movaps    %xmm0, 16(%edi,%edx,4)                        #12.13
        addl      $8, %edx                                      #11.13
        cmpl      %esi, %edx                                    #11.13
...
..B1.17:                        # Preds ..B1.17 ..B1.16
        movl      %edx, (%ebx,%esi,4)                           #12.13
        addl      $1, %esi                                      #11.13
        cmpl      %ecx, %esi                                    #11.13
        jb        ..B1.17       # Prob 99%                      #11.13
                                # LOE eax edx ecx ebx ebp esi
..B1.19:                        # Preds ..B1.17 ..B1.15
        movl      16(%esp), %edx                                #10.10
        cmpl      %edx, %eax                                    #10.10
...
..B1.32:                        # Preds ..B1.31
        ...
        imull     20(%esp), %esi                                #
        addl      12(%esp), %esi                                #
        movss     (%esi,%edi,4), %xmm0                          #19.41
        movl      4(%esp), %edi                                 #19.41
        movl      56(%esp), %esi                                #19.41
                                # LOE eax edx ecx ebx ebp esi edi xmm0
..B1.33:                        # Preds ..B1.33 ..B1.32
        movss     (%esi,%edi,4), %xmm1                          #19.55
        mulss     %xmm0, %xmm1                                  #19.53
        addss     (%eax,%edi,4), %xmm1                          #19.16
        movss     %xmm1, (%eax,%edi,4)                          #19.16
        addl      $1, %edi                                      #18.16
        cmpl      %edx, %edi                                    #18.16
...
..B1.35:                        # Preds ..B1.34 ..B1.56
        ...
        lea       (%esi,%edx,4), %esi                           #18.16
        testl     $15, %esi                                     #18.16
        unpcklps  %xmm0, %xmm0                                  #19.41
        unpcklps  %xmm0, %xmm0                                  #19.41
...
..B1.37:                        # Preds ..B1.37 ..B1.36
        movups    (%edi,%edx,4), %xmm1                          #19.55
        movups    16(%edi,%edx,4), %xmm2                        #19.55
        mulps     %xmm0, %xmm1                                  #19.53
        mulps     %xmm0, %xmm2                                  #19.53
        addps     (%esi,%edx,4), %xmm1                          #19.16
        addps     16(%esi,%edx,4), %xmm2                        #19.16
        movaps    %xmm1, (%esi,%edx,4)                          #19.16
        movaps    %xmm2, 16(%esi,%edx,4)                        #19.16
        addl      $8, %edx                                      #18.16
        cmpl      %ecx, %edx                                    #18.16
...
..B1.40:                        # Preds ..B1.40 ..B1.39
        movaps    (%edi,%edx,4), %xmm1                          #19.55
        movaps    16(%edi,%edx,4), %xmm2                        #19.55
        mulps     %xmm0, %xmm1                                  #19.53
        mulps     %xmm0, %xmm2                                  #19.53
        addps     (%esi,%edx,4), %xmm1                          #19.16
        addps     16(%esi,%edx,4), %xmm2                        #19.16
...
..B1.44:                        # Preds ..B1.44 ..B1.43
        movss     (%esi,%ecx,4), %xmm1                          #19.55
        mulss     %xmm0, %xmm1                                  #19.53
        addss     (%edx,%ecx,4), %xmm1                          #19.16
        movss     %xmm1, (%edx,%ecx,4)                          #19.16
        addl      $1, %ecx                                      #18.16
        cmpl      %eax, %ecx                                    #18.16
