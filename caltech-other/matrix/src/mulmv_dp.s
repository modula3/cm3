...
..B1.10:                        # Preds ..B1.10 ..B1.9
        movsd     (%ecx,%edi,8), %xmm0                          #13.27
        mulsd     (%edx,%edi,8), %xmm0                          #13.33
        addl      $1, %edi                                      #12.13
        cmpl      %ebx, %edi                                    #12.13
        addsd     %xmm0, %xmm1                                  #13.13
...
..B1.14:                        # Preds ..B1.14 ..B1.13
        movsd     (%ecx,%ebx,8), %xmm2                          #13.27
        movhpd    8(%ecx,%ebx,8), %xmm2                         #13.27
        mulpd     (%edi,%ebx,8), %xmm2                          #13.33
        addpd     %xmm2, %xmm1                                  #13.13
        movsd     16(%ecx,%ebx,8), %xmm3                        #13.27
        movhpd    24(%ecx,%ebx,8), %xmm3                        #13.27
        mulpd     16(%edi,%ebx,8), %xmm3                        #13.33
        addpd     %xmm3, %xmm0                                  #13.13
        movsd     32(%ecx,%ebx,8), %xmm4                        #13.27
        movhpd    40(%ecx,%ebx,8), %xmm4                        #13.27
        mulpd     32(%edi,%ebx,8), %xmm4                        #13.33
        addpd     %xmm4, %xmm1                                  #13.13
        movsd     48(%ecx,%ebx,8), %xmm5                        #13.27
        movhpd    56(%ecx,%ebx,8), %xmm5                        #13.27
        mulpd     48(%edi,%ebx,8), %xmm5                        #13.33
        addpd     %xmm5, %xmm0                                  #13.13
        addl      $8, %ebx                                      #
        cmpl      %esi, %ebx                                    #12.13
...
..B1.17:                        # Preds ..B1.17 ..B1.16
        movaps    (%ecx,%ebx,8), %xmm2                          #13.27
        mulpd     (%edi,%ebx,8), %xmm2                          #13.33
        addpd     %xmm2, %xmm1                                  #13.13
        movaps    16(%ecx,%ebx,8), %xmm3                        #13.27
        mulpd     16(%edi,%ebx,8), %xmm3                        #13.33
        addpd     %xmm3, %xmm0                                  #13.13
        movaps    32(%ecx,%ebx,8), %xmm4                        #13.27
        mulpd     32(%edi,%ebx,8), %xmm4                        #13.33
        addpd     %xmm4, %xmm1                                  #13.13
        movaps    48(%ecx,%ebx,8), %xmm5                        #13.27
        mulpd     48(%edi,%ebx,8), %xmm5                        #13.33
        addpd     %xmm5, %xmm0                                  #13.13
        addl      $8, %ebx                                      #
        cmpl      %esi, %ebx                                    #12.13
...
..B1.19:                        # Preds ..B1.17 ..B1.14
        addpd     %xmm0, %xmm1                                  #13.13
        movaps    %xmm1, %xmm0                                  #13.13
        unpckhpd  %xmm1, %xmm0                                  #13.13
        addsd     %xmm0, %xmm1                                  #13.13
        movaps    %xmm1, %xmm0                                  #13.13
...
..B1.22:                        # Preds ..B1.22 ..B1.21
        movsd     (%ecx,%esi,8), %xmm0                          #13.27
        mulsd     (%ebx,%esi,8), %xmm0                          #13.33
        addl      $1, %esi                                      #12.13
        cmpl      %edx, %esi                                    #12.13
        addsd     %xmm0, %xmm1                                  #13.13
