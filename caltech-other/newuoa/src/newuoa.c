/* newuoa.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int newuoa_(integer *n, integer *npt, doublereal *x, 
	...
	maxfun, doublereal *w, doublereal *calfun, doublereal *f, integer *
	info, integer *itag)
{
...
/*     change:  FUNCTION CALFUN (N,X,ITAG) returns the value of the objective function. */
