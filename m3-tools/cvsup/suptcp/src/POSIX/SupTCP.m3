...
(* $Id: SupTCP.m3,v 1.1.1.1 2009-04-09 17:02:04 jkrell Exp $ *)
...
REVEAL
  T = TCPPosix.Public BRANDED "SupTCP.T" OBJECT
    ep: IP.Endpoint;
...
(* FIXME - Disabled for now, to prevent a compiler warning.
