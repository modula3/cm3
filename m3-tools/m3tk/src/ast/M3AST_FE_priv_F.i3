...
(*--------------------------------------------------------------------------
   ...
   fe_priv_    Private Front-end attribute

--------------------------------------------------------------------------*)

IMPORT M3AST_AS, M3AST_FE_priv; 
IMPORT M3AST_FE_F AS Previous_FE_View;
IMPORT M3ASTOp_SM AS Previous_View;

TYPE
  Compilation_Unit = Previous_FE_View.Compilation_Unit OBJECT
    fe_priv_errors: M3AST_FE_priv.Unit_errors := NIL;
  END;
