...
PROCEDURE Longint_type(<*UNUSED*> n: M3AST_AS_F.Longint_type): TEXT RAISES {}=
  BEGIN
    RETURN "Longint_type";
  END Longint_type;
...
PROCEDURE Longint_literal(<*UNUSED*> n: M3AST_AS_F.Longint_literal): TEXT RAISES {}=
  BEGIN
    RETURN "Longint_literal";
  END Longint_literal;
