...
PROCEDURE Longint_type(n: M3AST_AS_F.Longint_type): TEXT;
PROCEDURE WideChar_type(n: M3AST_AS_F.WideChar_type): TEXT;
...
PROCEDURE Longint_literal(n: M3AST_AS_F.Longint_literal): TEXT;
...
PROCEDURE WideText_literal(n: M3AST_AS_F.Text_literal): TEXT;
PROCEDURE Char_literal(n: M3AST_AS_F.Char_literal): TEXT;
PROCEDURE WideChar_literal(n: M3AST_AS_F.Char_literal): TEXT;
