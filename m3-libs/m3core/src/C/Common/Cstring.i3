...
<*EXTERNAL Cstring__strcpy *> PROCEDURE strcpy   (s1: char_star; s2: const_char_star): char_star;
<*EXTERNAL Cstring__strncpy*> PROCEDURE strncpy  (s1: char_star; s2: const_char_star; n: size_t): char_star;
<*EXTERNAL Cstring__strcat *> PROCEDURE strcat   (s1: char_star; s2: const_char_star): char_star;
