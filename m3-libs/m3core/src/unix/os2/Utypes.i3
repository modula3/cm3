...
(*#endif*)
  ...
  size_t       = u_int;
  time_t       = long;
  dev_t        = int;                 (* changed for OS2 - was u_short *)
  off_t        = long;
  paddr_t      = long;                (* sys V compatibility *)
  key_t        = long;                (* sys V compatibility *)
  clock_t      = long;                 (* POSIX compliance    *)
  mode_t       = int;                 (* changed for OS2 - was u_short *)
  nlink_t      = int;                 (* changed for OS2 - was u_short *)
  uid_t        = int;                 (* changed for OS2 - was u_short *)
  pid_t        = int;                 (* POSIX compliance    *)
  gid_t        = int;                 (* changed for OS2 - was u_short *)
