...
(* Last modified on Wed Mar  4 11:43:00 PST 1992 by muller                   *)
...
TYPE
  ...
  u_long_t  = unsigned_long;
  u_short_t = unsigned_short;
  ...
  mode_t       = u_long_t;            (* POSIX compliance    *)
  nlink_t      = short;               (* POSIX compliance    *)
  uid_t        = u_long_t;            (* POSIX compliance    *)
  pid_t        = int;                 (* POSIX compliance    *)
  gid_t        = u_long_t;            (* POSIX compliance    *)
  fstore_t     = long;
  siteno_t     = short;
