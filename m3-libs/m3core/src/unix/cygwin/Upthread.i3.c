...
"", 0,
"(* $Id: Upthread.i3.c,v 1.1 2008-01-30 17:36:44 jkrell Exp $ *)", 0,
"", 0,
"INTERFACE Upthread;", 0,
"", 0,
"FROM Ctypes IMPORT char, int, unsigned_int, void_star;", 0,
...
"", 0,
"CONST", 0,
"  PTHREAD_STACK_MIN = 16384;", 0,
"  PTHREAD_KEYS_MAX = 1024;", 0,
"", 0,
"(* <bits/pthreadtypes.h> *)", 0,
"", 0,
"CONST", 0,
"  SIZEOF_PTHREAD_ATTR_T        = 256;", 0,
"  SIZEOF_PTHREAD_MUTEX_T       = 256;", 0,
"  SIZEOF_PTHREAD_MUTEXATTR_T   = 256;", 0,
"  SIZEOF_PTHREAD_COND_T        = 256;", 0,
"  SIZEOF_PTHREAD_COND_COMPAT_T = 256;", 0,
"  SIZEOF_PTHREAD_CONDATTR_T    = 256;", 0,
"  SIZEOF_PTHREAD_RWLOCK_T      = 256;", 0,
"  SIZEOF_PTHREAD_RWLOCKATTR_T  = 256;", 0,
"  SIZEOF_PTHREAD_BARRIER_T     = 256;", 0,
"  SIZEOF_PTHREAD_BARRIERATTR_T = 256;", 0,
"", 0,
...
"    data: ARRAY[1..SIZEOF_PTHREAD_ATTR_T] OF char;", 0,
"  END;", 0,
"", 0,
...
"    data: ARRAY[1..SIZEOF_PTHREAD_MUTEX_T] OF char;", 0,
"  END;", 0,
"  pthread_mutexattr_t = RECORD", 0,
"    data: ARRAY[1..SIZEOF_PTHREAD_MUTEXATTR_T] OF char;", 0,
"  END;", 0,
"", 0,
...
"    data: ARRAY [1..SIZEOF_PTHREAD_COND_T] OF char;", 0,
"  END;", 0,
"  pthread_condattr_t = RECORD", 0,
"    data: ARRAY [1..SIZEOF_PTHREAD_CONDATTR_T] OF char;", 0,
"  END;", 0,
"", 0,
...
"    data: ARRAY [1..SIZEOF_PTHREAD_RWLOCK_T] OF char;", 0,
"  END;", 0,
"  pthread_rwlockattr_t = RECORD", 0,
"    data: ARRAY [1..SIZEOF_PTHREAD_RWLOCKATTR_T] OF char;", 0,
"  END;", 0,
"", 0,
"(* <bits/sched.h> *)", 0,
"TYPE", 0,
...
"    pthread_mutex_t { ARRAY [1..SIZEOF_PTHREAD_MUTEX_T] OF char {0, .. } };", 0,
"", 0,
"(* Read-write lock initializers.  *)", 0,
"CONST", 0,
"  PTHREAD_RWLOCK_INITIALIZER =", 0,
"    pthread_rwlock_t { ARRAY [1..SIZEOF_PTHREAD_RWLOCK_T] OF char {0, .. } };", 0,
"", 0,
"(* Conditional variable handling.  *)", 0,
"CONST", 0,
"  PTHREAD_COND_INITIALIZER =", 0,
"    pthread_cond_t { ARRAY [1..SIZEOF_PTHREAD_COND_T] OF char {0, .. } };", 0,
"", 0,
