...
(*                                                             *)
(* Last modified on Mon Oct 24 15:05:48 PDT 1994 by kalsow     *)
(*      modified on Tue Mar 24 20:42:39 PST 1992 by muller     *)

INTERFACE Ustat;

FROM Ctypes IMPORT short, int, long, char_star;
FROM Utypes IMPORT u_short, dev_t, ino_t, off_t, time_t, daddr_t;
...
TYPE
  ...
  struct_ustat = RECORD
                ...
                f_fpack:  ARRAY[0..5] OF CHAR; END;

  struct_ustat_star = UNTRACED REF struct_ustat;
...
<*EXTERNAL*> PROCEDURE ustat (dev: dev_t;  bug: struct_ustat_star): int;
