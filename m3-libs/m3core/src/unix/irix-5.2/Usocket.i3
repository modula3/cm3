...
(* Last modified on Mon Feb 13 09:19:54 PST 1995 by kalsow         *)
(*      modified on Tue Oct  4 18:12:11 PDT 1994 by ericv          *)
(*      modified on Sat Jun 27 15:26:07 PDT 1992 by muller         *)
 ...
 *)
  ...
  SO_ORDREL	 = 16_0200;		(* MIPS ABI - unimplemented *)
  SO_IMASOCKET	 = 16_0400;		(* use libsocket (not TLI) semantics *)
  SO_CHAMELEON	 = 16_1000;		(* (cipso) set label to 1st req rcvd *)
 ...
 *)
  ...
  SO_PROTOTYPE	 = 16_1009;		(* get protocol type (libsocket) *)
...
(* MIPS ABI VALUES - unimplemented *)
  PF_NIT	 = AF_NIT;		(* Network Interface Tap *)
  PF_802	 = AF_802;		(* IEEE 802.2, also ISO 8802 *)
  PF_OSI	 = AF_OSI;		(* umbrella for all families used *)
  PF_X25	 = AF_X25;		(* CCITT X.25 in particular *)
  PF_OSINET	 = AF_OSINET;	(* AFI = 47, IDI = 4 *)
  PF_GOSIP	 = AF_GOSIP;	(* U.S. Government OSI *)
