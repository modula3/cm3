...
(* Last modified on Tue Jul 10 00:27:25 1990 by muller@cs.ruu.nl *)
(*      modified on Wed Jun 27 12:56:14 1990 by piet@cs.ruu.nl *)


INTERFACE Umsg;

FROM Ctypes IMPORT char, unsigned_short, long, int;
...
(* I think they are for kernel use - so I deleted them -- PvO 
...
CONST
  ...
  (* Sizing constants *)
(* I cannot find these on HP-UX -- PvO
...
TYPE
  struct_msg = RECORD
      ...
      msg_ts:   unsigned_short;             (* message text size *)
      msg_spot: long;                       (* message text map address *)
    END;
