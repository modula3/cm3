...
(* Last modified on Wed Jun 27 15:59:26 1990 by piet@cs.ruu.nl *)
(*      modified on Sat Mar 17 06:58:25 1990 by muller        *)

INTERFACE Utypes;

FROM Ctypes IMPORT long, unsigned_long, int, unsigned_int, short;
FROM Ctypes IMPORT unsigned_short, unsigned_char;
