...
ULONG DosQuerySysInfo (ULONG ulStart, ULONG ulLast, PVOID pBuf,
    ULONG ulBufLength);
ULONG DosScanEnv (PCSZ pszName, PCSZ *pszValue);
...
ULONG RexxRegisterFunctionDll (PCSZ pszFuncName, PCSZ pszModuleName,
    PCSZ pszEntryPoint);
ULONG RexxRegisterFunctionExe (PCSZ pszFuncName, PFN pfnEntryPoint);
...
#define CAPS_ENHANCED_TEXT		0x4000
...
#define FDS_CUSTOM			0x0002
#define FDS_FILTERUNION			0x0004
#define FDS_HELPBUTTON			0x0008
#define FDS_APPLYBUTTON			0x0010
#define FDS_PRELOAD_VOLINFO		0x0020
#define FDS_MODELESS			0x0040
#define FDS_INCLUDE_EAS			0x0080
#define FDS_OPEN_DIALOG			0x0100
#define FDS_SAVEAS_DIALOG		0x0200
#define FDS_MULTIPLESEL			0x0400
#define FDS_ENABLEFILELB		0x0800
...
#define FNTS_CENTER			0x0001
#define FNTS_CUSTOM			0x0002
#define FNTS_OWNERDRAWPREVIEW		0x0004
#define FNTS_HELPBUTTON			0x0008
#define FNTS_APPLYBUTTON		0x0010
#define FNTS_RESETBUTTON		0x0020
#define FNTS_MODELESS			0x0040
#define FNTS_INITFROMFATTRS		0x0080
#define FNTS_BITMAPONLY			0x0100
#define FNTS_VECTORONLY			0x0200
#define FNTS_FIXEDWIDTHONLY		0x0400
#define FNTS_PROPORTIONALONLY		0x0800
#define FNTS_NOSYNTHESIZEDFONTS		0x1000
...
#define CRA_TARGET			0x0002
#define CRA_CURSORED			0x0004
#define CRA_INUSE			0x0008
#define CRA_FILTERED			0x0010
#define CRA_DROPONABLE			0x0020
#define CRA_RECORDREADONLY		0x0040
#define CRA_EXPANDED			0x0080
#define CRA_COLLAPSED			0x0100
#define CRA_SOURCE			0x4000
...
SPLERR SplCopyJob (PSZ pszSrcComputerName, PSZ pszSrcQueueName, ULONG ulSrcJob,
    PSZ pszTrgComputerName, PSZ pszTrgQueueName, PULONG pulTrgJob);
...
SPLERR SplEnumPort (PSZ pszComputerName, ULONG ulLevel, PVOID pBuf,
    ULONG cbBuf, PULONG pcReturned, PULONG pcTotal, PULONG pcbNeeded,
    PVOID pReserved);
...
SPLERR SplReleaseJob (PSZ pszComputerName, PSZ pszQueueName, ULONG ulJob);
