...
(*                                                            *)
(* Last modified on Mon Nov 21 12:09:18 PST 1994 by kalsow    *)
...
PROCEDURE Interrupt (sig: int;  code: int;  scp: SigInfo;  addr: ADDRESS) =
...
PROCEDURE Quit (<*UNUSED*> sig, code: int;
                           scp: SigInfo;
                <*UNUSED*> addr: ADDRESS) =
  VAR pc := 0;
  BEGIN
