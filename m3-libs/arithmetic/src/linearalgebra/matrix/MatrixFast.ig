...
CONST
  ...
  RowFromArray       = MB.RowFromArray;
  ColumnFromArray    = MB.ColumnFromArray;
  DiagonalFromArray  = MB.DiagonalFromArray;
  RowFromVector      = MB.RowFromVector;
  ColumnFromVector   = MB.ColumnFromVector;
  DiagonalFromVector = MB.DiagonalFromVector;
  FromMatrixArray    = MB.FromMatrixArray;
  FromScalar         = MB.FromScalar;
  Copy               = MB.Copy;
  NewZero            = MB.NewZero;
  NewOne             = MB.NewOne;
  Cyclic             = MB.Cyclic;
