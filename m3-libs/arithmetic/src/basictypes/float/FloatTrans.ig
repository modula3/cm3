...
<*INLINE*> PROCEDURE Log   (x: T): T; (*returns ln(x) *)
<*INLINE*> PROCEDURE Log10 (x: T): T; (*returns log10(x) *)
<*INLINE*> PROCEDURE Log1p (x: T): T; (*returns ln(1+x) *)
...
<*INLINE*> PROCEDURE ACos  (x: T): T; (*returns the arc cosine of x in radians. *)
<*INLINE*> PROCEDURE ASin  (x: T): T; (*returns the arc sine of x in radians. *) 
<*INLINE*> PROCEDURE ATan  (x: T): T; (*returns the arc tangent of x in radians. *)
<*INLINE*> PROCEDURE ATan2 (y, x: T): T; (*returns the arc tangent of y/x in radians. *)
...
<*INLINE*> PROCEDURE ACosH (x: T): T; (*returns the inverse hyperbolic cosine of x *)
<*INLINE*> PROCEDURE ASinH (x: T): T; (*returns the inverse hyperbolic sine of x *)
<*INLINE*> PROCEDURE ATanH (x: T): T; (*returns the inverse hyperbolic tangent of x *)
