...
(*choose k from n elements,
  each element at most once and
  the order is respected*)

PROCEDURE ArrangementsR (n, k : T) : T;
(*choose k from n elements,
  each element can be chosen multiple times and
  the order is respected,
  e.g. figures consisting of k digits to the base n*)

PROCEDURE Combinations  (n, k : T) : T;
(*choose k from n elements,
  each element at most once and
  the order is ignored,
  e.g. the number of subsets of size k of a set of size n,
  or a lottery where 6 numbers in a 7x7 field can be marked*)
