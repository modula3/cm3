...
PROCEDURE TypeDescMethodOffset  (d: TypeDesc): INTEGER; (* OBJ: vtable byte offset of own methods *)
PROCEDURE SetTypeDescMethodOffset(d: TypeDesc; mo: INTEGER); (* OBJ: set method offset *)
