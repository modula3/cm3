...
"$LLVM_CLANG" "$SCRIPT_DIR/smoke/llvm_link_test.c" "$SCRIPT_DIR/smoke/raise_stub.cpp" "$OBJ" /Users/hosking/cm3/lib/libm3core.a /Users/hosking/cm3/lib/libm3.a -lc++ -o "$TEST_BIN"
