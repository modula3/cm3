...
BEGIN
  EVAL defs.put("CM3_RELEASE", "5.1.4");       (* readable release version *)
  EVAL defs.put("CM3_VERSION", "050104");      (* version as number *)
  EVAL defs.put("CM3_CREATED", "2001-05-12");  (* date of last change *)
