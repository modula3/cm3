...
BEGIN
  EVAL defs.put("CM3_RELEASE", "5.2.0");       (* readable release version *)
  EVAL defs.put("CM3_VERSION", "050200");      (* version as number *)
  EVAL defs.put("CM3_CREATED", "2003-01-06");  (* date of last change *)
