...
BEGIN
  EVAL defs.put("CM3_RELEASE", "d5.2.8");      (* readable release version *)
  EVAL defs.put("CM3_VERSION", "050208");      (* version as number *)
  EVAL defs.put("CM3_CREATED", "2005-05-12");  (* date of last change *)
