...
BEGIN
  EVAL defs.put("CM3_RELEASE", "5.1.3");       (* readable release version *)
  EVAL defs.put("CM3_VERSION", "050103");      (* version as number *)
  EVAL defs.put("CM3_CREATED", "2001-03-24");  (* date of last change *)
