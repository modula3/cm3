...
BEGIN
  EVAL defs.put("CM3_RELEASE", "d5.3.0");      (* readable release version *)
  EVAL defs.put("CM3_VERSION", "050300");      (* version as number *)
  EVAL defs.put("CM3_CREATED", "2005-06-12");  (* date of last change *)
