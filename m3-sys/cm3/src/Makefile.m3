...
BEGIN
  EVAL defs.put("CM3_RELEASE", "5.1.6");       (* readable release version *)
  EVAL defs.put("CM3_VERSION", "050106");      (* version as number *)
  EVAL defs.put("CM3_CREATED", "2001-11-13");  (* date of last change *)
