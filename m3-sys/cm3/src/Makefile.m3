...
BEGIN
  EVAL defs.put("CM3_RELEASE", "5.1.5");       (* readable release version *)
  EVAL defs.put("CM3_VERSION", "050105");      (* version as number *)
  EVAL defs.put("CM3_CREATED", "2001-10-28");  (* date of last change *)
