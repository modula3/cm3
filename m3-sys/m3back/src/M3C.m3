...
PROCEDURE init_int(self: T; offset: ByteOffset; READONLY value: Target.Int; type: CGType) =
BEGIN
...
PROCEDURE Segments_init_int(self: Segments_t; offset: ByteOffset; READONLY value: Target.Int; type: CGType) =
BEGIN
