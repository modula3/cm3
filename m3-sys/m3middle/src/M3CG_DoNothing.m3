...
PROCEDURE declare_proctype (u: U; t: TypeUID; n_formals: INTEGER; result: TypeUID; n_raises: INTEGER; cc: CallingConvention) =
...
PROCEDURE declare_object (u: U; t, super: TypeUID; brand: TEXT; traced: BOOLEAN; n_fields, n_methods: INTEGER; field_size: BitSize) =
 BEGIN
 END declare_object;
...
PROCEDURE import_global (u: U; n: Name; s: ByteSize; a: Alignment; t: Type; m3t: TypeUID): Var =
BEGIN
  RETURN NewVar (u);
END import_global;
...
PROCEDURE bind_segment (u: U; seg: Var; s: ByteSize; a: Alignment; t: Type; exported, inited: BOOLEAN) =
BEGIN END bind_segment;

PROCEDURE declare_global (u: U; n: Name; s: ByteSize; a: Alignment; t: Type; m3t: TypeUID; exported, inited: BOOLEAN): Var =
BEGIN
  RETURN NewVar (u);
END declare_global;

PROCEDURE declare_constant (u: U; n: Name; s: ByteSize; a: Alignment; t: Type; m3t: TypeUID; exported, inited: BOOLEAN): Var =
BEGIN
  RETURN NewVar (u);
...
PROCEDURE free_temp (u: U; v: Var) = BEGIN END free_temp;

PROCEDURE begin_init (u: U; v: Var) = BEGIN END begin_init;
PROCEDURE end_init (u: U;  v: Var) = BEGIN END end_init;
PROCEDURE init_int (u: U; o: ByteOffset; READONLY value: Target.Int; t: Type) = BEGIN END init_int;
PROCEDURE init_proc (u: U;  o: ByteOffset;  value: Proc) = BEGIN END init_proc;
PROCEDURE init_label (u: U;  o: ByteOffset;  value: Label) = BEGIN END init_label;
...
PROCEDURE import_procedure (u: U; n: Name; n_params: INTEGER; ret_type: Type; cc: CallingConvention): Proc =
VAR p := NewProc (u);
BEGIN
  RETURN p;
END import_procedure;

PROCEDURE declare_procedure (u: U; n: Name; n_params: INTEGER; return_type: Type; lev: INTEGER; cc: CallingConvention; exported: BOOLEAN; parent: Proc): Proc =
VAR p := NewProc (u);
BEGIN
  RETURN p;
END declare_procedure;

PROCEDURE begin_procedure (u: U; p: Proc) = BEGIN END begin_procedure;
PROCEDURE end_procedure (u: U; p: Proc) = BEGIN END end_procedure;

PROCEDURE begin_block (u: U) = BEGIN END begin_block;

PROCEDURE end_block (u: U) = BEGIN END end_block;

PROCEDURE note_procedure_origin (u: U; p: Proc) = BEGIN END note_procedure_origin;

PROCEDURE set_label (u: U; l: Label; barrier: BOOLEAN) = BEGIN END set_label;

PROCEDURE jump (u: U; l: Label) = BEGIN END jump;
PROCEDURE if_true (u: U; t: IType; l: Label; f: Frequency) = BEGIN END if_true;
PROCEDURE if_false (u: U; t: IType; l: Label; f: Frequency) = BEGIN END if_false;

PROCEDURE if_compare (u: U; t: ZType; op: CompareOp; l: Label; f: Frequency) =
 BEGIN END if_compare;
...
PROCEDURE load_float(u: U; t: RType; READONLY f: Target.Float) = BEGIN END load_float;
