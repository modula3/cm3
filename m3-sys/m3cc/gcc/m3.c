...
void init_decl_processing ()
{
  ...
  layout_type (t_word64);
  layout_type (t_word32);
  layout_type (t_word16);
  layout_type (t_word8);
  ...
  TYPE_NAME (t_int8)   =  get_identifier ("int8");
  TYPE_NAME (t_int16)  =  get_identifier ("int16");
  TYPE_NAME (t_int32)  =  get_identifier ("int32");
  TYPE_NAME (t_int64)  =  get_identifier ("int64");
  TYPE_NAME (t_word8)  =  get_identifier ("word8");
  TYPE_NAME (t_word16) =  get_identifier ("word16");
  TYPE_NAME (t_word32) =  get_identifier ("word32");
  TYPE_NAME (t_word64) =  get_identifier ("word64");
