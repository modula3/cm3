...
(*
  ...
  formatter's input stream: *)
    ...
    putText (text: Text.T;  raw:= FALSE) RAISES {Wr.Failure};
    (*
    ...
    putChar (c: CHAR) RAISES {Wr.Failure};
    (*
    ...
    putMarkup (text: Text.T;  width := 0) RAISES {Wr.Failure};
    (*
...
(* 
  ...
  below). *)
    ...
    partialBreak (offset := 0;  freshLine := TRUE)  RAISES {Wr.Failure};
    (*
    ...
    newLine (offset := 0;  freshLine := TRUE) RAISES {Wr.Failure};
    (* 
    ...
    unitedBreak (offset := 0;  freshLine := TRUE) RAISES {Wr.Failure};
    (*
