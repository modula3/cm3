...
TYPE Opcode = {
  ...
  CleanupRet,           (* 61 terminator *)
  CatchRet,             (* 62 terminator *)
  CatchPad,             (* 63 *)
  CleanupPad,           (* 64 *)
  CatchSwitch,          (* 65 terminator *)

  (* Standard Unary Operators *)
  FNeg,                 (* 66 *)

  (* Added *)
  CallBr                (* 67 terminator *)
...
PROCEDURE LLVMContextSetOpaquePointers(C: ContextRef; OpaquePointers: Bool);
 ...
 * Get type attribute.
 *)
PROCEDURE LLVMCreateTypeAttribute(C : ContextRef; KindID : unsigned; typeRef : TypeRef) : AttributeRef;

(**
 * Get the type attribute's value.
 *)
PROCEDURE LLVMGetTypeAttributeValue(A : AttributeRef) : TypeRef;
...
PROCEDURE LLVMPointerTypeIsOpaque (Ty: TypeRef): BOOLEAN;
...
PROCEDURE LLVMPointerTypeInContext
  (C: ContextRef; AddressSpace: uint32_t): TypeRef;
 ...
 *
 *)
PROCEDURE LLVMGetAggregateElement(C : ValueRef; idx : unsigned) : ValueRef;
...
(* del me PROCEDURE LLVMConstFNeg(ConstantVal: ValueRef): ValueRef; *)
...
(* del me PROCEDURE LLVMConstFAdd(LHSConstant, RHSConstant: ValueRef): ValueRef; *)
...
(* del me PROCEDURE LLVMConstFSub(LHSConstant, RHSConstant: ValueRef): ValueRef; *)
...
(* del me PROCEDURE LLVMConstFMul(LHSConstant, RHSConstant: ValueRef): ValueRef;*)
(* del me
...
PROCEDURE LLVMAddAlias2 (M        : ModuleRef;
                     ValueTy  : TypeRef;
                     AddrSpace: uint32_t;
                     Aliasee  : ValueRef;
...
PROCEDURE LLVMGetNamedGlobalAlias (M: ModuleRef;
 Name: char_star; NameLen: uint32_t): ValueRef;
...
(* need to add this to core.cpp *)
(**
 * Get the function type ie signature for an intrinsic.
 *
 * @see llvm::Function::getFunctionType()
 *)
PROCEDURE LLVMGetFunctionType(Fn : ValueRef) : TypeRef;

(**
 * Obtain the ID number which matches the given function name.
 *
 * @see llvm::Function::getIntrinsicID()
 *)

PROCEDURE LLVMLookupIntrinsicID(Name : const_char_star; NameLen : unsigned): unsigned;
...
(* have to add the function in extras.c into Core.h/cpp
...
(* this works as we only pass pointer to 128 bit struct which C interprets
   as uint64_t[2] *)
PROCEDURE LLVMConstQuad(C : ContextRef; q : QuadRef) : ValueRef;
(* ^Binding was found in extras.c *)
 ...
 *
 *)
PROCEDURE LLVMGetGEPSourceElementType (GEP: ValueRef; ): TypeRef;
...
*)
PROCEDURE LLVMSetCurrentDebugLocation2(Builder: BuilderRef; L: MetadataRef);
(* del me
PROCEDURE LLVMGetCurrentDebugLocation(Builder: BuilderRef): ValueRef;
*)
PROCEDURE LLVMGetCurrentDebugLocation2(Builder: BuilderRef): MetadataRef;
(**
 ...
 *
 *)
PROCEDURE LLVMAddMetadataToInst (Builder: BuilderRef; Inst: ValueRef; );
...
PROCEDURE LLVMGetCastOpcode (Src         : ValueRef;
                         SrcIsSigned : BOOLEAN;
                         DestTy      : TypeRef;
                         DestIsSigned: BOOLEAN;  ): Opcode;
...
PROCEDURE LLVMBuildIsNotNull(
    B: BuilderRef; Val: ValueRef; Name: const_char_star): ValueRef;
PROCEDURE LLVMBuildPtrDiff2
  (arg1: BuilderRef; ElemTy: TypeRef; LHS, RHS: ValueRef; Name: const_char_star ):
  ValueRef;
  (* del me
