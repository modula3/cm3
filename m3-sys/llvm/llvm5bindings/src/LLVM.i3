...
(* Get the debug location info for this line and col *)
PROCEDURE DIBGetDebugLoc(line,col : unsigned;
                          scope : MetadataRef): MetadataRef;

(*
PROCEDURE DIBGetDebugLoc(line,col : unsigned;
                         scope : LLVMDIScope): ValueRef;
*)
(* ^Binding found in M3Extras.h and M3Extras.cpp. *) 
...
(* Set aomic on load and store *)
PROCEDURE LLVMSetAtomic(MemoryAccessInst : ValueRef;
