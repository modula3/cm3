...
define void @Main__F1(i64 %a.a) personality ptr @__gxx_personality_v0 !dbg !16 {
entry:
  %a.slot = alloca i64
  call void @llvm.dbg.declare(metadata ptr %a.slot, metadata !20, metadata !DIExpression()), !dbg !21
...
entry:
  call void @Main__F1(i64 291), !dbg !23
  call void @Main__F1(i64 123), !dbg !24
  call void @Main__F1(i64 1), !dbg !25
  ret void
}
...
!16 = distinct !DISubprogram(name: "Main__F1", linkageName: "Main__F1", scope: !4, file: !3, line: 8, type: !6, scopeLine: 8, unit: !2, spFlags: DISPFlagDefinition)
!18 = distinct !DISubprogram(name: "Main__F2", linkageName: "Main__F2", scope: !4, file: !3, line: 12, type: !6, scopeLine: 12, unit: !2, spFlags: DISPFlagDefinition)
!17 = !DILocation(line: 0, column: 0, scope: !16)
!19 = !DILocation(line: 0, column: 0, scope: !18)
!20 = !DILocalVariable(name: "a", scope: !16, file: !3, line: 8, type: !7)
!21 = !DILocation(line: 8, column: 0, scope: !16)
!22 = !DILocation(line: 9, column: 0, scope: !16)
!23 = !DILocation(line: 14, column: 0, scope: !18)
!24 = !DILocation(line: 15, column: 0, scope: !18)
!25 = !DILocation(line: 16, column: 0, scope: !18)
