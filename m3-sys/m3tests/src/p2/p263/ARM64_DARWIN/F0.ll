...
define i8 @F0__F1(ptr %a.t) personality ptr @__gxx_personality_v0 !dbg !16 {
entry:
  ...
  %t3 = getelementptr inbounds [1 x i8], ptr %t2, i64 0, i64 0
  %t4 = load i8, ptr %t3
  ret i8 %t4
}

define void @F0__F0_M3() personality ptr @__gxx_personality_v0 {
entry:
  ret void
}
...
define weak ptr @F0_I3(i64 %mode) {
entry:
  ret ptr @F0_M3_info
}

; RT0.ImportInfo chain for F0
@F0_M3_imp.0 = internal global { ptr, ptr, ptr } { ptr null, ptr @F0_I3, ptr null }

; RT0.ModuleInfo for F0 (13 fields, 104 bytes)
%RT0_ModuleInfo_t = type { ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, i64 }
@F0_M3_info = global %RT0_ModuleInfo_t {
  ptr null,  ; file (+0)
  ...
  ptr null,  ; var_map (+56)
  ptr null,  ; gc_map (+64)
  ptr @F0_M3_imp.0,  ; imports (+72)
  i64 0,  ; link_state (+80)
  ptr @F0_M3,  ; binder (+88)
  i64 3  ; gc_flags (+96)
}

define ptr @F0_M3(i64 %mode) personality ptr @__gxx_personality_v0 {
entry:
...
!16 = distinct !DISubprogram(name: "F0__F1", linkageName: "F0__F1", scope: !4, file: !3, line: 5, type: !6, scopeLine: 5, unit: !2, spFlags: DISPFlagDefinition)
!17 = !DILocation(line: 0, column: 0, scope: !16)
!18 = !DILocalVariable(name: "_result", scope: !16, file: !3, line: 5, type: !7)
!19 = !DILocalVariable(name: "t", scope: !16, file: !3, line: 5, type: !15)
!20 = !DILocation(line: 5, column: 0, scope: !16)
!21 = !DILocation(line: 7, column: 0, scope: !16)
!3 = !DIFile(filename: "F0.m3", directory: "..")
!4 = !DINamespace(name: "F0", scope: !2)
!5 = !{null}
