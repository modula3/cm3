...
define i8 @F4094__F1(ptr %a.t) personality ptr @__gxx_personality_v0 !dbg !16 {
entry:
  ...
  %t3 = getelementptr inbounds [4095 x i8], ptr %t2, i64 0, i64 0
  %t4 = load i8, ptr %t3
  ret i8 %t4
}

define void @F4094__F4094_M3() personality ptr @__gxx_personality_v0 {
entry:
  ret void
}
...
define weak ptr @F4094_I3(i64 %mode) {
entry:
  ret ptr @F4094_M3_info
}

; RT0.ImportInfo chain for F4094
declare ptr @F0_I3(i64)
@F4094_M3_imp.0 = internal global { ptr, ptr, ptr } { ptr null, ptr @F4094_I3, ptr @F4094_M3_imp.1 }
@F4094_M3_imp.1 = internal global { ptr, ptr, ptr } { ptr null, ptr @F0_I3, ptr null }

; RT0.ModuleInfo for F4094 (13 fields, 104 bytes)
%RT0_ModuleInfo_t = type { ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, i64 }
@F4094_M3_info = global %RT0_ModuleInfo_t {
  ptr null,  ; file (+0)
  ptr @tc_ref_1608408759,  ; type_cells (+8)
  ...
  ptr null,  ; var_map (+56)
  ptr null,  ; gc_map (+64)
  ptr @F4094_M3_imp.0,  ; imports (+72)
  i64 0,  ; link_state (+80)
  ptr @F4094_M3,  ; binder (+88)
  i64 3  ; gc_flags (+96)
}

define ptr @F4094_M3(i64 %mode) personality ptr @__gxx_personality_v0 {
entry:
  %do_body = icmp ne i64 %mode, 0
  br i1 %do_body, label %run, label %done
run:
  call void @F4094__F4094_M3()
  br label %done
done:
  ret ptr @F4094_M3_info
}
...
!16 = distinct !DISubprogram(name: "F4094__F1", linkageName: "F4094__F1", scope: !4, file: !3, line: 6, type: !6, scopeLine: 6, unit: !2, spFlags: DISPFlagDefinition)
...
!3 = !DIFile(filename: "F4094.m3", directory: "..")
!4 = !DINamespace(name: "F4094", scope: !2)
!5 = !{null}
