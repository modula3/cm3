...
define void @I6__I6_I3() personality ptr @__gxx_personality_v0 {
entry:
  ret void
}

define ptr @I6_I3(i64 %mode) {
entry:
...
; RT0.ImportInfo chain for I6
declare ptr @Main_M3(i64)
@I6_M3_imp.0 = internal global { ptr, ptr, ptr } { ptr null, ptr @Main_M3, ptr null }

; RT0.ModuleInfo for I6 (13 fields, 104 bytes)
%RT0_ModuleInfo_t = type { ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, i64 }
@I6_M3_info = internal global %RT0_ModuleInfo_t {
  ptr null,  ; file (+0)
