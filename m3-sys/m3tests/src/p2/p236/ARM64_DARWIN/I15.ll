...
define void @I15__I15_I3() personality ptr @__gxx_personality_v0 {
entry:
  ret void
}

define ptr @I15_I3(i64 %mode) {
entry:
  %do_body = icmp ne i64 %mode, 0
  br i1 %do_body, label %run, label %done
run:
  call void @I15__I15_I3()
  br label %done
done:
  ret ptr @I15_M3_info
}

; RT0.ImportInfo chain for I15
declare ptr @Main_M3(i64)
@I15_M3_imp.0 = internal global { ptr, ptr, ptr } { ptr null, ptr @Main_M3, ptr null }

; RT0.ModuleInfo for I15 (13 fields, 104 bytes)
%RT0_ModuleInfo_t = type { ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, i64 }
@I15_M3_info = internal global %RT0_ModuleInfo_t {
  ptr null,  ; file (+0)
  ...
  ptr null,  ; var_map (+56)
  ptr null,  ; gc_map (+64)
  ptr @I15_M3_imp.0,  ; imports (+72)
  i64 0,  ; link_state (+80)
  ptr @I15_I3,  ; binder (+88)
  i64 3  ; gc_flags (+96)
}
