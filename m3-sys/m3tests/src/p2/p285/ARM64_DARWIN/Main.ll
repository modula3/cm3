...
define void @Main__F2(ptr %_result_ptr) personality ptr @__gxx_personality_v0 !dbg !16 {
entry:
  %t1 = alloca [1 x i64]
  %t2 = getelementptr inbounds [1 x i64], ptr %t1, i64 0, i64 0
  store i64 123, ptr %t2
  %t3 = load [1 x i64], ptr %t1
  store [1 x i64] %t3, ptr %_result_ptr
  ret void
}

define void @Main__F1(ptr %_result_ptr) personality ptr @__gxx_personality_v0 !dbg !18 {
entry:
  %t3 = alloca [1 x i64]
  %t1 = alloca [1 x [1 x i64]]
  %t2 = getelementptr inbounds [1 x [1 x i64]], ptr %t1, i64 0, i64 0
  call void @Main__F2(ptr %t3), !dbg !30
  %t4 = call ptr @memcpy(ptr %t2, ptr %t3, i64 8), !dbg !30
  %t5 = load [1 x [1 x i64]], ptr %t1
  store [1 x [1 x i64]] %t5, ptr %_result_ptr
  ret void
}
...
entry:
  %t1 = alloca [1 x [1 x i64]]
  call void @Main__F1(ptr %t1)
  %t2 = getelementptr inbounds [1 x [1 x i64]], ptr %t1, i64 0, i64 0
  %t3 = getelementptr inbounds [1 x i64], ptr %t2, i64 0, i64 0
  %t4 = load i64, ptr %t3
  call void @RTIO__PutInt(i64 %t4, i64 5)
...
!16 = distinct !DISubprogram(name: "Main__F2", linkageName: "Main__F2", scope: !4, file: !3, line: 11, type: !6, scopeLine: 11, unit: !2, spFlags: DISPFlagDefinition)
!18 = distinct !DISubprogram(name: "Main__F1", linkageName: "Main__F1", scope: !4, file: !3, line: 16, type: !6, scopeLine: 16, unit: !2, spFlags: DISPFlagDefinition)
...
!23 = !DICompositeType(tag: DW_TAG_array_type, baseType: !7, size: 64, elements: !24)
!24 = !{!25}
!25 = !DISubrange(count: 1)
!26 = !DICompositeType(tag: DW_TAG_array_type, baseType: !23, size: 64, elements: !27)
!27 = !{!28}
!28 = !DISubrange(count: 1)
!29 = !DILocation(line: 13, column: 0, scope: !16)
