...
(* Last modified on Tue Jul 13 12:00:22 PDT 1993 by kalsow                   *)
(*      modified on Mon Feb 24 10:48:11 PST 1992 by muller                   *)
...
PROCEDURE TestFloatMode() <* NOWARN *> =
  ...
  BEGIN
    ...
    xNear := SetRndMode(RoundingMode.NearestElseAwayFromZero, -twentyOne, ten);
