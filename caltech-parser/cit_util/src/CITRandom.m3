...
PROCEDURE Seed(t:T) : INTEGER = BEGIN RETURN t.mySeed END Seed;
...
PROCEDURE Init (t: T;  fixed: BOOLEAN; seed : INTEGER): T =
  BEGIN
    ...
    <* ASSERT Normalize(t.mySeed) = t.mySeed *>
...
PROCEDURE Normalize(seed : INTEGER) : INTEGER =
  VAR
    j := seed;
  BEGIN
